...
* 각 Cloud Manager 환경은 환경당 최대 100개의 사용자 지정 도메인을 호스팅할 수 있습니다. 두 개 이상의 환경에서 동일한 도메인 이름을 사용할 수 없습니다.
...
1. 그러면 환경 도메인 이름 확인 화면이 표시됩니다. 자세한 내용은 [TXT 레코드](/help/implementing/cloud-manager/custom-domain-names/add-text-record.md)를 참조하십시오.
