...
* Cloud Manager의 *비즈니스 소유자* 또는 *배포 관리자* 역할의 샌드박스 프로그램 사용자는 이제 클라우드 관리자 UI를 통해 프로덕션 및 스테이징 환경 세트를 삭제할 수 있습니다. 이제 의 환경 카드 모두에서 삭제 옵션을 사용할 수 있습니다. **프로그램 개요** 페이지 및 **환경** 페이지를 가리키도록 업데이트하는 중입니다. 프로덕션 또는 스테이지에서 삭제 옵션을 선택하면 세트에 있는 다른 옵션도 삭제됩니다.
