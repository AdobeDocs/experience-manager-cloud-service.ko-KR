...
description: Adobe Experience Manager(AEM)의 Cloud Manager 릴리스 정보 as a Cloud Service 릴리스 2021.3.0
...
* 환경이 최대 절전 모드이지만 사용 가능한 AEM 업데이트도 있는 경우 **최대 절전 모드** 상태가 우선함 **업데이트 사용 가능**.
...
* Cloud Manager 프로덕션 파이프라인에는 이제 다음이 포함됩니다 [사용자 정의 UI 테스트](/help/implementing/cloud-manager/functional-testing.md#custom-ui-testing) 기능.
