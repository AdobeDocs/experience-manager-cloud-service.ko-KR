...
GitHub를 사용하여 저장소를 관리하는 경우, [이제 Cloud Manager를 통해 GitHub 저장소 내에서 직접 코드의 유효성을 검사할 수 있습니다](/help/implementing/cloud-manager/managing-code/private-repositories.md). 이 통합을 사용하면 코드를 Adobe 리포지토리와 일관되게 동기화할 필요가 없으며, 가져오기 요청을 주 분기로 병합하기 전에 확인할 수 있습니다.
