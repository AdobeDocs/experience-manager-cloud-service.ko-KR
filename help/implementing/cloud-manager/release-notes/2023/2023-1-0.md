...
AEM as a Cloud Service의 Cloud Manager 2023.1.0 릴리스 일자는 2023년 1월 10일 수요일입니다. 다음 릴리스는 2023년 2월 16일에 예정되어 있습니다.
...
* 이제 사용자 정의 UI 테스트 보고서가 Cloud Manager 저장소에 복사되며 Cloud Manager API 호출을 통해 액세스할 수 있습니다.
