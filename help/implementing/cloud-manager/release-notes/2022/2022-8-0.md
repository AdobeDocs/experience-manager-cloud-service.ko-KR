...
description: AEM as a Cloud Service의 Cloud Manager 2022.8.0 릴리스 노트.
...
AEM as a Cloud Service의 Cloud Manager 2022.8.0 릴리스 일자는 2022년 8월 11일 금요일입니다. 다음 릴리스는 2022년 9월 9일에 예정되어 있습니다.
...
* Cloud Manager UI에서 New Relic 사용자가 생성되거나 삭제되지 않는 문제가 수정되었습니다.
