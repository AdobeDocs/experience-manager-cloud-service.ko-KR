...
>
>AEM as a Cloud Service의 기존 경험 감사 기능에 대한 자세한 내용은 [경험 감사 테스트](/help/implementing/cloud-manager/experience-audit-testing.md) 문서를 참조하십시오.
...
파이프라인 실행 세부 정보에 표시되는 요약 외에도 Cloud Manager 대시보드의 **보고서** 탭을 사용하여 [전체 보고서](#view-full-report)에 직접 액세스하여 전체 감사 결과에 직접 액세스할 수도 있습니다.

>[!TIP]
>
>다음 섹션에서는 경험 감사의 결과를 보는 방법을 설명합니다.
>
>* 감사 작동 방식에 대한 자세한 내용은 [경험 감사 평가 세부 정보](#details) 섹션을 참조하십시오.
>* 주문형 경험 감사를 실행하는 방법을 알아보려면 [주문형 감사 보고서](#on-demand) 섹션을 참조하십시오.
>* 감사에 문제가 있는 경우 [경험 감사에 문제가 있습니다.](#issues) 섹션을 참조하십시오.
>* 일반적인 성능 팁은 [일반 성능 팁](#performance-tips) 섹션을 참조하십시오.
...
* **[가장 느린 5페이지](#view-slowest-pages)** 대화 상자에서 **전체 보고서 보기**&#x200B;를 탭하거나 클릭합니다.
* [파이프라인 실행을 볼 때 **전체 보고서 보기**&#x200B;를 탭하거나 클릭합니다.](#results)
* Cloud Manager에서 **보고서** 탭을 탭하거나 클릭합니다.
...
차트 단추 상단과 하단의 **선택** 및 **보기** 드롭다운을 사용하여 각각 페이지별 세부 정보와 다른 시간대를 선택합니다. 차트 상단의 및 **트렌드 업데이트** 버튼을 탭하거나 클릭하여 선택 사항을 적용하고 차트를 새로 고치십시오.

차트 위로 마우스를 가져가면 도구 설명에 특정 시점의 Google Lighthouse 카테고리 값이 표시됩니다.

![트렌드 세부 정보](assets/experience-audit-trend-details.png)

특정 시점에 차트를 탭하거나 클릭하면 해당 스캔의 세부 정보가 포함된 팝오버가 열립니다. **경험 감사 검색 열기**&#x200B;를 탭하거나 클릭하여 해당 검색 결과를 **[경험 감사 검색 결과](#scan-results)** 섹션으로 로드합니다.
...
**검사한 페이지** 섹션은 검사한 모든 페이지에 대한 세부 점수를 제공합니다. **이전** 및 **다음** 단추를 사용하여 결과를 페이지로 연결하고 페이지 번호를 지정할 디스플레이 수를 선택할 수 있습니다.

![검사한 페이지](assets/experience-audit-scanned-pages.png)

특정 페이지의 링크를 탭하거나 클릭하면 [**페이지 점수 - 트렌드** 섹션](#trend)의 **선택** 필터가 업데이트되고 선택한 페이지에 대한 **점수 및 권장 사항** 탭이 표시됩니다.
