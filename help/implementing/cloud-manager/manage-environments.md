...
1. 다음에서 **[내 프로그램](/help/implementing/cloud-manager/navigation.md#my-programs)** 콘솔, 환경을 추가하려는 프로그램을 탭하거나 클릭합니다.

1. 다음에서 **[내 프로그램](/help/implementing/cloud-manager/navigation.md#my-programs)** 콘솔, 클릭 **환경 추가** 다음에 있음 **환경** 카드를 사용하여 환경을 추가할 수 있습니다.
...
다음에서 **개요** 페이지 에서는 두 가지 방법으로 환경의 세부 정보에 액세스할 수 있습니다.

1. 다음에서 **개요** 페이지를 클릭하고 **환경** 사이드 탐색 패널의 탭입니다.
...
>[!TIP]
>
>자세한 내용은 문서를 참조하십시오. [사용자 정의 도메인 이름 소개.](/help/implementing/cloud-manager/custom-domain-names/introduction.md)
...
>[!TIP]
>
>자세한 내용은 문서를 참조하십시오. [IP 허용 목록 소개.](/help/implementing/cloud-manager/ip-allow-lists/introduction.md)
