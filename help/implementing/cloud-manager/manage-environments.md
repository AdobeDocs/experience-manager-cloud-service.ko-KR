...
클라우드 네이티브 서비스인 Adobe은 프로덕션 프로그램 내에서 개발, 스테이징 및 프로덕션 환경에 대한 업데이트를 자동으로 관리합니다.
...
>[!TIP]
>
>AEM as a Cloud Service 팀 및 제품 프로필에서 라이선스가 부여된 Adobe 솔루션에 대한 액세스 권한을 부여하고 제한하는 방법에 대해 알아보려면 [AEM as a Cloud Service 팀 및 제품 프로필](/help/onboarding/aem-cs-team-product-profiles.md)을 참조하세요.
