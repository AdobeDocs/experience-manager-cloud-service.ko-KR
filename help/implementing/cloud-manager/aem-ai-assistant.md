...
AEM에 있는 AI Assistant의 현재 범위는 AEMr as a Cloud Service에 대한 제품 지식 질문 해결에 중점을 둡니다. 이 범위에는 주요 영역에 대한 포괄적인 지원이 포함됩니다. <!--, such as Sites, Assets, Forms, Edge Delivery Services, Dynamic Media, and Cloud Manager. -->
...
### AEM 대화에서 AI Assistant 시작 또는 재설정
...
1. AEM의 AI 도우미에서 ![자세히 아이콘](https://spectrum.adobe.com/static/icons/workflow_18/Smock_More_18_N.svg)을 클릭합니다.
1. AI 도우미에게 새로운 주제 또는 주제 변경에 대해 알리려면 **새 대화 시작**&#x200B;을 클릭하세요.
...
1. AEM의 AI Assistant가 답할 수 있는 질문 유형을 더 잘 이해하려면 프롬프트를 선택하십시오.

### AEM의 AI Assistant에 대한 피드백 제공

입력을 통해 AEM의 AI Assistant를 개선하여 성능과 정확성을 높일 수 있습니다.
...
| ![플래그 아이콘](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Flag_18_N.svg) | AEM의 AI 도우미와의 상호 작용에 대한 자세한 피드백을 제공하거나 문제를 보고하려면 을(를) 클릭합니다. |
