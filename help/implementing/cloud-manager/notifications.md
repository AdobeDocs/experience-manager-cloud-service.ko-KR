...
기본적으로 애플리케이션과 이메일 모두를 통해 모든 제품에 대한 모든 알림을 받게 됩니다. 제품 이름 옆에 있는 V자형 화살표를 클릭하여 세부 옵션을 표시하고 해당 제품에 대해 수신하는 알림 유형을 정의합니다. 또는 제품 수준에서 옵션을 선택하거나 선택 해제하여 제품의 모든 옵션을 선택/선택 해제합니다.
