...
다음을 클릭합니다. **모두 보기** 받은 편지함의 모든 공지를 볼 수 있는 패널 하단의 옵션입니다.

다음을 클릭합니다. **모두 읽음으로 표시** 읽지 않은 모든 알림을 읽은 것으로 표시하고 종 모양 아이콘 배지를 지우려면 패널 하단의 옵션을 선택합니다.
...
기본적으로 애플리케이션과 이메일 모두를 통해 모든 제품에 대한 모든 알림을 받게 됩니다. 제품 이름 옆에 있는 V자 버튼을 클릭하면 자세한 옵션이 표시되고 해당 제품에 대해 수신하는 알림 유형을 정의할 수 있습니다. 또는 제품 수준에서 옵션을 선택하거나 선택 해제하여 제품의 모든 옵션을 선택/선택 해제합니다.
