...
| 다른 백엔드에 대한 CDN 프록시 | 제외됨 | [CDN 원본 선택기](/help/implementing/dispatcher/cdn-configuring-traffic.md#origin-selectors) 기술을 사용하여 다른 비 AEM 백엔드로 라우팅된 요청은 AEM에 도달하지 않으므로 제외됩니다. |
