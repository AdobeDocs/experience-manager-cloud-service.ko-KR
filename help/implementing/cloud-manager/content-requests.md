...
* 위에 설명된 &quot;잘 알려진 검색 엔진&quot; 콘텐츠 요청 제외 규칙을 활용하기 위해 브라우저의 사용자 에이전트가 AEM에 올바르게 전달되는지 확인하십시오.  제외를 방지하고 사용자 에이전트가 전달된 경우보다 더 높은 콘텐츠 요청을 초래할 수 있는 특정 Headless 구현 또는 CDN 구성과 함께 원래 사용자 에이전트가 유실되는 경우가 있습니다.
