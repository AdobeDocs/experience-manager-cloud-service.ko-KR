---
title: Java 기능 테스트
description: AEM as a Cloud Service용 Java 기능 테스트를 작성하는 방법 알아보기
...
AEM as a Cloud Service용 Java 기능 테스트를 작성하는 방법 알아보기
...
| 속성 | 설명 | 예 |
|-------------------------------------|------------------------------------------------------------------|-------------------------|
| `sling.it.instances` | 인스턴스 수로, 클라우드 서비스와 일치시키려면 `2` | `2` |
| `sling.it.instance.url.1` | 작성자 URL로 설정해야 합니다. | `http://localhost:4502` |
| `sling.it.instance.runmode.1` | 첫 번째 인스턴스의 runmode를으로 설정해야 합니다. `author` | `author` |
| `sling.it.instance.adminUser.1` | 작성자 관리자 사용자로 설정해야 합니다. | `admin` |
| `sling.it.instance.adminPassword.1` | 작성자 관리자 암호로 설정해야 합니다. |  |
| `sling.it.instance.url.2` | 게시 URL로 설정해야 합니다. | `http://localhost:4503` |
| `sling.it.instance.runmode.2` | 두 번째 인스턴스의 runmode를 `publish` | `publish` |
| `sling.it.instance.adminUser.2` | 게시 관리자 사용자로 설정해야 합니다. | `admin` |
| `sling.it.instance.adminPassword.2` | 게시 관리자 암호로 설정해야 합니다. |  |
