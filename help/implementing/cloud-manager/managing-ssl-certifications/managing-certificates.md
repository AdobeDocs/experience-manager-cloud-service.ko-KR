...
* **주황색** - 이 상태는 인증서가 60일 이내에 만료될 예정임을 나타냅니다.
   * 가능한 사이트 액세스 또는 중단을 방지하기 위해 인증서를 갱신하고 Cloud Manager 사용자 인터페이스를 통해 인증서를 교체할 계획이 있는지 확인해야 합니다.
...
>[!NOTE]
>
>사용자는 의 멤버여야 합니다. **비즈니스 소유자** 또는 **배포 관리자** cloud Manager에서 SSL 인증서를 업데이트하는 역할입니다.
...
>[!NOTE]
>
>사용자는 의 멤버여야 합니다. **비즈니스 소유자** 또는 **배포 관리자** cloud Manager에서 SSL 인증서를 삭제하는 역할입니다.
