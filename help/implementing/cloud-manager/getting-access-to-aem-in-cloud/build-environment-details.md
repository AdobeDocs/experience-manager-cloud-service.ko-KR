...
Java 21 런타임은 Java 21 및 Java 17을 사용하는 빌드에 사용되며 Java 11 빌드에도 점차적으로 적용됩니다(아래 참고 사항 참조). Java 21 업데이트를 수신하려면 환경이 AEM 릴리스 17098 이상 최신이어야 합니다. 호환성을 보장하려면 다음 조정이 필요합니다.
