...
필요한 권한이 있는 사용자는 편집할 수 있습니다. [조직에서 만든 프로덕션 프로그램](creating-production-programs.md) 및 [조직에서 만든 샌드박스 프로그램.](creating-sandbox-programs.md) 프로그램을 편집하여 다음과 같은 작업을 수행할 수 있습니다.

* Assets가 있는 기존 프로그램에 Sites 솔루션을 추가하고 반대로 할 수 있습니다.
...
1. 페이지 왼쪽 상단에서 프로그램 이름을 클릭하고 을 선택합니다 **프로그램 편집**.
...
1. **Go-Live 설정** 탭에서 프로그램의 계획된 Go-Live 날짜를 수정합니다.
   ...
   * 이 날짜는 정보 제공용입니다. 프로그램 개요 페이지에서 라이브 위젯이 트리거됩니다. 또한 여정에 맞게 Adobe Experience Manager(AEM) as a Cloud Service 모범 사례 설명서에 대한 제품 내 링크를 제공하여 성공적인 Go Live 경험을 제공합니다.
   * 이 탭은 샌드박스 프로그램에 사용할 수 없습니다.

1. 클릭 **업데이트** 을 클릭하여 프로그램에 변경 사항을 저장합니다.
...
프로그램을 만든 후에는 이 설정을 편집할 수 없습니다. 향상된 보안 옵션에 대한 자세한 내용은 [프로덕션 프로그램 만들기](creating-production-programs.md).
