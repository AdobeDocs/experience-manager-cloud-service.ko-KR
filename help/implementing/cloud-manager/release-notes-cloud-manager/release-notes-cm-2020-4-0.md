...
# Adobe Experience Manager as a Cloud Service 2020.4.0의 Cloud Manager 릴리스 노트 {#release-notes}

이 페이지에서는 AEM as a Cloud Service 2020.4.0에 있는 Cloud Manager 릴리스 노트를 간략하게 설명합니다.
