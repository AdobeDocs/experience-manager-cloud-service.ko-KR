...
>[!TIP]
>
>여러 변수를 추가하려면 첫 번째 변수를 추가한 다음 **추가** 의 단추 **환경 구성** 추가 변수를 추가하는 대화 상자. 이렇게 하면 한 번의 업데이트로 환경에 여러 변수를 추가할 수 있습니다.
...
>[!TIP]
>
>여러 변수를 업데이트하려면 를 사용하는 것이 좋습니다. **환경 구성** 탭하거나 클릭하기 전에 필요한 모든 변수를 한 번에 업데이트하는 대화 상자 **저장**. 이렇게 하면 한 번의 업데이트로 환경에 여러 변수를 추가할 수 있습니다.
