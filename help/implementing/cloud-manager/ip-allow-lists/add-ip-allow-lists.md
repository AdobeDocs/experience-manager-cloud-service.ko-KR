...
1. 다음에서 **개요** 페이지, 다음으로 이동 **환경** 화면.

1. 다음에서 **환경** 화면에서 다음 위치로 이동 **IP 허용 목록** 페이지를 가리키도록 업데이트하는 중입니다.
...
1. 다음에서 **IP 허용 목록 추가** 대화 상자에서 허용 목록에 추가하다를 참조하는 데 사용할 이름을 입력합니다 **IP 허용 목록 이름** 필드.
