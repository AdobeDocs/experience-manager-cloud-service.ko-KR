...
1. 원하는 조직을 선택합니다.
1. **내 프로그램** 콘솔에서 New Relic One 사용자를 관리할 프로그램을 클릭합니다.
1. 왼쪽 메뉴에서 **서비스** 아래의 ![데이터 아이콘 또는 환경 아이콘](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Data_18_N.svg) **환경**&#x200B;을 클릭합니다.
1. 환경 페이지의 오른쪽 상단 모서리에서 ![자세히 아이콘](https://spectrum.adobe.com/static/icons/workflow_18/Smock_More_18_N.svg)을 클릭한 다음 **New Relic 활성화**&#x200B;를 클릭합니다.

   ![New Relic 활성화](/help/implementing/cloud-manager/assets/new-relic/new-relic-activate.png)
...
AEM as a Cloud Service 프로그램과 연결된 New Relic One 하위 계정의 사용자를 정의할 수 있습니다.

>[!NOTE]
>
>New Relic One 사용자를 관리하려면 **비즈니스 소유자** 또는 **배포 관리자** 역할의 사용자가 로그인해야 합니다.

**New Relic One 사용자를 관리하려면:**
...
1. **내 프로그램** 콘솔에서 New Relic One 사용자를 관리할 프로그램을 클릭합니다.
1. 왼쪽 메뉴에서 **서비스** 아래의 ![데이터 아이콘 또는 환경 아이콘](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Data_18_N.svg) **환경**&#x200B;을 클릭합니다.
1. 환경 페이지의 오른쪽 상단 모서리에서 ![추가 아이콘](https://spectrum.adobe.com/static/icons/workflow_18/Smock_More_18_N.svg)을 클릭한 다음 **사용자 관리**&#x200B;를 클릭합니다.

   ![New Relic 사용자 관리](/help/implementing/cloud-manager/assets/new-relic/new-relic-manage-users.png)

1. **New Relic 사용자 관리** 대화 상자에서 다음을 수행합니다.
...
사용자가 정의되면 New Relic은 각 사용자에게 확인 이메일을 보냅니다. 여기에서 활성화 프로세스를 완료하고 로그인할 수 있습니다.
...
## New Relic One 열기 {#accessing-new-relic}

[New Relic 계정을 활성화](#activate-account)한 후에는 Cloud Manager을 통해 또는 직접 New Relic One을 열 수 있습니다.

**Cloud Manager을 통해 New Relic One을 열려면 다음을 수행하십시오.**

1. [experience.adobe.com](https://experience.adobe.com)에서 Cloud Manager에 로그인합니다.
   1. **바로 가기** 섹션에서 **Experience Manager**&#x200B;를 클릭합니다.
   1. 왼쪽 사이드 패널에서 **Cloud Manager**&#x200B;를 클릭합니다.
1. 원하는 조직을 선택합니다.
1. **내 프로그램** 콘솔에서 New Relic One을 열 프로그램을 클릭합니다.
1. 왼쪽 메뉴에서 **서비스** 아래의 ![데이터 아이콘 또는 환경 아이콘](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Data_18_N.svg) **환경**&#x200B;을 클릭합니다.
1. 환경 페이지의 오른쪽 상단 모서리에서 ![자세히 아이콘](https://spectrum.adobe.com/static/icons/workflow_18/Smock_More_18_N.svg)을 클릭한 다음 **New Relic 열기**&#x200B;를 클릭합니다.

   ![New Relic 열기](/help/implementing/cloud-manager/assets/new-relic/new-relic-open-new-relic.png)

1. 새 브라우저 탭이 열리면 New Relic One에 로그인합니다.

**New Relic One을 직접 열려면:**
...
### 지원되는 파이프라인 및 워크플로 {#supported-pipelines}

다음 Cloud Manager 파이프라인과 마지막 두 워크플로우 유형은 New Relic One에서 변경 추적기를 생성합니다.
...
1. 차트에서 변경 이벤트를 클릭하여 세부 보기를 엽니다.
