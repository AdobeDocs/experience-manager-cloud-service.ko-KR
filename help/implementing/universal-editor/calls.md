...
호출이 성공적으로 완료되면 요청 및 응답의 페이로드를 포함하는 이벤트가 트리거되며, 이는 자체 앱에 대해 사용자 지정할 수 있습니다. 문서를 참조하십시오. [유니버설 편집기 이벤트](/help/implementing/universal-editor/events.md) 을 참조하십시오.
