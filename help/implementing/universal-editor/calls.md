...
호출이 성공적으로 완료되면 요청 및 응답의 페이로드를 포함하는 이벤트가 트리거되며, 이 이벤트는 자체 앱에 맞게 사용자 정의할 수 있습니다. 자세한 내용은 [범용 편집기 이벤트](/help/implementing/universal-editor/events-universal-editor.md) 문서를 참조하십시오.
...
* [범용 편집기 이벤트](/help/implementing/universal-editor/events-universal-editor.md)
