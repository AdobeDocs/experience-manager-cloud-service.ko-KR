...
| `data-editor-itemmodel` | 속성 레일에서 양식 기반 편집에 사용될 모델 정의 |
...
| `component` | 편집 가능 항목은 구성 요소입니다. 추가 기능을 추가하지 않으며, DOM의 이동/삭제 가능한 부분을 표시하고 속성 레일 및 해당 필드를 여는 데 필요 | 필수 | 해당 없음 | 해당 없음 | 선택 사항 | 선택 사항 | 해당 없음 |
