...
| `media` | 편집 가능 항목은 자산(예: 이미지 또는 비디오)임 | 옵션 | 필수 | 옵션<br>자산 선택기로 전달되는 이미지 또는 비디오 필터 조건 목록 | 옵션 | 해당 사항 없음 | 옵션 |
...
| `reference` | 편집 가능 항목은 참조(예: 콘텐츠 조각, 경험 조각 또는 제품)임 | 상황에 따라 다름 <br>아래 참조 | 상황에 따라 다름 <br>아래 참조 | 옵션<br>콘텐츠 조각, 제품 또는 참조 선택기에 전달되는 경험 조각 필터 조건 목록 | 옵션 | 옵션 | 해당 사항 없음 |
