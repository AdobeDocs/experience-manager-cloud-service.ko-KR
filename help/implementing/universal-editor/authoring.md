...
* [일반 텍스트 편집](#editing-content) 제자리에.
* [리치 텍스트 편집](#editing-rich-text) 구성 요소 레일에 표시되는 추가적인 서식 옵션과 함께 배치됩니다.
* [콘텐츠 조각 편집](#edit-content-fragment)

![구성 요소 모드](assets/component-mode.png)

을(를) 선택하는 경우 [컨텐츠 조각](/help/assets/content-fragments/content-fragments.md)의 세부 사항이 콘텐츠 조각을 편집할 수 있는 구성 요소 레일에 표시됩니다.
...
속성 모드의 레일에 편집기에서 현재 선택한 구성 요소의 속성이 표시됩니다. 페이지가 로드될 때 구성 요소의 기본 모드입니다.
...
다음 시기 [구성 요소 모드,](#component-mode) 선택한 구성 요소에 대한 편집 옵션이 구성 요소 레일에 나타납니다. 구성 요소 레일에서 선택한 구성 요소를 편집할 수 있습니다. 그러나 편집 버튼을 탭하거나 클릭할 수도 있습니다.

![편집 아이콘](assets/edit.png)

편집 버튼을 탭하거나 클릭하면 [콘텐츠 조각 편집기](/help/assets/content-fragments/content-fragments-managing.md#opening-the-fragment-editor) 새 탭에서. 이를 통해 콘텐츠 조각 편집기의 전체 기능에 액세스하여 관련 콘텐츠 조각을 편집할 수 있습니다.
...
콘텐츠 편집은 간단하고 직관적입니다. 편집 모드([미디어 모드](#media-mode) 및 [구성 요소 모드](#component-mode)) 편집기의 콘텐츠 위로 마우스를 가져가면 편집 가능한 콘텐츠가 파란색 상자로 강조 표시됩니다.

![편집 가능한 콘텐츠는 파란색 상자로 강조 표시됩니다](assets/editable-content.png)

>[!TIP]
>
>편집 모드에서 컨텐츠를 탭하거나 클릭하면 편집할 컨텐츠가 선택됩니다. 링크를 이용하여 콘텐츠를 탐색하려면 [미리보기 모드](#preview-mode)로 전환합니다.
...
텍스트 구성 요소를 탭하거나 클릭하여 선택하면 해당 세부 사항이 구성 요소 레일에 표시됩니다. 레일에서 텍스트를 편집할 수도 있습니다.

![구성 요소 레일의 텍스트 편집](assets/ue-editing-text-component-rail.png)

또한 텍스트에 대한 자세한 내용은 구성 요소 레일에서 확인할 수 있습니다. 포커스가 구성 요소 레일의 편집된 필드를 떠나면 변경 사항이 자동으로 저장됩니다.
...
또한 구성 요소 레일에서 텍스트의 서식 옵션 및 세부 정보를 사용하고 확인할 수 있습니다. 포커스가 구성 요소 레일의 편집된 필드를 떠나면 변경 사항이 자동으로 저장됩니다.
...
콘텐츠 조각과 관련된 필드를 선택하면 콘텐츠 조각이 구성 요소 레일에 로드되고 필드가 자동으로 스크롤됩니다.

포커스가 구성 요소 레일의 편집된 필드를 떠나면 변경 사항이 자동으로 저장됩니다.
...
>[!TIP]
>
>단축키 사용 `A` 을 눌러 선택한 컨테이너에 구성 요소를 추가합니다.
...
>[!TIP]
>
>단축키 사용 `Shift+Backspace` 을 눌러 해당 컨테이너에서 선택한 구성 요소를 삭제합니다.
...
미리보기 모드에서 콘텐츠를 탭하거나 클릭하면 콘텐츠 독자에게 반응하는 것처럼 반응합니다. 편집할 컨텐츠를 선택하려면 와 같은 편집 모드로 전환합니다. [구성 요소 모드](#component-mode) 또는 [미디어 모드입니다.](#media-mode)
