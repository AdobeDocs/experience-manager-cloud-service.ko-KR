...
>[!NOTE]
>
>Edge Delivery Services에서 AEM 작성을 사용하는 프로젝트에는 로컬 유니버설 편집기 서비스가 필요하지 않습니다.
...
1. 자체 서명된 인증서를 신뢰할 수 있으면 로컬 유니버설 편집기 서비스를 사용하여 페이지가 로드됩니다.
1. 도구 모음에서 [로컬 개발자 로그인](/help/sites-cloud/authoring/universal-editor/navigation.md#local-developer-login)을 클릭하고 로컬 AEM 인스턴스를 인증합니다.

이제 로컬 범용 편집기 서비스를 사용하여 로컬 AEM 테스트 인스턴스의 페이지를 편집할 수 있습니다.
