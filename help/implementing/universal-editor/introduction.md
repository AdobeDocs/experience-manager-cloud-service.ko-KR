...
다양한 방식으로 경험을 빌드할 수 있으므로 모든 구현에서는 범용 편집기를 사용하여 작성자가 직접 편집을 수행할 수 있습니다.

사용자는 Headless 구현으로 인해 작성자가 양식 기반 UI에서 모든 콘텐츠를 편집할 수 없다고 생각하지만 유니버설 편집기에서는 그렇지 않습니다

구현에서 유니버설 편집기를 사용하기 위한 요구 사항은 바로 전달되며, 다음을 지원합니다.
...
* **탁월한 경험 제공** - 전문가가 방문자를 위한 매력적인 경험을 만들 수 있도록 유니버설 편집기를 사용하면 전문가가 미리보기 컨텍스트에서 콘텐츠를 만들고 편집할 수 있습니다. 덕분에 경험 디자인에 맞고 방문자에게 의미 있는 여정을 구성하는 콘텐츠를 만들 수 있습니다.
