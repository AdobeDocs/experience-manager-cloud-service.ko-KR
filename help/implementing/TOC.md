...
+ AEM as a Cloud Service를 위한 개발 {#developing}
   ...
   + [AEM Technical Foundation](/help/implementing/developing/introduction/aem-technologies.md)
   ...
   + [AEM의 얼굴 및 얼굴 없음](developing/headful-headless.md)
   + 전체 스택 AEM 개발 {#full-stack}
      ...
      + [AEM 응용 프로그램에 태그 지정 구성](/help/implementing/developing/introduction/tagging-applications.md)
      + 검색 {#search}
   ...
   + 하이브리드 AEM 개발 {#hybrid}
      + [AEM이 장착된 하이브리드 및 SPA](https://www.adobe.com/content/dam/www/us/en/marketing/experience-manager-sites/headless-content-management-system/pdfs/aem-hybrid-architecture-wp-1-18-19.pdf)
   ...
   + 헤드리스 환경 관리 {#headless}
      + [헤드레스 및 AEM](developing/headless/introduction.md)
      + 시작 가이드 {#getting-started}
         ...
         + [에셋 폴더 만들기](developing/headless/getting-started/create-assets-folder.md)
         + [컨텐츠 조각 만들기](developing/headless/getting-started/create-content-fragment.md)
         + [내용 부분 액세스 및 전달](developing/headless/getting-started/create-api-request.md)
      + 콘텐츠 조각 {#content-fragments}
         + [내용 부분 및 GraphQL을 사용한 헤드레스 전달](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/content-fragments/content-fragments-graphql.html)
         ...
         + [인스턴스에 대한 내용 조각 기능 사용](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/content-fragments/content-fragments-configuration-browser.html)
      ...
      + 전달 API {#delivery-api}
         + [내용 부분 REST API](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/admin/assets-api-content-fragments.html)
         + [내용 부분 그래프QL API](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/admin/graphql-api-content-fragments.html)
         + [내용 부분이 있는 AEM GraphQL API - 샘플 내용 및 쿼리](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/admin/content-fragments-graphql-samples.html)
         + [원격 AEM GraphQL 인증(내용 부분에 대한 쿼리)](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/admin/graphql-authentication-content-fragments.html)
...
+ 개인화 {#personalization}
   ...
   + [ContextHub를 사용하여 세그먼트 구성](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/sites/authoring/personalization/contexthub-segmentation.html)
