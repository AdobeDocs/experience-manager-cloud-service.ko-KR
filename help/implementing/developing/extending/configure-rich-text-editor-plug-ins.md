...
작성자는 스타일을 적용하여 텍스트 부분의 모양을 변경할 수 있습니다. 스타일은 CSS 스타일 시트에서 사전 정의한 CSS 클래스를 기반으로 합니다. 양식화된 내용은에 포함되어 있습니다. `span` 를 사용하는 태그 `class` css 클래스를 참조하는 속성입니다. 예를 들면 다음과 같습니다.
