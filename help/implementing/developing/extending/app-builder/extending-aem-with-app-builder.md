---
title: as a Cloud Service Adobe Developer App Builder을 사용하여  [!DNL Adobe Experience Manager] 확장.
description: as a Cloud Service Adobe Developer App Builder을 사용하여  [!DNL Adobe Experience Manager] 확장.
...
# as a Cloud Service Adobe Developer App Builder을 사용하여 [!DNL Adobe Experience Manager] 확장 {#extend-using-app-builder}
...
App Builder은 2020년 여름부터 Adobe의 개발자 미리보기를 통해 기업 고객 및 파트너가 사용할 수 있습니다. App Builder의 GA(일반 공급)가 2021년 12월로 예정되어 있습니다. Adobe은 개발자가 [평가판 프로그램](https://developer.adobe.com/app-builder/trial/)을 통해 App Builder을 사용해 볼 수 있도록 환영합니다.
...
* Adobe Developer Console - 사용자 정의 마이크로서비스 및 확장 개발을 위해 개발자가 필요한 모든 도구 및 API에 액세스하여 프로젝트를 구축하고 관리하여 플러그인 및 통합을 만들 수 있도록 합니다.
...
App Builder을 시작할 수 있도록 Adobe이 시작 설명서를 만들었습니다.
