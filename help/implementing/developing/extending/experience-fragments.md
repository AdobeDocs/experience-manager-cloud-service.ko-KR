...
오버레이를 사용하여 재작성기를 구성하는 것이 좋습니다. 다음을 참조하십시오 [AEM의 오버레이 as a Cloud Service](/help/implementing/developing/introduction/overlays.md)
...
유일한 추가 구성은 구성 요소가 템플릿에서 허용되도록 하는 것이며, 이는 콘텐츠 정책을 통해 수행됩니다.
...
Target으로 내보내기 기능을 사용하여 다음과 같은 작업을 수행할 수 있습니다.
