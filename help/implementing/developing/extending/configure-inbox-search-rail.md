...
1. 다음 항목 선택 **[!UICONTROL 받은 편지함 검색 레일]** 구성 및 선택 **[!UICONTROL 편집]**.
...
1. 다음 항목 선택 **[!UICONTROL 받은 편지함 검색 레일]** 구성 및 선택 **[!UICONTROL 삭제]**.
...
1. 다음 항목 선택 **[!UICONTROL 조건자 선택]** 탭하고 드래그 **[!UICONTROL 범위 조건자]** 을 양식으로 변환.
...
1. 구성에 대한 선택적 설명을 지정하고 을 선택합니다. **[!UICONTROL 완료]** 저장하려고.
...
1. 를 엽니다. [구성을 위한 양식](#creating-opening-customized-configuration).
1. 다음 항목 선택 **[!UICONTROL 조건자 선택]** 탭하고 드래그 **[!UICONTROL 텍스트 조건자]** 을 양식으로 변환.
1. 다음에서 **[!UICONTROL 설정]** 탭에서 검색 기준으로 사용할 받은 편지함 열 이름을 선택합니다. **[!UICONTROL 열 이름]** 필드.
...
1. 를 엽니다. [구성을 위한 양식](#creating-opening-customized-configuration).
1. 다음 항목 선택 **[!UICONTROL 조건자 선택]** 탭하고 드래그 **[!UICONTROL 날짜 범위 조건자]** 을 양식으로 변환.
1. 다음에서 **[!UICONTROL 설정]** 탭에서 검색 기준으로 사용할 받은 편지함 열 이름을 선택합니다. **[!UICONTROL 열 이름]** 필드.
...
1. 를 엽니다. [구성을 위한 양식](#creating-opening-customized-configuration).
1. 다음 항목 선택 **[!UICONTROL 조건자 선택]** 탭하고 드래그 **[!UICONTROL 사용자 정의 열 옵션 조건자]** 을 양식으로 변환.
1. 다음에서 **[!UICONTROL 설정]** 탭에서 검색 기준으로 사용할 받은 편지함 열 이름을 선택합니다. **[!UICONTROL 열 이름]** 필드.
...
1. 다음에서 **[!UICONTROL 옵션 추가]** 섹션:
   1. 선택 **[!UICONTROL 수동]** 필터 검색 옵션을 수동으로 정의합니다. 선택 **[!UICONTROL 필터 옵션 추가]** 을 클릭하여 첫 번째 옵션을 정의합니다. 열 옵션의 레이블과 검색할 옵션 값 텍스트를 지정합니다. 예를 들어 을 검색하려는 경우 **여성** 받은 편지함 열의 값으로 **F** 열 옵션의 레이블로 사용하고 추가 **여성** 를 옵션 값 텍스트로 사용합니다. 마찬가지로 필터 옵션을 더 추가할 수 있습니다.
   ...
   1. 선택 **[!UICONTROL CRX 옵션 경로]** crx 저장소 경로를 사용하여 옵션을 정의합니다. 선택 **[!UICONTROL 옵션 경로 추가]** 여러 경로를 추가합니다. 다음은 을(를) 정의하는 샘플입니다. `Male` 및 `Female` 필터 옵션:
