...
1. 양식 **검색** 콘솔을 열고 업데이트할 구성을 선택합니다. 예: 사이트 **관리자 검색 레일입니다**. 그런 다음 편집을 **선택합니다**.
...
1. 적절한 콘솔(이 예에서는 사이트) **으로**&#x200B;이동하고 검색 - **필터 레일을** 엽니다. 새롭게 정의된 검색 양식과 다양한 옵션이 표시됩니다. 필요한 옵션을 선택하여 검색 결과를 봅니다.
