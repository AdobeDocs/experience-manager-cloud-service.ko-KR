...
UI는 모바일 장치와 데스크탑 장치 모두에 적합하지만, AEM에서는 두 가지 스타일을 만들지 않고 모든 화면과 장치에 적합한 한 가지 스타일을 사용합니다.
...
AEM에는 편집, 미리 보기, 주석 레이어 등 페이지 작성을 위해 이미 구현된 여러 레이어가 함께 제공됩니다.
...
맞춤화를 수행해야 하거나 이미 수행한 경우 통합 기능을 비활성화할 수 있습니다.
