...
[여기에서 WKND 개발자 자습서를 ](https://docs.adobe.com/content/help/en/experience-manager-learn/getting-started-wknd-tutorial-develop/overview.html) 이용할 수 있으며 최신 기술 및 모범 사례를 사용하여 AEM 프로젝트를 제작하는 방법을 안내할 수 있습니다.
