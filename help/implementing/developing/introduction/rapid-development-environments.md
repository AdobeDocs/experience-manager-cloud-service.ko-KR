...
코드, 컨텐츠 또는 [컨테이너 패키지](/help/implementing/developing/introduction/aem-project-content-package-structure.md#container-packages) (&quot;모두&quot; 패키지라고도 함).
...
에서 `dispatcher` AEM 프로젝트의 모듈에서는 아래 maven 명령을 실행하여 dispatcher 구성을 압축할 수 있습니다.
...
>[!NOTE]
>
>RDE는 &quot;유연한 모드&quot; 디스패처 구성을 지원하지만 &quot;레거시 모드&quot; 디스패처 구성은 지원하지 않습니다. 자세한 내용은 [dispatcher 설명서](/help/implementing/dispatcher/disp-overview.md#validation-debug) 두 가지 모드에 대한 자세한 내용을 참조하십시오. 다음 문서에 대한 설명서를 참조할 수도 있습니다. [유연한 모드로 마이그레이션](/help/implementing/dispatcher/validation-debug.md#migrating): 아직 수행하지 않았다면 설정합니다.
