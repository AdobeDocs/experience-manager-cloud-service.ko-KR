...
>[!NOTE]
>
>아래 나열된 구성 변경 사항을 수행하려면 로컬 개발 환경에서 생성한 다음 AEM as a Cloud Service 인스턴스로 푸시합니다. 이 작업을 수행하는 방법에 대한 자세한 내용은 [AEM에 as a Cloud Service 배포](/help/implementing/deploying/overview.md).
