...
>[!NOTE]
>
>AEM as a Cloud Service 환경의 경우 디버그는 최대 세부 정보 수준입니다. 추적 로그 수준은 지원되지 않으므로 클라우드 환경에서 작업할 때는 설정하지 않아야 합니다.
...
* Splunk HEC 끝점 주소입니다. 이 끝점에 유효한 SSL 인증서가 있어야 하며 공개적으로 액세스할 수 있어야 합니다.
* Splunk 색인
* Splunk 포트
