...
|---|---|---|---|---|---|
| 29.04.2020 21:50:13.398 | `[cm-p1234-e5678-aem-author-59555cb5b8-q7l9s]` | `*DEBUG*` | qtp2130572036-1472 | com.example.approval.workflow.impl.CustomApprovalWorkflow | 지정된 승인자가 없습니다. [ 크리에이티브 승인자 사용자 그룹을 기본값으로 설정 ] |
