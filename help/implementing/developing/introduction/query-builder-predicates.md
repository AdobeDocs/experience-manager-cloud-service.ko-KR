...
* **`lowerBound`** - 예를 들어 속성을 확인하기 위해 바인딩된 보다 낮은 날짜 `2014-10-01`
...
* **`hasPermission`** - 해당 노드에 대해 현재 사용자 세션에 있어야 하는 모든 쉼표로 구분된 JCR 권한. 예를 들어, `jcr:write`, `jcr:modifyAccessControl`
