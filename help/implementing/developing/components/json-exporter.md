...
AEM 컨텐츠 서비스는 웹 페이지의 초점을 넘어서 AEM에서 컨텐트에 대한 설명과 제공을 일반화하기 위해 고안되었습니다.
...
* 다음과 같은 컨텐츠를 제공합니다.
   ...
   >[!NOTE]
   >
   >표준 구현은 아니지만 [여러 선택기가 지원되지만 ](enabling-json-exporter.md#multiple-selectors), `model`는 첫 번째 구현이어야 합니다.
