...
[페이지 템플릿을 편집할 때 디자인 대화 상자가 사용됩니다](/help/sites-cloud/authoring/features/templates.md)모든 구성 요소에 필요한 것은 아니지만. 예: **제목** 및 **이미지 구성 요소** 둘 다 디자인 대화 상자가 있지만 **소셜 미디어 공유 구성 요소** 그렇지 않습니다.
...
대화 상자 필드의 이벤트 처리 방법은 사용자 지정 의 리스너를 통해 수행됩니다 [클라이언트 라이브러리입니다.](/help/implementing/developing/introduction/clientlibs.md)
