...
# AEM에서 {#getting-started-with-spas-in-aem-using-react}을(를) 사용하여 SPA 시작하기
...
>[!NOTE]
>
>이 문서는 Response 프레임워크를 기반으로 합니다. 각도 프레임워크에 해당하는 문서는 AEM에서 SPA 시작하기 - 각도[를 참조하십시오.](getting-started-angular.md)
...
`Page`은 페이지 모델의 JSON 표현을 인제스트하고 페이지의 각 요소를 래핑/장식하기 위한 컨텐츠를 처리합니다. `Page`에 대한 자세한 내용은 [SPA Blueprint.](blueprint.md) 문서에 있습니다.
