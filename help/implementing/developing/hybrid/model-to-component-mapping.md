...
1. 그런 다음 [모델 공급자](blueprint.md#the-model-provider)에 의해 모델과 함께 제공된 [컨테이너](blueprint.md#container)는 해당 모델 컨텐트(`:items`)에 대해 반복합니다.
...
각 구성 요소는 [`ModelProvider`](blueprint.md#the-model-provider)의 기능과 함께 확장됩니다. 따라서 초기화는 다음과 같은 일반 양식을 사용합니다.
