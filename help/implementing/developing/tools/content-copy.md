...
1. (선택 사항) 원하는 경우 다음을 설정합니다.
   ...
   * **지우기** - 가져오기를 시작하기 전에 대상에서 기존 콘텐츠를 삭제하려면 선택하십시오. 따라서 깨끗한 슬레이트에서 시작하여 기존 콘텐츠와의 충돌을 피할 수 있습니다. **지우기**&#x200B;를 선택 해제한 상태로 두면 Cloud Manager은 기존 대상 콘텐츠 위에 새 콘텐츠를 가져옵니다. 지우기가 시작되기 전에 확인 메시지가 나타나고 Cloud Manager은 지우기 작업과 추적을 위한 가져오기 세부 사항을 기록합니다.
