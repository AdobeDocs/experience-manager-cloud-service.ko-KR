---
title: 변형 - 조각 콘텐츠 작성
description: 변형을 통해 조각에 대한 콘텐츠를 작성한 다음 목적에 따라 해당 콘텐츠의 변형을 만드는 방법을 이해합니다. 이렇게 하면 Headless 전달 및 페이지 작성을 위한 유연성을 높일 수 있습니다.
...
[변형](/help/sites-cloud/administering/content-fragments/content-fragments.md#constituent-parts-of-a-content-fragment)은 특정 채널 및/또는 시나리오에서 사용할 마스터 콘텐츠의 사본을 만들고 편집할 수 있는 AEM 콘텐츠 조각의 중요한 기능으로, 페이지 작성과 Headless 콘텐츠 전달을 보다 유연하게 해 줍니다.
...
1. **만들기**&#x200B;를 선택합니다.
1. 마지막으로
   1. **완료**&#x200B;를 선택하면 원래 조각으로 돌아가고 새 조각이 참조됩니다.
   1. **열기**&#x200B;를 선택하면 새 조각이 참조되고 새 브라우저 탭에서 편집할 새 조각이 열립니다.
...
그러나 자산의 형식 지정(예: 크기)은 [페이지 편집기](/help/sites-cloud/authoring/fundamentals/content-fragments.md). 조각 편집기의 에셋 표현은 순전히 콘텐츠 흐름을 작성하기 위한 것입니다.
...
title="변형 - 조각 콘텐츠 작성"
abstract="특정 채널에 사용할 컨텐츠를 어떻게 변형하는지 알아봅니다."
additional-url="https://video.tv.adobe.com/v/333295" text="컨텐츠 조각 변형"
