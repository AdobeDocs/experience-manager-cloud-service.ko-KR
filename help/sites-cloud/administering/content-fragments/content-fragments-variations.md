...
편집할 컨텐츠 조각을 열면 **변형** 탭은 기본적으로 열립니다. 보유하고 있는 마스터 또는 변형에 사용할 콘텐츠를 여기에서 작성할 수 있습니다. 구조화된 조각은 콘텐츠 모델에서 정의된 다양한 데이터 유형의 다양한 필드를 포함합니다.
...
1. **선택**&#x200B;을 사용하여 자산을 현재 위치에서 콘텐츠 조각의 단락 시스템에 추가합니다.
   ...
   * **Markdown**: 에셋이 표시되진 않지만 로 돌아가면 여전히 남아 있습니다. **리치 텍스트**.
