...
[작성](/help/sites-cloud/administering/content-fragments/content-fragments-variations.md#authoring-your-content) 시 콘텐츠 조각 편집기는 *Markdown* 구문을 사용하여 사용자가 손쉽게 페이지 작성 및 Headless 전달에 필요한 콘텐츠를 작성할 수 있도록 합니다.
