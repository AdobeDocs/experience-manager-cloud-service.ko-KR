...
>
>* 이 **콘텐츠 조각** 콘솔
>* **자산** 콘솔 - [콘텐츠 조각 관리](/help/assets/content-fragments/content-fragments-managing.md) 참조
...
* **모델**
   * 정보만.
   * 다음 경우에 사용 가능 [빠른 필터링](#fast-filtering#fast-filtering)
* **폴더**
   * 콘솔에서 폴더 열기 링크 제공.
...
* **태그**
   * 정보만.
   * 컨텐츠 조각과 관련된 모든 태그를 표시합니다(기본 및 변형 모두).
   * 다음 경우에 사용 가능 [빠른 필터링](#fast-filtering#fast-filtering).
* **게시일**
   * 정보만.
* **게시자**
...
* 다양한 술어
   * 콘텐츠 조각 모델, 현지화, 태그, 상태 필드 등
   * 하나 이상의 술어를 선택하고 결합하여 필터를 만들 수 있습니다
* 구성 **저장** 옵션
* 재사용을 위해 저장된 검색 필터를 검색할 수 있는 옵션

이 옵션을 선택하면 **필터링 기준** 검색 상자 아래에 옵션이 표시됩니다. 여기에서 선택을 취소할 수 있습니다. 예:

![콘텐츠 조각 콘솔 - 필터링](assets/cfc-console-filter.png)

### 빠른 필터링 {#fast-filtering}

목록에서 특정 열 값을 클릭하여 술어를 선택할 수도 있습니다. 하나 이상의 값을 선택하여 술어를 결합할 수 있습니다.
