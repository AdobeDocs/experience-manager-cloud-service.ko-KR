...
>* [자산의 MSM을 사용하여 콘텐츠 조각 재사용](/help/assets/reuse-assets-using-msm.md)(**자산** 콘솔을 통해서만 사용 가능)
...
모든 콘텐츠와 마찬가지로, 결국 콘텐츠 조각을 **[게시 서비스](/help/overview/architecture.md#runtime-architecture)**&#x200B;에 게시해야 합니다.

그 전에 AEM **[미리보기 서비스](/help/overview/architecture.md#runtime-architecture)**&#x200B;에 [콘텐츠 조각을 게시](/help/sites-cloud/administering/content-fragments/content-fragments-managing.md##publishing-and-previewing-a-fragment)하여 콘텐츠 조각 사용을 통해 제공되는 경험을 미리 볼 수도 있습니다.

>[!CAUTION]
>
>**미리보기 서비스** 게시는 **콘텐츠 조각** 콘솔에서만 사용할 수 있습니다.
...
* **자산**&#x200B;으로 저장됩니다.
   ...
   * 콘텐츠 조각(및 그 변형)은 **콘텐츠 조각** 콘솔 및 **자산** 콘솔 모두에서 만들고 유지 관리할 수 있습니다.
...
* **관련 콘텐츠**
   ...
   * 자산은 [컬렉션을 통해 조각에 연결](/help/sites-cloud/administering/content-fragments/content-fragments-assoc-content.md)됩니다. 연결된 컬렉션은 작성자가 페이지를 작성할 때 사용할 자산을 결정할 수 있도록 해 줍니다.
