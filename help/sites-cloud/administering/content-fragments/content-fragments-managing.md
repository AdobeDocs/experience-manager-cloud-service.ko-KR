...
>[!NOTE]
>
>콘텐츠 조각은 **에셋**&#x200B;으로 저장됩니다. 주로 **콘텐츠 조각** 콘솔에서 관리되지만 [에셋](/help/assets/content-fragments/content-fragments-managing.md) 콘솔에서도 관리할 수 있습니다.
...
조각과 [콘텐츠를 연결](/help/sites-cloud/administering/content-fragments/content-fragments-assoc-content.md)할 수도 있습니다. 이렇게 하면 조각이 콘텐츠 페이지에 추가될 때 에셋(즉, 이미지)을 조각과 함께 필요에 따라 사용할 수 있도록 연결을 제공합니다.
...
* 다음 **[서비스 게시](/help/overview/architecture.md#runtime-architecture)** - 전체, 공용 액세스

* 다음 **[미리보기 서비스](/help/overview/architecture.md#runtime-architecture)** - 전체 가용성 전에 콘텐츠 미리보기

   >[!CAUTION]
   에 콘텐츠 조각 게시 **미리보기 서비스** 은(는) 다음에서만 사용할 수 있습니다. [콘텐츠 조각 콘솔](/help/sites-cloud/administering/content-fragments/content-fragments-console.md); 사용 **게시** 작업.
...
를 사용하여 콘텐츠 조각을 게시하려면 **게시** 을 클릭합니다. [콘텐츠 조각 콘솔](/help/sites-cloud/administering/content-fragments/content-fragments-console.md#actions-selected-content-fragment):
...
1. 목록에서 조각을 하나 이상 선택합니다.

1. 도구 모음에서 를 선택합니다. **게시** 그런 다음 다음 다음 중 하나를 선택하여 적절한 대화 상자를 엽니다.

   * **지금** - 다음 중 하나를 선택합니다. **서비스 게시**&#x200B;또는 **미리보기 서비스**; 확인 후 조각이 즉시 게시됩니다.
   * **예약** - 필요한 서비스 외에도 조각을 게시할 날짜 및 시간을 선택할 수도 있습니다.

   필요한 경우 게시할 참조를 지정해야 합니다. 기본적으로 콘텐츠에 브레이크가 발생하지 않도록 미리보기 서비스에 참조가 게시됩니다.
예를 들어 예약된 게시 요청의 경우:
   ![게시 대화 상자](assets/cfm-publish-01.png)

1. 게시 작업을 확인합니다.

에 게시할 수도 있습니다. **서비스 게시** 다음에서 [콘텐츠 조각 편집기](#toolbar-actions-in-the-content-fragment-editor) 사용:
* **빠른 게시**
* **게시 관리**

>[!NOTE]
이후 [조각을 사용하는 페이지 게시](/help/sites-cloud/authoring/fundamentals/content-fragments.md#publishing); 페이지 참조에 조각이 나열됩니다.
...
콘텐츠 조각 게시를 취소하려면 하나 이상의 조각을 선택한 다음, **게시 취소** 의 도구 모음에서 [콘텐츠 조각 콘솔](/help/sites-cloud/administering/content-fragments/content-fragments-console.md#actions-selected-content-fragment). 다음을 선택할 수 있습니다. **지금** 또는 **예약됨**.

관련 대화 상자가 열리면 적절한 서비스를 선택할 수 있습니다.
![게시 취소 대화 상자](assets/cfm-unpublish-01.png)

>[!NOTE]
다음 **게시 취소** 게시된 조각을 사용할 수 있는 경우에만 작업이 표시됩니다.
