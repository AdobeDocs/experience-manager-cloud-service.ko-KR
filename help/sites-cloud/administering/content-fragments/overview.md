...
>[!TIP]
>
>콘텐츠 조각은 [Edge Delivery Services에 게시할 수 있습니다.](https://www.aem.live/developer/content-fragment-overlay)
...
* **콘텐츠 조각 모델**
   ...
   * [구성 브라우저를 사용하여 활성화됨](/help/sites-cloud/administering/content-fragments/setup.md)입니다.
   * 콘텐츠 조각 콘솔을 사용하여 [만들어짐](/help/sites-cloud/administering/content-fragments/managing-content-fragment-models.md#creating-a-content-fragment-model)입니다.
