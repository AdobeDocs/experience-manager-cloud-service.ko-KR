...
>[!IMPORTANT]
>
>이 섹션에 설명된 많은 기능은 [통합 셸](/help/overview/aem-cloud-service-on-unified-shell.md)에서 *전용*&#x200B;이므로 로컬 인스턴스가 아닌 *온라인* Adobe Experience Manager(AEM) as a Cloud Service에서 사용할 수 있습니다.
