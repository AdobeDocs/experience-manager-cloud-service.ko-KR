...
![라이브 카피 구성 개요](../assets/live-copy-composition.png)

#### 라이브 카피가 아닌 페이지를 포함하는 라이브 카피 {#live-copy-with-non-live-copy-pages}

AEM에서 라이브 카피를 만들 때 라이브 카피 분기를 확인하고 탐색할 수 있으며 라이브 카피 분기에 일반 AEM 기능을 사용할 수 있습니다. 즉, 사용자(또는 프로세스)는 라이브 카피 내부에 새 리소스(페이지 및/또는 단락)을 만들 수 있습니다. 예를 들어 특정 지역 또는 국가에 대한 제품입니다.
