...
1. **만들기**&#x200B;를 선택합니다. 표시되는 확인 메시지에서 **열기** 또는 **완료** 중 하나를 선택할 수 있습니다.
...
라이브 카피를 동기화하는 방법에는 여러 가지가 있습니다.
...
1. 속성의 상속을 취소하려면 속성 오른쪽에 나타나는 링크 아이콘을 선택합니다.
