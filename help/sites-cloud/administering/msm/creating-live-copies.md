...
1. 다음을 입력합니다.
   ...
   * URL에 사용할 **이름**
   ...
   ![라이브 카피 속성](../assets/live-copy-properties.png)
...
1. **만들기**&#x200B;를 클릭하거나 탭합니다. 표시되는 확인 메시지에서 다음 중 하나를 선택할 수 있습니다. **열기** 또는 **완료**.
...
1. **초기 챕터** 드롭다운을 사용하여 라이브 카피에 포함할 블루프린트의 섹션을 선택합니다. 기본적으로 사용할 수 있는 모든 챕터가 포함되어 있지만 필요하지 않은 챕터를 제거할 수 있습니다.
...
1. **라이브 카피** 탭을 선택합니다.
   ...
   자세한 내용은 라이브 카피 개요 콘솔 문서의 [라이브 카피 사용 개요](live-copy-overview.md#using-the-live-copy-overview) 섹션을 참조하십시오.
...
페이지에 대한 라이브 카피 상속을 일시 중단하는 것은 임시적인 작업입니다. 일시 중단하면 라이브 관계를 복원할 수 있는 **다시 시작** 작업을 사용할 수 있게 됩니다.
...
1. 를 엽니다. [라이브 카피 개요](live-copy-overview.md#using-the-live-copy-overview) 일시 중단된 라이브 카피 페이지를 선택합니다. 페이지는 다음과 같이 표시됩니다. **상속이 취소됨**.
...
* 롤아웃 시 블루프린트에서 구성 요소 순서가 복원됩니다. 롤아웃 전에 라이브 카피에 새 구성 요소가 추가된 경우 추가된 구성 요소는 위에 있는 구성 요소와 함께 순서가 변경됩니다.
...
라이브 카피 페이지를 재설정하여 다음을 수행할 수 있습니다.
...
1. 확인 대화 상자가 표시되면 **분리** 을 클릭하여 작업을 완료합니다.
...
1. **라이브 카피 분리** 대화 상자에서 **분리** 작업을 확인합니다.
   ...
   ![라이브 카피 분리](../assets/detach-live-copy.png)
