...
description: 사이트 테마를 활용하여 더욱 간편하게 사이트를 맞춤화하기 위해 기존 사이트에 대해 프론트엔드 파이프라인을 활성화하는 방법에 대해 알아봅니다.
...
사이트 테마를 활용하여 더욱 간편하게 사이트를 맞춤화하기 위해 기존 사이트에 대해 프론트엔드 파이프라인을 활성화하는 방법에 대해 알아봅니다.
...
사이트 템플릿을 기반으로 하는 사이트는 기본적으로 프론트엔드 파이프라인을 활용할 수 있습니다. 이 문서에서는 기존 사이트를 조정하여 프론트엔드 파이프라인을 활용하는 방법에 대해 설명합니다.
