...
1. **언어 사본 업데이트**&#x200B;를 선택한 다음 속성을 구성하십시오.
...
1. 추가 및 I18N-사전 을 클릭합니다.
   ...
   ![i18n 사전 추가](../assets/add-i18n.png)
...
1. 언어 마스터에서 페이지를 선택하고 **참조**&#x200B;를 선택한 다음 **언어 사본**&#x200B;을 선택합니다.
1. 검토할 언어 사본을 선택하십시오.
...
AEM은 여러 번역 솔루션 및 인터페이스를 제공하지만 번역 작업 정보를 수동으로 가져오고 내보낼 수도 있습니다.
...
번역된 컨텐츠는 커넥터를 통해 AEM과 통합되지 않아 번역 공급업체에서 전송한 경우 등의 작업을 통해 AEM으로 가져올 수 있습니다.
