...
1. 게시할 태그를 선택하고 도구 모음에서 **게시**&#x200B;를 선택합니다.
...
콘솔에서 선택한 태그가 대화 상자에서 지정된 태그에 병합됩니다. 참조된 태그가 이동하거나 병합되더라도 태그가 물리적으로 삭제되지는 않으므로 참조를 유지할 수 있습니다. 자세한 내용은 [AEM 태깅 프레임워크](/help/implementing/developing/introduction/tagging-framework.md#moving-and-merging-tags)를 참조하십시오.
