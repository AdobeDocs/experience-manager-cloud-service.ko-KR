...
1. 탐색을 사용하여 **도구**&#x200B;를 선택한 다음 **워크플로**&#x200B;를 선택합니다.
1. 현재 진행 중인 워크플로 인스턴스 목록을 표시하려면 **인스턴스**&#x200B;를 선택합니다. 상단 레일의 왼쪽 모서리에서 **필터**&#x200B;를 선택합니다. 또는 키 입력 alt+1을 사용할 수 있습니다. 다음 대화 상자가 표시됩니다.
...
서비스를 구성하려면 [OSGi 구성 파일](/help/implementing/deploying/configuring-osgi.md)을(를) 참조하십시오. 다음 표에서는 두 방법 중 하나에 필요한 속성에 대해 설명합니다.
...
**Adobe Granite Workflow Service**&#x200B;를 구성하여 받은 편지함의 최대 크기를 설정할 수 있습니다. [저장소](/help/implementing/deploying/configuring-osgi.md)에 OSGi 구성 추가를 참조하십시오. 다음 표에서는 구성하는 속성에 대해 설명합니다.
