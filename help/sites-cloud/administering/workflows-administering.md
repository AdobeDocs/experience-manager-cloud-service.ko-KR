---
title: 워크플로우 인스턴스 관리
description: 워크플로우 인스턴스 관리 방법 학습
...
워크플로우 관리에 다양한 콘솔을 사용할 수 있습니다. 전역 탐색 [을 사용하여](/help/sites-cloud/authoring/getting-started/basic-handling.md#global-navigation) 도구 **** 창을 **연 다음**&#x200B;작업 흐름을 선택합니다.
...
## 워크플로우 인스턴스 검색 {#search-workflow-instances}

1. 탐색 사용 도구 **를**&#x200B;선택한 다음 **워크플로우를 선택합니다**.
1. 인스턴스 **를** 선택하여 현재 진행 중인 워크플로우 인스턴스 목록을 표시합니다. 상단 레일의 왼쪽 모서리에서 필터 **를 선택합니다**. 또는 키 입력 alt+1을 사용할 수 있습니다. 다음 대화 상자가 표시됩니다.

   ![wf-99-1](/help/sites-cloud/administering/assets/wf-99-1.png)

1. 필터 대화 상자에서 워크플로우 검색 기준을 선택합니다. 다음 입력에 따라 검색할 수 있습니다.
...
서비스를 구성하려면 OSGi 구성 파일을 구성하여 [OSGi 구성 파일을 볼 수 있습니다](/help/implementing/deploying/configuring-osgi.md). 다음 표에서는 두 방법 중 하나에 필요한 속성에 대해 설명합니다.
...
[ **Adobe [Granite Workflow Service]를 구성하여 받은 편지함의 최대 크기를 설정할 수 있습니다**. 저장소에 OSGi 구성 [추가를 참조하십시오](/help/implementing/deploying/configuring-osgi.md). 다음 표에서는 구성하는 속성에 대해 설명합니다.
