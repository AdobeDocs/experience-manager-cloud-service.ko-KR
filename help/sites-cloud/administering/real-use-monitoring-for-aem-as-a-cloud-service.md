...
>[!NOTE]
>
>Adobe이 다음을 발표하게 되어 기쁩니다. [GA 롤아웃](/help/release-notes/release-notes-cloud/release-notes-current.md#real-use-monitoring) Real Use Monitoring 서비스의 경우 클라이언트측 데이터 수집입니다. 자동화된 서비스이며 고객 설정이 필요하지 않습니다.
...
RUM(Real Use Monitoring) 서비스는 웹 사이트 또는 애플리케이션의 디지털 사용자 경험을 실시간으로 캡처하고 분석하는 성능 모니터링 기술입니다. 웹 애플리케이션의 실시간 성능에 대한 가시성을 제공하고 최종 사용자 경험에 대한 보다 심층적인 통찰력을 제공합니다. &quot;실제 사용자 모니터링&quot;은 서비스의 진정한 본질을 더 잘 반영하기 때문에 &quot;실제 사용 모니터링&quot;으로 새롭게 브랜딩되었습니다. 이 서비스는 사용자 자신보다 웹 사이트 참여를 모니터링하여 성능을 최적화하는 데 중점을 둡니다.
