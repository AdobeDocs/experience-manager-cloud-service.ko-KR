...
description: AEM 사이트 편집기의 사이드 패널을 사용하여 페이지에 구성 요소 및 에셋을 추가하는 방법을 알아봅니다.
...
AEM 사이트 편집기의 사이드 패널을 사용하여 페이지에 구성 요소 및 에셋을 추가하는 방법을 알아봅니다.

## 사이드 패널 모드 {#modes}

페이지 편집기의 도구 모음에서 **사이드 패널 전환** 아이콘을 탭하거나 클릭하여 페이지 편집기에서 항상 사이드 패널에 액세스할 수 있습니다.

![사이드 패널 토글](assets/editor-side-panel-side-panel-toggle.png)
