---
title: 페이지 편집기로 편집할 수 있는 페이지를 만드는 템플릿
description: 템플릿 편집기 를 사용하여 콘텐츠 작성자가 페이지 편집기로 편집할 수 있는 페이지를 만드는 데 사용할 수 있는 템플릿을 만들 수 있습니다.
...
# 페이지 편집기로 편집할 수 있는 페이지를 만드는 템플릿 {#creating-page-templates}

템플릿 편집기 를 사용하여 콘텐츠 작성자가 페이지 편집기로 편집할 수 있는 페이지를 만드는 데 사용할 수 있는 템플릿을 만들 수 있습니다.

## 개요 {#overview}

작성자는 페이지를 만들 때 새 페이지의 기반으로 사용되는 템플릿을 선택해야 합니다. 템플릿은 결과 페이지의 구조, 초기 컨텐츠 및 페이지 편집기에서 페이지를 편집할 때 사용할 수 있는 구성 요소를 정의합니다.
...
이 문서에서는 **템플릿 작성자**&#x200B;가 **템플릿 편집기**&#x200B;를 사용하여 편집 가능한 템플릿을 만들고 관리하는 방법을 설명합니다.

편집 가능한 템플릿이 기술 수준에서 작동하는 방법에 대한 자세한 내용은 개발자 문서 [편집 가능한 템플릿](/help/implementing/developing/components/templates.md)을 참조하십시오.
...
새 템플릿을 만들려면 다음 역할 간의 공동 작업이 필요합니다.
...
프로젝트에 프로젝트 특정 템플릿을 포함하려면 템플릿 폴더를 만들어야 합니다. 이는 관리자 작업이며 [페이지 템플릿](/help/implementing/developing/components/templates.md#template-folders) 문서에 설명되어 있습니다.

### 새 템플릿 만들기 - 템플릿 작성자 {#creating-a-new-template-template-author}

1. **[템플릿 콘솔](/help/sites-cloud/administering/templates-console.md)**&#x200B;을 연 다음 필요한 폴더로 이동합니다.
...
템플릿을 만든 후 **[템플릿 콘솔](/help/sites-cloud/administering/templates-console.md)**&#x200B;을 사용하여 템플릿 속성을 보거나 편집합니다.
...
**[템플릿 콘솔](/help/sites-cloud/administering/templates-console.md)**&#x200B;을 사용하여 템플릿을 활성화하거나 비활성화하십시오.
...
**[템플릿 콘솔](/help/sites-cloud/administering/templates-console.md)**&#x200B;을 사용하여 템플릿을 게시합니다.
...
>[!CAUTION]
>
>AEM에서 자르기 비율은 **높이/폭**(으)로 정의됩니다. 이는 종래의 폭/높이 정의와 다르며, 레거시 호환성을 위해 수행됩니다. **이름**&#x200B;을 명확히 정의한 경우 이 이름이 UI에 표시되므로 페이지 작성 사용자가 차이를 알지 못합니다.
...
1. [템플릿 콘솔](#publishing-a-template-template-author)(/help/sites-cloud/administering/templates-console.md)에서 **[템플릿을 게시]**&#x200B;합니다.
