---
title: 콘솔용 키보드 단축키
description: 다음 키보드 단축키를 사용하여 작성 시간 절약
...
AEM은 많이 사용되는 브라우저에서 이미 사용되는 일반적인 단축키를 사용하지 않지만 AEM 단축키에서 기본 브라우저 동작이 재정의되지 않습니다.

또한 키보드 단축키는 모든 로케일과 키보드 레이아웃에 동일합니다.

>[!NOTE]
>
>AEM 단축키는 기본 브라우저 동작을 재정의하지 않습니다.
>
>AEM과 브라우저 단축키 간에 충돌이 발생하는 경우 AEM 단축키가 작동하지 않아 브라우저 기능이 작동하지 않습니다.

>[!CAUTION]
>
>AEM 키보드 단축키는 화면 판독기, 일부 브라우저 기능 및 기타 접근성 도구에 방해가 될 수 있습니다.
>
