...
* [도움말](#accessing-help)
   ...
   ![도움말 단추](/help/sites-cloud/authoring/assets/help.png)

* [알림](/help/sites-cloud/authoring/getting-started/inbox.md)

   ![알림 단추](/help/sites-cloud/authoring/assets/notifications.png)

   이 아이콘에는 현재 할당된 불완전 알림 수가 배지로 지정됩니다.

* [사용자 속성](/help/sites-cloud/authoring/getting-started/account-environment.md)

   ![사용자 속성 단추](/help/sites-cloud/authoring/assets/user-properties.png)
...
* 키보드 탐색
   ...
   **사이트** 콘솔에는 **주 컨텐츠로 이동**&#x200B;하는 옵션이 추가되었습니다. 이 옵션은 헤더 옵션을 탭할 때 표시되며, (제품) 도구 모음에서 표준 요소를 건너뛰고 주 컨텐츠로 바로 이동할 수 있도록 하여 탐색 시간을 단축할 수 있습니다.

   ![주 컨텐츠로 이동](/help/sites-cloud/authoring/assets/skip-to-main-content.png)
...
* **탐색**
   ...
   ![자습서](/help/sites-cloud/authoring/assets/tutorial.png)

* **페이지 편집기**

   페이지를 처음 편집하면 일련의 슬라이드를 통해 페이지 편집기에 대한 설명을 볼 수 있습니다.

   ![편집기 자습서](/help/sites-cloud/authoring/assets/editor-tutorial.png)
...
필터를 선택하면 해당 위치 필터가 이미 설정된 [검색](/help/sites-cloud/authoring/getting-started/search.md)과 비슷한 패널이 열리므로, 보려는 컨텐츠를 추가로 필터링할 수 있습니다.
