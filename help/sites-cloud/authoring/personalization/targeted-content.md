...
1. 선택 **타겟팅**. 페이지 상단에 타겟팅 옵션이 표시됩니다.
...
1. 다음 옆에 있는 + 을(를) 선택합니다. **활동** 드롭다운 메뉴.
1. 활동 이름을 입력합니다.
...
1. 타겟팅 프로세스를 안내하는 컨트롤을 표시하려면 다음을 선택합니다. **타깃팅 시작**.

   ![타겟팅 시작](../assets/targeted-start-targeting.png)

   >[!NOTE]
   >
   >작업 중인 활동을 변경하려면 다음을 선택합니다 **뒤로**.
...
1. 경험을 추가하려면 다음을 선택합니다. **+** **경험 타깃팅 추가** 의 기존 경험 아래에 나타나는 값: **대상** 창.
1. 대상자를 선택합니다. 기본적으로 해당 이름은 경험의 이름입니다. 원하는 경우, 다른 이름을 입력할 수 있습니다. 선택 **확인**.
...
타겟팅된 콘텐츠를 편집하는 경우 다음을 선택해야 합니다. **타깃팅 시작** 그렇게 하기 전에.
...
1. 라이브러리에서 오퍼를 선택한 다음 확인 표시 아이콘을 선택합니다.
   ...
   * 선택 **찾아보기** 다른 폴더로 이동합니다. 탐색 창이 열리면 화살표를 클릭하여 폴더로 드릴다운합니다. 선택 **찾아보기** 다시 클릭하여 탐색 창을 닫습니다.

   ![콘텐츠 검색](../assets/targeted-select-content-browse.png)

   * 선택 **필터** 키워드 또는 태그에 대해 오퍼를 필터링합니다. 키워드를 입력하고 드롭다운 메뉴에서 태그를 선택합니다. 선택 **필터** 필터링 창을 닫으려면 다시 시도하십시오.
   ...
   * **가장 최근에서 가장 오래된 순으로** 옆에 있는 화살표를 클릭하거나 탭하여 오퍼를 정렬하는 방법을 변경합니다. 오퍼를 가장 최근 오퍼에서 가장 오래된 오퍼순으로 또는 가장 오래된 오퍼에서 가장 최근 오퍼순으로 정렬할 수 있습니다.
   ...
   옆에 있는 아이콘 선택 **다음으로 보기** 오퍼를 타일이나 목록으로 표시합니다.
...
1. 사용자 정의 오퍼를 선택하여 오퍼 메뉴를 표시한 다음 **오퍼 라이브러리에 오퍼 저장** 아이콘.
...
1. (선택 사항) 선택 **편집** 그런 다음 키워드를 입력하여 원하는 세그먼트를 검색합니다.
1. 대상자 목록에서 대상자를 선택하고 을 선택합니다 **확인**.
...
1. 성공 지표를 카운트하는 방법을 추가로 제어하려면 **고급 설정** 액세스 권한.
1. **저장**&#x200B;을 클릭합니다.
...
1. 미리보기 모드로 전환하려면 도구 모음에서 를 선택합니다. **미리 보기**.
