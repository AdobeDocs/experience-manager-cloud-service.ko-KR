...
![대상 관리](/help/sites-cloud/authoring/assets/contexthub-segmentation-audiences.png)
...
![세그먼트 편집기](/help/sites-cloud/authoring/assets/contexthub-segment-editor.png)
...
1. 세그먼트에 [액세스한](#accessing-segments)후 만들기 단추를 클릭하거나 탭하고 ContextHub 세그먼트 **만들기를 선택합니다**.

   ![세그먼트 추가](/help/sites-cloud/authoring/assets/contexthub-create-segment.png)

1. 새 **ContextHub**&#x200B;세그먼트에서 세그먼트 제목과 필요한 경우 증폭 값을 입력한 다음 만들기를 **탭하거나 클릭합니다**.

   ![새 세그먼트](/help/sites-cloud/authoring/assets/contexthub-new-segment.png)
...
1. 새 참조나 세그먼트의 구성 옵션을 두 번 클릭하거나 탭하여 특정 매개 변수를 편집합니다. 이 예에서는 바젤에 있는 사람들을 대상으로 테스트를 하고 있습니다.
   ...
   ![바젤주의 사용자 테스트](/help/sites-cloud/authoring/assets/contexthub-comparing-property-value.png)
...
![OR 연산자가 있는 세그먼트](/help/sites-cloud/authoring/assets/contexthub-or-operator.png)
...
![세그먼트](/help/sites-cloud/authoring/assets/contexthub-segment-resolve.png)

또는 해결되지 않은 경우:

![확인되지 않는 세그먼트](/help/sites-cloud/authoring/assets/contexthub-segment-doesnt-resolve.png)
