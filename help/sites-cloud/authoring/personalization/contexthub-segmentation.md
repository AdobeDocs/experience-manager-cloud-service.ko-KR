...
1. **만들기** 단추를 선택하고 **ContextHub 세그먼트 만들기**&#x200B;를 선택합니다.

   ![세그먼트 추가](../assets/contexthub-create-segment.png)

1. **새 ContextHub 세그먼트**&#x200B;에서 세그먼트 제목과 필요한 경우 부스트 값을 입력한 다음 **만들기**&#x200B;를 선택하십시오.
...
1. [세그먼트에 액세스](#accessing-segments)한 후 **만들기** 단추를 선택하고 **폴더**&#x200B;를 선택합니다.
...
1. [세그먼트에 액세스](#accessing-segments)한 후 수정할 폴더를 선택하여 선택합니다.

   ![폴더 선택](../assets/contexthub-select-folder.png)

1. 도구 모음에서 **이름 바꾸기**&#x200B;를 선택하여 폴더의 이름을 변경합니다.

1. 새 **폴더 제목**&#x200B;을 입력하고 **저장**&#x200B;을 선택하세요.
...
1. 폴더를 삭제하려면 도구 모음에서 **삭제**&#x200B;를 선택하십시오.
