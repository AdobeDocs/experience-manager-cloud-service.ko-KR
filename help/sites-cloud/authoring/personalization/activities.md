...
1. 활동을 만들 브랜드를 클릭하거나 탭한 다음, **만들기** 및 **활동 만들기**&#x200B;를 차례대로 클릭하거나 탭합니다. 편집하는 경우, 마스터 영역 화면에서 활동을 선택하고 **활동 편집**&#x200B;을 클릭하거나 탭합니다.
...
1. 게시하려면 **게시**&#x200B;를 탭하거나 클릭합니다. 게시를 취소하려면 **게시 취소**&#x200B;를 탭하거나 클릭합니다. 활동이 게시되거나 게시 취소되고, 활동 콘솔에서 활동 상태가 변합니다(새로 고침이 필요할 수 있음).
