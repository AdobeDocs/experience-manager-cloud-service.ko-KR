...
1. 탐색 콘솔에서 **Personalization**&#x200B;을(를) 선택합니다. **활동**&#x200B;을 선택하세요.

   ![활동으로 이동](/help/sites-cloud/authoring/assets/activities-navigation.png)

1. 활동 콘솔에서 **브랜드 만들기**&#x200B;다음&#x200B;**를 선택합니다**.
...
1. 활동을 만들 브랜드를 선택한 다음 **만들기**, **활동 만들기**&#x200B;를 선택하십시오. 편집하는 경우, 마스터 영역 화면에서 활동을 선택하고 **활동 편집**&#x200B;을 클릭하거나 탭합니다.
1. 다음 정보를 입력한 다음 **다음**&#x200B;을(를) 선택하십시오.
   * 활동 이름.
   ...
   * (옵션) 활동의 목표 또는 설명입니다.
   * 활동 유형을 선택합니다.
1. 활동에 하나 이상의 경험을 추가합니다. **경험 추가**&#x200B;를 선택합니다.
...
1. 게시하려면 **Publish**&#x200B;을(를) 선택하십시오. 게시를 취소하려면 **게시 취소**&#x200B;를 선택하십시오. 활동이 게시되거나 게시 취소되고, 활동 콘솔에서 활동 상태가 변합니다(새로 고침이 필요할 수 있음).
...
1. **Personalization**&#x200B;에서 **활동**&#x200B;을 선택하여 **활동** 콘솔로 이동합니다.
1. 활동을 보려는 브랜드를 선택합니다.
1. 활동을 선택하고 **속성 보기**&#x200B;를 선택한 다음 **보고서** 탭을 클릭하고 성능을 확인하거나 우승 경험을 전환할 활동을 선택합니다. 성능 데이터가 표시됩니다.

   ![활동 성능 확인](/help/sites-cloud/authoring/assets/activities-performance.png)

1. **우승자 푸시** 링크를 선택하여 해당 경험을 기본 경험으로 푸시합니다.
...
1. 우승자를 전환하려면 **예**&#x200B;를 선택하여 현재 경험을 비활성화하고 우승 경험의 콘텐츠로 바꿉니다.
