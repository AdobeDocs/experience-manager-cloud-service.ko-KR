...
사이트나 Live Copy는 해당 사이트나 Live Copy에서 사용 가능해야 하는 활동을 포함하는 영역에 연결합니다. 기본적으로 사이트 또는 라이브 카피는 마스터 영역에 연결되지만, 마스터 영역 이외의 다른 영역에도 연결될 수 있습니다.
...
1. 활동을 일시 중단하려면 다음 중 하나를 수행하십시오.
   ...
   1. 대상과 같은 활동의 요소를 선택합니다. AEM에 Live Copy 일시 중단을 확인하는 상자가 자동으로 표시됩니다. (타겟팅 프로세스에서 임의의 요소를 탭하거나 클릭하여 Live Copy를 일시 중단할 수 있습니다.)
