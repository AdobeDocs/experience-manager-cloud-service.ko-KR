...
>[!TIP]
>
>페이지 관리를 시작하기 전에 [AEM에서 페이지를 구성하는 방법](/help/sites-cloud/authoring/sites-console/organizing-pages.md)을 숙지하십시오.
...
[페이지를 만들거나](/help/sites-cloud/authoring/sites-console/creating-pages.md) [사이트&#x200B;**콘솔**&#x200B;을 사용하여 기존 페이지로 이동한 후 편집할 수 있도록 열 수 있습니다.](/help/sites-cloud/authoring/sites-console/introduction.md)
...
비동기 작업의 상태는 [**전역 탐색** > &#x200B;](/help/operations/asynchronous-jobs.md#monitor-the-status-of-asynchronous-operations)도구&#x200B;**>**&#x200B;작업&#x200B;**>**&#x200B;작업&#x200B;**의**&#x200B;비동기 작업 상태&#x200B;**대시보드**&#x200B;에서 확인할 수 있습니다.
