...
>[!NOTE]
>
>특정 작업은 [해당 리소스의 카드 보기](/help/sites-cloud/authoring/basic-handling.md#card-view)에도 표시됩니다.
...
>[!NOTE]
>
>받은 편지함은 콘솔로 작동하므로 완료되면 [전역 탐색](/help/sites-cloud/authoring/basic-handling.md#global-navigation) 또는 [검색](/help/sites-cloud/authoring/search.md)을 사용하여 다른 위치를 탐색합니다.
