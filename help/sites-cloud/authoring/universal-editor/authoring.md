...
앱이 범용 편집기에서 작동하도록 계측되면 범용 편집기는 AEM 내에서 as a Cloud Service으로 그리고 AEM에 액세스하지 않고 직접 액세스할 수 있습니다.

### AEM 내에서 as a Cloud Service 액세스 {#accessing-aem}

1. AEM as a Cloud Service 제작 인스턴스에 로그인합니다.
1. 사용 [**사이트** 콘솔](/help/sites-cloud/authoring/sites-console/introduction.md) 편집할 범용 편집기에서 사용하기 위해 만든 페이지로 이동합니다.
1. 페이지를 편집합니다.
1. 선택한 페이지를 편집할 수 있는 범용 편집기가 열립니다.

>[!NOTE]
>
>에서 페이지 편집 시 [**사이트** 콘솔,](/help/sites-cloud/authoring/sites-console/introduction.md) 콘솔에서 페이지의 [템플릿:](/help/sites-cloud/authoring/sites-console/templates.md) 이 문서에 설명된 유니버설 편집기 또는 [페이지 편집기.](/help/sites-cloud/authoring/page-editor/introduction.md)

### 직접 액세스 {#accessing-directly}

1. 범용 편집기에 로그인합니다. 로그인하려면 Adobe ID이 필요합니다. [유니버설 편집기에 액세스할 수 있습니다.](/help/implementing/universal-editor/getting-started.md#request-access)
...
>[!NOTE]
>
>유니버설 편집기로 편집할 모든 페이지는 다음과 같아야 합니다. [유니버설 편집기를 지원하도록 계측되었습니다.](/help/implementing/universal-editor/getting-started.md)
