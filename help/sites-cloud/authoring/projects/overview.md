...
| 편집자 | 이 역할의 사용자는 프로젝트 컨텐츠를 업로드하고 편집할 수 있습니다. | 프로젝트, 관련 메타데이터 및 관련 자산에 대한 읽기 및 쓰기 액세스 권한촬영 목록을 업로드하고 자산을 검토 및 승인할 권한./etc/commerce에 대한 쓰기 권한특정 프로젝트에 대한 권한 수정 | workflow-users 그룹 |
