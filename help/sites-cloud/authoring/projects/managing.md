...
다음에서 **프로젝트** 콘솔을 통해 프로젝트에 액세스하고 작업을 수행합니다.
...
1. 선택 **타일 추가** 프로젝트에 연결할 타일을 선택합니다. 여러 유형의 타일을 선택할 수 있습니다.
...
1. 대화 상자에서 삭제를 확정해야 합니다. 확정하면 프로젝트 또는 리소스 링크가 삭제됩니다. 선택 **선택 취소** 을 클릭하여 선택 모드를 종료합니다.
...
1. 위치 **프로젝트**(으)로 이동하여 항목을 추가하려는 타일에 있는 아래쪽 V자 버튼을 선택합니다.
...
프로젝트 타임라인에서는 프로젝트의 자산이 마지막으로 사용된 시기에 대한 정보를 제공합니다. 프로젝트 타임라인을 보려면 **타임라인**&#x200B;을 클릭한 다음 선택 모드에 들어가 프로젝트를 선택합니다. 자산은 왼쪽 창에 표시됩니다. 선택 **타임라인** (으)로 돌아가기 **프로젝트** 콘솔.
