...
AEM에서는 마지막 세 단계만 실제로 수행됩니다. 즉, 필요한 CSS와 JavaScript의 모든 개발은 AEM 없이 수행할 수 있습니다.
...
>[!CAUTION]
>
>구성 요소 정책의 스타일 속성으로 구성된 CSS 클래스(및 필요한 JavaScript)는 다음과 같이 배포해야 합니다. [클라이언트 라이브러리](/help/implementing/developing/introduction/clientlibs.md) 일 때문에.
