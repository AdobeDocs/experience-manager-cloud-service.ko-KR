...
1. 이제 다음의 경우에 템플릿을 사용할 수 있습니다. [페이지 만들기](/help/sites-cloud/authoring/fundamentals/organizing-pages.md#creating-a-new-page), 하지만 다음을 원할 수 있습니다. [템플릿 편집](#editing-templates-template-authors) 귀하의 요구 사항에 따라.
