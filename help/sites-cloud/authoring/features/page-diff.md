...
예를 들어 버전을 비교하는 경우 현재 버전은 왼쪽에 표시되고 이전 버전은 오른쪽에 표시됩니다.
...
>[!NOTE]
>
>페이지 차이 메커니즘 작업 및 페이지 차이에 영향을 줄 수 있는 제한 사항에 대한 자세한 내용은 을 참조하십시오. [개발자 설명서](/help/implementing/developing/introduction/page-diff.md) 을 참조하십시오.
