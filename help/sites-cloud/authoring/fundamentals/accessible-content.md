...
* 대비(최소): 텍스트 및 텍스트 이미지의 시각적 표현에는 다음을 제외하고 최소 4.5:1의 대비율이 있습니다.
   ...
   * 로고: 로고나 브랜드 이름에 속하는 텍스트에는 최소 대비 요구 사항이 없습니다.
   >[!NOTE]
   >
   >자세한 내용은 [텍스트가 아닌](https://www.w3.org/WAI/WCAG21/Understanding/non-text-contrast.html) 요소(아이콘, 인터페이스 요소 등)에 대한 추가 요구 사항을 독자가 이해할 수 있도록 하려면 텍스트가 아닌 대비 이해를 참조하십시오.
...
이 성공 기준의 의도는 사용자가 입력 오류 수정에 대한 적절한 제안을 받을 수 있도록 하기 위함입니다. &quot;입력 오류&quot;에 대한 WCAG 2.0 정의에서는 시스템에서 &quot;허용되지 않는 사용자가 제공한 정보&quot;라고 말합니다. 허용되지 않는 정보의 일부 예에는 필수 사항이지만 사용자가 생략한 정보와 필수 데이터 형식 또는 허용된 값을 벗어나는 정보가 포함됩니다.
