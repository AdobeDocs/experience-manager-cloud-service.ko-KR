...
새 페이지를 만들 때 페이지 **이름**&#x200B;을 제공하면 AEM이 AEM 및 JCR에서 지정한 [규칙에 따라 이름을 확인](/help/implementing/developing/introduction/naming-conventions.md)합니다. **이름** 필드에 잘못된 문자를 제출할 수 없습니다. AEM에서 잘못된 문자를 감지하면 필드에 설명 메시지가 강조 표시됩니다.
...
1. 다음에서 **대상 선택** 마법사의 단계에서는 다음 중 하나를 수행할 수 있습니다.
   ...
   * 사용 **뒤로** 을 눌러 페이지 이름 지정으로 돌아갑니다.
   ...
   >[!NOTE]
   >
   >기본적으로 이동/이름 변경 중인 페이지의 상위 항목이 대상으로 선택됩니다.
