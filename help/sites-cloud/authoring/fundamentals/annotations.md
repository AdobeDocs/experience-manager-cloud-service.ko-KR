...
>[!TIP]
>
>요구 사항에 따라 다음을 개발할 수도 있습니다. [워크플로우](/help/sites-cloud/authoring/workflows/overview.md) 주석이 추가, 업데이트 또는 삭제될 때 알림을 보내려면
...
1. [주석 시작 모드](#annotate-mode) 클릭합니다.
...
1. 특정 주석의 편집이 끝나면 다음 작업을 할 수 있습니다.
   ...
   * 텍스트 마커를 클릭하거나 탭하여 주석을 엽니다. 열리면 전체 텍스트를 보거나, 변경하거나, [주석을 삭제합니다.](#deleting-annotations)
   * 텍스트 마커 위치 변경.
