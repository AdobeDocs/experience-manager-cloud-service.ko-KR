...
>* 이 워크플로우는 개발 팀에서 사용자 정의했을 수 있습니다.
...
**게시 관리**&#x200B;는 **빠른 게시**&#x200B;보다 더 많은 옵션을 제공하여 하위 페이지 포함, 참조 맞춤화, 적용 가능한 워크플로우 시작 등의 작업을 허용함과 동시에 나중에 게시할 수 있는 옵션을 제공합니다.
...
1. **게시 관리** 마법사가 시작됩니다. 첫 번째 단계, **옵션**&#x200B;를 사용하면 다음 작업을 수행할 수 있습니다.
   ...
   * **예약**
     ...
     >[!NOTE]
     >
     >나중에 게시/게시 취소를 취소하려면 [워크플로우 콘솔](/help/sites-cloud/administering/workflows-administering.md#suspending-resuming-and-terminating-a-workflow-instance)로 이동하여 해당 워크플로우를 종료합니다.
