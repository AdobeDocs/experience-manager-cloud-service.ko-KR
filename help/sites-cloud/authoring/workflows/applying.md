...
1. [리소스를](/help/sites-cloud/authoring/getting-started/basic-handling.md#viewing-and-selecting-resources) 선택하고 타임라인을 [엽니다](/help/sites-cloud/authoring/getting-started/basic-handling.md#timeline) (또는 타임라인을 연 다음 리소스를 선택합니다).
...
1. **범위** 단계에서 다음 내용을 선택할 수 있습니다.
   ...
   * **컨텐츠** 추가를 통해 [경로 브라우저를](/help/sites-cloud/authoring/fundamentals/environment-tools.md#path-browser) 열고 추가 리소스를 선택합니다.브라우저에서 선택을 클릭/탭하여 **컨텐츠를** 워크플로우 인스턴스에 추가합니다.
