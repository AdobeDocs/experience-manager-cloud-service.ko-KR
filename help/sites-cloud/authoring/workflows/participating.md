...
워크플로는 일반적으로 페이지나 에셋에 대해 사람이 활동을 수행해야 하는 단계를 포함합니다. 워크플로는 활동을 수행할 사용자 또는 그룹을 선택하고 해당 개인 또는 그룹에 작업 항목을 지정합니다. 사용자는 알림을 받은 다음 적절한 조치를 취할 수 있습니다.
...
* 페이지 편집기를 사용하는 경우 상태 표시줄에 다음이 표시됩니다.
   ...
   * 페이지가 적용되는 워크플로의 수. 다음과 같은 작업을 수행할 수 있습니다.
      ...
      * 실제 숫자를 클릭/탭하여 적용 가능한 모든 워크플로의 드롭다운 목록을 연 다음, 상태 표시줄에 표시할 워크플로를 선택합니다.
...
이 작업에서 다음을 나타낼 수 있습니다.

* **다음 단계**: 수행할 다음 단계입니다. 제공된 목록에서 선택할 수 있습니다
* **댓글**: 필요한 경우
...
1. **작업 항목 완료** 대화 상자가 열립니다. 다음 항목 선택 **다음 단계** 드롭다운 선택기에서 **댓글** 필요한 경우.
...
1. 를 엽니다. [편집할 페이지](/help/sites-cloud/authoring/fundamentals/organizing-pages.md#opening-a-page-for-editing).
...
1. 사용 가능한 작업을 표시하려면 경고 배너를 클릭/탭합니다. 선택 **고급**:
...
* **사용자**: 위임할 사용자이며, 제공된 목록에서 선택할 수 있습니다
* **댓글**: 필요한 경우
...
1. 필요한 페이지를 선택한 다음 **타임라인**&#x200B;을 엽니다(또는 **타임라인**&#x200B;을 연 다음 페이지 선택).
1. 사용 가능한 작업을 표시하려면 경고 배너를 클릭/탭합니다. 선택 **담당자 변경**:
...
* **이전 단계**: 반환할 단계입니다. 제공된 목록에서 선택할 수 있습니다
* **댓글**: 필요한 경우
...
타임라인을 사용하여 이전 단계로 롤백(단계)할 수도 있습니다.

1. 필요한 페이지를 선택한 다음 **타임라인**&#x200B;을 엽니다(또는 **타임라인**&#x200B;을 연 다음 페이지 선택).
1. 사용 가능한 작업을 표시하려면 경고 배너를 클릭/탭합니다. 선택 **롤백**:
...
워크플로 인스턴스와 연결된 페이로드에 대한 세부 사항을 볼 수 있습니다. 처음에는 패키지의 리소스가 표시된 다음 드릴다운하여 개별 페이지를 표시할 수 있습니다.
...
1. 도구 모음에서 **페이로드 보기**&#x200B;를 선택하여 대화 상자를 엽니다.
   * 워크플로 패키지는 단순히 저장소 내 경로에 대한 포인터 컬렉션이므로 여기에 항목을 추가/제거/수정하여 워크플로 패키지에서 참조되는 내용을 조정할 수 있습니다. 사용 **리소스 정의** 새 항목을 추가할 구성 요소입니다.
1. 링크는 개별 페이지를 여는 데 사용할 수 있습니다.
