...
* touch UI를 사용하여 AEM as a Cloud Service에서 Analytics 구성을 만듭니다. Adobe Analytics을 AEM as a Cloud Service과 통합하려면 IMS 인증이 필요합니다.
...
Adobe Analytics을 AEM as a Cloud Service과 제대로 통합하려면 IMS 구성이 필요합니다. 이 구성을 만들어야 하므로 다음을 참조하십시오 [페이지](/help/sites-cloud/integrating/integration-adobe-analytics-ims.md) analytics IMS 구성을 만드는 방법을 알아봅니다.
...
>[!NOTE]
>
>Launch용 IMS 구성(기술 계정)은 AEM as a Cloud Service에서 미리 구성되어 있습니다. 이 구성을 만들 필요는 없습니다.
