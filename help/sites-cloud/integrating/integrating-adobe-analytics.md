...
* Adobe Analytics를 [Adobe Launch](#analytics-launch)에 확장 기능으로 추가하고 구성합니다. Adobe Launch에 대한 자세한 내용은 [빠른 시작 안내서](https://experienceleague.adobe.com/docs/experience-platform/tags/get-started/quick-start.html?lang=ko)를 참조하세요.
