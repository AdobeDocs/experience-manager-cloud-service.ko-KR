...
* Touch UI를 사용하여 AEM as a Cloud Service에 Analytics 구성을 만듭니다. Adobe Analytics을 AEM as a Cloud Service과 통합하려면 IMS 인증이 필요합니다.
...
>[!NOTE]
>
>Launch용 IMS 구성(기술 계정)은 AEM as a Cloud Service에 사전 구성되어 있습니다. 이 구성을 만들 필요는 없습니다.
