...
필요한 옵션은에서 선택할 수 있습니다. **페이지 속성** 필요한 폴더 또는 조각 중 하나 또는 둘 다 지정되며, 사양은 필요에 따라 상속됩니다.
...
>
>이로 인해 콘텐츠 조각 및 관련된 모든 자산은 Target으로 내보내기 전에 게시되어야 합니다.
...
1. 필요에 따라 **게시하지 않고 내보내기** 또는 **게시**&#x200B;를 탭/클릭합니다.
   ...
   >
   >모든 항목이 이미 게시되었으며 그 이후 아무것도 수정되지 않은 경우 이 단계는 전달됩니다.
