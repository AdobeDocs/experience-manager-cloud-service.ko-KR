...
![클라우드 설정 대화 상자](assets/claude-1.png)

![클라우드의 커넥터 패널](assets/claude-2.png)

![클라우드에 사용자 지정 커넥터를 추가하고 있습니다.](assets/claude-3.png)

![클라우드에서 사용자 지정 커넥터를 연결하는 중입니다.](assets/claude-4.png)

![클라우드의 사용자 지정 커넥터 구성 양식입니다.](assets/claude-5.png)

![사용자 지정 커넥터에 대한 도구 사용 권한 대화 상자입니다.](assets/claude-6.png)

![클라우드에 AEM 콘텐츠 MCP 서비스를 사용하라는 메시지를 표시합니다.](assets/claude-7.png)
