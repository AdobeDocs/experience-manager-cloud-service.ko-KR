...
1. [AEMY GitHub 앱](https://github.com/apps/aem-aemy)이 저장소에 설치되어 있는지 확인하십시오.
...
1. **저장소 연결**&#x200B;을 클릭합니다.
1. 새 브라우저 탭에서 AEMY 앱이 열립니다. **AEM AEMY 승인**&#x200B;을 클릭합니다.
...
* [경험 현대화 콘솔](/help/ai-in-aem/agents/modernization/console.md) - 콘솔에 대한 세부 정보, 보기, 옵션 및 기능
