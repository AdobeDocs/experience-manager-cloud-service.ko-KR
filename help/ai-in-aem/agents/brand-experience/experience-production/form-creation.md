...
양식 만들기 작업은 자연어 프롬프트를 사용하여 양식을 개발하도록 설계된 [Brand Experience Agent](/help/ai-in-aem/agents/brand-experience/overview.md)의 기능입니다. 이 작업은 적절한 양식 구조 및 필드 유형을 자동으로 생성합니다. 그 일은 AI 비서를 통해 드러난다.
...
조직에 대한 양식 작성 작업을 활성화하려면 Adobe을 통해 활성화를 시작해야 합니다. 다음을 통해 연락하여 프로세스를 시작합니다.

* 전자 메일: `experience-production-agent@adobe.com`
* 또는 지정된 Adobe 계정 팀에 문의하십시오.

연락할 때 AEM as a Cloud Service 조직 ID를 입력하십시오.
