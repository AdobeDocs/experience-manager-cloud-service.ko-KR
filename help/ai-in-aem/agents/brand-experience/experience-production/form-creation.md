...
# 양식 생성 작업 {#form-creation-job}

양식 만들기 작업은 자연어 프롬프트를 사용하여 양식을 개발하도록 설계된 [Experience Production Agent](/help/ai-in-aem/agents/brand-experience/experience-production/overview.md)의 일부입니다. 이 작업은 적절한 양식 구조 및 필드 유형을 자동으로 생성합니다. 그 일은 AI 비서를 통해 드러난다.

양식 생성 작업의 주요 이점은 다음과 같습니다.

* **양식 개발 가속화**: 간단한 자연어 명령을 사용하여 양식을 신속하게 만들 수 있으므로 기존 제품 인터페이스를 학습할 필요가 없습니다.
* **일관된 브랜드 경험**: 승인된 템플릿과 스타일을 사용하여 조직의 브랜딩, 템플릿 및 스타일 지침을 따르는 양식을 만듭니다.
* **낮은 기술 장벽**: 고급 기술 전문가 또는 심층적인 제품 전문 지식 없이도 비즈니스 사용자가 양식을 쉽게 만들 수 있도록 허용합니다.

## 기능 {#capabilities}

* **일반 텍스트 프롬프트를 사용하여 새 양식을 만듭니다**: 일반 언어로 요구 사항을 제출하여 양식을 만들 수 있습니다. 이 스킬은 자연어 설명 및 지정된 템플릿을 기반으로 적절한 양식 구조, 필드 유형 및 브랜드 내 경험을 자동으로 생성합니다. 이 기능은 브랜드 및 규정 준수 표준이 유지되도록 하면서 양식 생성을 가속화합니다.
...
* *`https://[aem-author-url]/path/to/pdf/file`*&#x200B;에서 사용 가능한 PDF 파일을 가져와서 신용 카드 응용 프로그램 양식을 만듭니다.
* *`https://github.com/wkndforms/wesecure`*&#x200B;의 상용구를 사용하여 피드백 양식 만들기

## 양식 세분화 {#refine-with-forms-experience-builder}

AI 도우미를 사용하여 초기 양식 구조를 만든 후 Forms Experience Builder를 사용하여 다음을 수행할 수 있습니다.
...
자세한 내용은 [Forms Experience Builder 설명서를 참조하십시오.](/help/forms/experience-builder/product-overview.md)
...
* 지침이 있는 실습 지침에는 [Experience Production Agent 통합 문서](https://main--summit-labs--aemsites.aem.live/brand-visibility/l339/)를 사용할 수도 있습니다.
