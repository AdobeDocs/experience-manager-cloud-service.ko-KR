...
복잡한 마이그레이션 또는 가속화된 결과를 위해 Adobe은 AOE(Agentic Outcome Engineer) 제공 모델을 제공합니다. Adobe 엔지니어가 사용자를 대신하여 AI 도구를 작동하는 선택적 서비스입니다. 이 게재 모델에 대한 자세한 내용은 [Experience 현대화 에이전트의 게재 모델](/help/ai-in-aem/agents/brand-experience/modernization/delivery-model.md) 문서를 참조하십시오.
