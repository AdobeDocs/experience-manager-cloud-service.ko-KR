...
>[!NOTE]
>
>거버넌스 에이전트에는 AI를 사용하여 고객의 기존 브랜드 지침 문서를 규격을 준수하는 콘텐츠 생성을 자동으로 관리, 유효성 검사 및 안내하는 체계적이고 시행 가능한 정책 확인으로 변환하는 AI 기반 브랜드 정책 가져오기 기능도 포함되어 있습니다. 자세한 내용은 [브랜드 정책을 가져오는 방법](/help/ai-in-aem/agents/governance/how-to-import-a-brand-policy.md)을 참조하세요.
