...
**스마트 태그**: 스마트 태그는 Adobe AI의 인공 지능 프레임워크를 사용하여 태그 구조 및 비즈니스 분류법에 대한 이미지 인식 알고리즘을 교육합니다. 이 콘텐츠 인텔리전스는 다른 자산 세트에 관련 태그를 적용하는 데 사용됩니다. AEM은 기본적으로 업로드된 자산에 스마트 태그를 자동 적용합니다.
