...
* [컬렉션 거버넌스](#configure-collections-content-hub)

* [공개 링크 공유 활성화](#enable-public-link-sharing)
...
1. 변경 내용을 적용하려면 **[!UICONTROL 저장]**&#x200B;을 클릭하세요.
   ...
   ![Content Hub의 구성 컬렉션 탭](assets/configuration-collections-tab.png)

### 공개 링크 공유 활성화 {#enable-public-link-sharing}

Content Hub 사용자가 공개 링크를 생성할 수 있도록 구성 사용자 인터페이스에서 다음 설정을 활성화합니다.

1. [구성](#access-configuration-options-content-hub) 사용자 인터페이스에서 **[!UICONTROL 컬렉션 및 공유]**&#x200B;를 클릭합니다.

1. **[!UICONTROL 공개 링크 사용]** 토글을 활성화하고 **[!UICONTROL 저장]**&#x200B;을 클릭하여 변경 내용을 적용합니다.

   ![Content Hub에서 공개 링크 공유 사용](assets/enable-public-link-sharing-tab.png)
