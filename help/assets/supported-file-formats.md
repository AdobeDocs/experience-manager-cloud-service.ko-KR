...
| 에셋 유형 | [찾아보기](/help/assets/navigate-view.md) | 복사 | [업로드](/help/assets/add-delete.md) | 만들기 | [삭제](/help/assets/add-delete.md#delete-assets) | 세부 사항 | 이미지 확대/축소 | [최근에 본 항목](/help/assets/navigate-view.md) |
|-------------------|----------|----------|----------|----------|----------|-------------------|------------|-----------------|
| 래스터 이미지 | ✓ | ✓ | ✓ | − | ✓ | ✓ | ✓ | ✓ |
| RAW 파일 | ✓ | ✓ | ✓ | − | ✓ | ✓ | ✓ | ✓ |
| 폴더 | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | − | − |
...
| 에셋 유형 | [다운로드](/help/assets/manage-organize.md#download) | 드래그 앤 드롭 | [이미지 편집기](/help/assets/edit-images.md) | [검색](/help/assets/search.md) | [스마트 태그](/help/assets/metadata.md#tags) | [이름 변경](/help/assets/manage-organize.md) | [버전](/help/assets/manage-organize.md#versions-of-assets) |
|---------------|----------|---------------|--------------|----------|------------|----------|----------|
| 래스터 이미지 | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ |
| RAW 파일 | ✓ | ✓ | − | ✓ | ✓ | ✓ | ✓ | ✓ |
| 폴더 | ✓ | ✓ | − | ✓ | − | ✓ | ✓ |
...
| 에셋 유형 | [메타데이터](/help/assets/metadata.md) | [표현물](/help/assets/add-delete.md#renditions) | [휴지통](/help/assets/add-delete.md#delete-assets) | 복사 | 이동 |
|---------------|-------------------|------------|----------|----------|----------|
| 래스터 이미지 | ✓ | ✓ | ✓ | ✓ | ✓ |
| RAW 파일 | ✓ | ✓ | ✓ | ✓ | ✓ |
| 폴더 | ✓ | − | ✓ | ✓ | ✓ |
