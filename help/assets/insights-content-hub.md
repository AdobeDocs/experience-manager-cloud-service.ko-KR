...
## 자주 묻는 질문 {#faqs-assets-insights-content-hub}

### AEM Assets Content Hub에서 Assets 인사이트가 필요한 이유는 무엇입니까?

AEM Assets Content Hub의 Assets Insights는 캠페인, 채널 및 지역 전반에 걸친 자산 사용 통계에 대한 중요한 데이터를 제공함으로써 마케팅 이해 당사자가 자산 성능과 인기를 이해하여 사용자 경험을 개선할 수 있도록 합니다.

### AEM Assets Content Hub 내의 Assets Insights에 설명된 기능에 액세스할 수 있는 사람은 누구입니까?

AEM Assets Content Hub 사용자는 작업을 수행하고 Assets 인사이트 섹션에 언급된 기능에 액세스할 수 있습니다.

### AEM Assets Content Hub의 인사이트 탭에서 사용할 수 있는 자산 인사이트는 무엇입니까?

저장소의 에셋 수, 컬렉션 수, 연도, 월 또는 일별 Assets 업로드, 일 또는 월별 활성 사용자 및 AEM Assets Content Hub 내의 파일 형식을 기반으로 한 에셋 분류를 볼 수 있습니다.

### AEM Assets Content Hub에서 업로드된 자산에 대한 통계를 보려면 어떻게 해야 합니까?

인사이트 탭으로 이동하여 AEM Assets Content Hub에서 업로드된 에셋 및 컬렉션에 대한 통계를 볼 수 있습니다. 이 탭에서는 연도, 월 또는 일별로 업로드 내역을 추적할 수 있습니다.

### AEM Assets Content Hub의 사용자 활동과 관련하여 분석할 수 있는 지표는 무엇입니까?

AEM Assets Content Hub 내에서 선 그래프를 사용하여 시각적으로 표현되는 일별 또는 월별 활성 사용자 수를 분석할 수 있습니다.
