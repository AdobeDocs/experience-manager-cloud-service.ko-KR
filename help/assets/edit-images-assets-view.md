...
Express에 액세스할 수 있는 사용자는 이제 AEM Assets 내에서 직접 사용할 수 있는 Adobe Express 및 Adobe Firefly의 통합 이미지 편집 및 생성 도구를 사용하여 콘텐츠를 재사용하고 콘텐츠 속도를 높일 수 있습니다. 또한 사전 정의된 요소를 사용하여 에셋을 멋진 모양으로 만들거나 몇 번의 클릭만으로 이미지를 편집하는 빠른 작업을 수행할 수 있습니다.
...
[!DNL Assets view] 은 을 사용하여 처음부터 새 템플릿을 만드는 기능을 제공합니다. [!DNL Adobe Express] 포함된 편집기. 을 사용하여 새 에셋을 만들려면 [!DNL Adobe Express]을(를) 클릭하고 아래 단계를 수행하십시오.

1. 다음으로 이동 **[!UICONTROL 내 작업 영역]** 및 클릭 **[!UICONTROL 만들기]** 위에 표시되는 Adobe Express 배너 내 [!UICONTROL 빠른 액세스] 섹션. [!DNL Adobe Express] 빈 캔버스 [!DNL Assets view] 사용자 인터페이스.
