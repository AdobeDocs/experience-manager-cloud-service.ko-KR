...
[!DNL Assets view]는 [!DNL Adobe Express] 및 [!DNL Adobe Photoshop Express]에서 제공하는 사용자 친화적인 편집 옵션을 제공합니다. 를 사용하여 사용할 수 있는 편집 작업 [!DNL Adobe Express] 는 이미지 크기 조정, 배경 제거, 이미지 자르기 및 JPEG을 PNG로 변환 또는 그 반대의 경우입니다.
