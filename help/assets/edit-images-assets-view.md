...
[!DNL Assets view]는 [!DNL Adobe Photoshop Express]에서 제공하는 사용자 친화적인 편집 옵션을 제공합니다. 사용할 수 있는 편집 작업에는 얼룩 제거, 자르기 및 펴기, 이미지 크기 조정 및 이미지 조정이 있습니다.

이미지를 편집한 후 새 이미지를 새 버전으로 저장할 수 있습니다. 필요한 경우 버전 관리를 통해 나중에 원본 에셋으로 되돌릴 수 있습니다. 이미지를 편집하려면 [미리보기를 열고](/help/assets/navigate-assets-view.md#preview-assets) 오른쪽 레일에서 **[!UICONTROL 이미지 편집]** ![편집 아이콘](assets/do-not-localize/edit-icon.png)을 클릭합니다
