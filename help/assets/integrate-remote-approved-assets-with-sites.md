...
직접 URL 사용(예: `http://localhost:4502/system/console/configMgr`)

   1. **[!UICONTROL repositoryID]**= &quot;delivery-pxxxxx-eyyyy.adobeaemcloud.com&quot; 및 **[!UICONTROL imsClient]**= [IMSClientId] 추가
...
1. 원격 자산을 추가하려는 **[!UICONTROL 사이트]** 섹션 아래에서 웹 사이트 내의 특정 AEM **[!UICONTROL 페이지]**(으)로 이동합니다.
