...
# as a Cloud Service [!DNL Assets] 프라임  {#assets-prime}
...
Assets as a Cloud Service 프라임에는 다음과 같은 다양한 키 기능을 수행할 수 있는 경량 DAM이 포함되어 있습니다.

* **자산 관리 및 라이브러리 서비스**&#x200B;: 사용자가 중앙 저장소에서 브랜드의 디지털 자산을 수집, 저장, 카탈로그, 제어, 관리 및 관리할 수 있는 도구입니다.

* **검색, 검색 및 Collaboration**: 사용자가 풍부한 고객 경험을 만드는 데 필요한 자산을 탐색, 검색, 공유 및 공동 작업할 수 있는 도구입니다.
...
* **통합**: 다른 Adobe 및 Adobe이 아닌 응용 프로그램과 통합.
...
## Assets as a Cloud Service 프라임 사용{#enable-assets-prime}
...
Assets Prime이 이제 Experience Manager Assetsas a Cloud Service 에 대해 활성화됩니다.
...
AEM Assets Collaborator 사용자는 다른 Adobe 제품 및 Adobe이 아닌 애플리케이션에서 조직에서 사용할 수 있는 Assets의 통합을 통해 Experience Manager의 자산으로 작업하고, 전문적으로 디자인된 템플릿, 브랜드 키트, Adobe Stock 자산 등을 활용하여 내장된 Adobe Express 및 Firefly을 사용하여 자산을 만들고 편집하고, AEM Assets Content Hub 포털을 사용하여 조직에서 승인된 자산에 액세스하고 활용할 수 있습니다.
...
기본적으로 `Adobe Express` 및 `AEM Assets Collaborator Users` 서비스를 사용할 수 있습니다. 필요에 따라 토글을 끄거나 켤 수 있지만, Adobe은 제품 프로필에 대해 활성화된 기본 서비스를 사용하는 것을 권장합니다.
...
기본적으로 `Adobe Express` 및 `AEM Assets Power Users` 서비스를 사용할 수 있습니다. 필요에 따라 토글을 끄거나 켤 수 있지만, Adobe은 제품 프로필에 대해 활성화된 기본 서비스를 사용하는 것을 권장합니다.
