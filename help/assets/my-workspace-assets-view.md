...
1. 사용자, 조직 전체 또는 선택한 그룹에 맞는 항목을 고정해야 하는 경우 선택합니다. 다음을 선택하는 경우 **[!UICONTROL 그룹]**&#x200B;에서 기존 그룹 이름을 선택합니다 **[!UICONTROL 그룹에 고정]** 필드.
...
를 사용하여 Assets 보기 배포 내에서 상위 검색 용어를 검색한 횟수와 함께 볼 수도 있습니다. **Insights** 내 작업 영역의 섹션에 있는 마지막 항목이 될 필요가 없습니다. 세부 인사이트로 이동하여 지난 30일 또는 12개월 동안의 인기 검색어를 볼 수도 있습니다.

![작업 영역의 인사이트](assets/insights.png)

**작업**

에 현재 할당된 작업 목록 표시 **[!UICONTROL 내 작업]** 탭, 에서 사용자가 생성 **[!UICONTROL 할당된 작업]** 및 을 클릭하고,에서 사용자가 이미 완료한 작업을 **[!UICONTROL 완료된 작업]** 탭. 작업을 선택하고 **[!UICONTROL 작업 완료]** 작업을 승인하거나 거부합니다. 작업을 선택하고 **[!UICONTROL 작업 세부 정보 열기]**&#x200B;를 클릭하여 작업을 보고 승인, 거부, 편집 또는 삭제할 수도 있습니다.
...
다음 **[!UICONTROL 상위 다운로드]** 탭에는 에셋 보기 환경에서 가장 많이 다운로드한 에셋 10개가 표시됩니다. [목록 보기] 또는 [격자 보기]에서 자산이 표시되도록 할 수 있습니다. 두 보기 모두 각 자산에 대한 포맷 유형 및 다운로드 수를 표시합니다. 자산을 선택하고 **[!UICONTROL 세부 정보]**&#x200B;를 클릭하면 해당 속성을 조회할 수 있습니다.
