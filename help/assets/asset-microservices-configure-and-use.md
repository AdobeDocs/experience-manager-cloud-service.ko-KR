...
처리 프로필에는 FPO(배치에만 해당) 변환이 포함될 수 있습니다. 처리 프로필에 대해 설정해야 하는 경우 Adobe Asset Link [설명서를](https://helpx.adobe.com/enterprise/using/manage-assets-using-adobe-asset-link.html) 참조하십시오. 자세한 내용은 Adobe Asset [Link 전체 설명서를](https://helpx.adobe.com/kr/enterprise/using/adobe-asset-link.html)참조하십시오.
