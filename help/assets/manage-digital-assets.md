...
[Experience Manager에 디지털 자산 추가](add-assets.md)를 참조하십시오.
...
1. ZIP 파일 유형을 선택합니다.
1. 작업 표시줄에서 사용할 수 있는 **[!UICONTROL 보관 추출]** 옵션을 클릭합니다.
...
1. **[!UICONTROL 추출]**&#x200B;을 클릭합니다. Zip 추출 프로세스가 시작됩니다. 프로세스가 완료되면 대상 폴더에서 추출된 에셋을 볼 수 있습니다.
...
1. 미리 보기 모드에서 [지원되는 이미지 형식](/help/assets/file-format-support.md)에 대해 확대/축소 옵션을 사용할 수 있습니다(대화형 편집 사용).
   ...
   보기를 원래 크기로 재설정하려면 **[!UICONTROL 재설정]**&#x200B;을 선택하세요.
...
1. [!UICONTROL 속성] 페이지에서 다양한 탭에서 메타데이터 속성을 편집합니다. 예를들어 **[!UICONTROL 기본]** 탭에서 제목, 설명 등을 편집합니다.
...
1. Assets UI에서 하나 이상의 에셋을 선택한 다음 도구 모음에서 **[!UICONTROL 복사]** 아이콘을 선택합니다. 또는 에셋 카드에서 **[!UICONTROL 복사]** ![복사_아이콘](assets/copy_icon.png) 빠른 작업을 선택하십시오.
...
1. 도구 모음에서 **[!UICONTROL 붙여넣기]** 자산 아이콘을 클릭합니다. Assets이 이 위치에 복사됩니다.
...
1. 자산을 선택하고 도구 모음에서 **[!UICONTROL 이동]** 아이콘 ![이동_아이콘](assets/move_icon.png)을 선택합니다.

1. Assets 이동 마법사에서 다음 중 하나를 수행합니다.

   * 에셋을 이동한 후 에셋의 이름을 지정합니다. **[!UICONTROL 다음]**&#x200B;을(를) 선택하여 계속합니다.

   * 프로세스를 중지하려면 **[!UICONTROL 취소]**&#x200B;를 선택하십시오.
...
1. **[!UICONTROL 대상 선택]** 대화 상자에서 다음 중 하나를 수행합니다.
   ...
   * 에셋의 새 위치로 이동한 후 **[!UICONTROL 다음]**&#x200B;을(를) 선택하여 계속 진행합니다.

   * **[!UICONTROL 뒤로]**&#x200B;를 선택하여 **[!UICONTROL 이름 바꾸기]** 화면으로 돌아갑니다.

1. 이동하는 에셋에 참조 페이지, 에셋 또는 컬렉션이 있는 경우 **[!UICONTROL 대상 선택]** 탭 옆에 **[!UICONTROL 참조 조정]** 탭이 나타납니다.

   **[!UICONTROL 참조 조정]** 화면에서 다음 중 하나를 수행합니다.

   * 새 세부 정보를 기준으로 조정할 참조를 지정한 다음 **[!UICONTROL 이동]**&#x200B;을 선택하여 계속 진행하십시오.

   * **[!UICONTROL 조정]** 열에서 에셋에 대한 참조를 선택/선택 취소합니다.
   * **[!UICONTROL 대상 선택]** 화면으로 돌아가려면 **[!UICONTROL 뒤로]**&#x200B;를 선택하십시오.

   * 이동 작업을 중지하려면 **[!UICONTROL 취소]**&#x200B;를 선택하십시오.
...
1. GlobalNav 아이콘을 선택하고 목록에서 **[!UICONTROL 렌디션]**&#x200B;을 선택합니다.
...
1. **[!UICONTROL 렌디션]** 패널에서 에셋에 대해 생성된 렌디션 목록을 봅니다.
   ...
   >[!NOTE]
   >
   >기본적으로 [!DNL Experience Manager Assets]은(는) 미리 보기 모드에서 자산의 원본 렌디션을 표시하지 않습니다. 관리자는 오버레이를 사용하여 미리 보기 모드에서 원본 변환을 표시하도록 [!DNL Assets]을(를) 구성할 수 있습니다.

1. 렌디션을 보거나 삭제하려면 렌디션을 선택합니다.

   **렌디션 삭제**

   **[!UICONTROL 렌디션]** 패널에서 렌디션을 선택한 다음 도구 모음에서 **[!UICONTROL 렌디션 삭제]** 아이콘을 선택합니다. 에셋 처리가 완료된 후에는 렌디션을 일괄적으로 삭제할 수 없습니다. 개별 에셋의 경우 사용자 인터페이스에서 렌디션을 수동으로 제거할 수 있습니다. 여러 에셋의 경우 특정 표현물을 삭제하거나 에셋을 삭제하고 삭제된 에셋을 다시 업로드하도록 [!DNL Experience Manager]을(를) 사용자 지정할 수 있습니다.

   ![delete_renditionicon](assets/delete_renditionicon.png)

   **새 렌디션 업로드**

   에셋에 대한 에셋 세부 정보 페이지로 이동하고 도구 모음에서 **[!UICONTROL 렌디션 추가]** 아이콘을 선택하여 에셋에 대한 새 렌디션을 업로드합니다.
   ...
   이미지 또는 비디오 에셋의 세부 사항 페이지에 표시할 렌디션의 차원을 구성할 수 있습니다. 사용자가 지정한 차원을 기반으로, Assets은 정확한 차원이나 가장 가까운 차원을 사용하여 렌디션을 표시합니다.
...
1. 자산을 선택하고 도구 모음에서 **[!UICONTROL 삭제]** ![삭제_아이콘](assets/do-not-localize/delete-icon.png)을 클릭합니다.

1. 확인 대화 상자에서 다음을 클릭합니다.

   * 작업을 중지하려면 **[!UICONTROL 취소]**
   * **[!UICONTROL 삭제]**&#x200B;를 사용하여 작업을 확인합니다.

      * 에셋에 참조가 없으면 에셋이 삭제됩니다.
      * 에셋에 참조가 있으면 **[!UICONTROL 하나 이상의 에셋이 참조되었습니다]**. **[!UICONTROL 강제 삭제]** 또는 **[!UICONTROL 취소]**&#x200B;를 선택할 수 있습니다.
...
가장 적절한 자산을 검색하고 사용하려면 [자산 검색 [!DNL Experience Manager]](/help/assets/search-assets.md)을 참조하십시오.
...
*그림: 에셋에 대한 타임라인 항목 정렬*

>[!NOTE]
>
>[컬렉션 콘솔](/help/assets/manage-collections.md#navigate-the-collections-console)에서 **[!UICONTROL 모두 표시]** 목록은 댓글 및 워크플로만 볼 수 있는 옵션을 제공합니다. 또한 콘솔에 나열된 최상위 수준 컬렉션에만 타임라인이 표시됩니다. 컬렉션 내부를 탐색하는 경우에는 표시되지 않습니다.

>[!NOTE]
>
>타임라인에 콘텐츠 조각과 관련된 [옵션](content-fragments/content-fragments.md)이(가) 몇 개 있습니다.
...
>[!NOTE]
>
>콘텐츠 조각의 경우 [조각 편집기에서 주석을 만듭니다](content-fragments/content-fragments.md).

1. 주석을 추가할 자산의 위치로 이동합니다.
1. 다음 중 하나에서 **[!UICONTROL 주석]** 아이콘을 선택합니다.
...
1. 주석 모드를 종료하려면 **[!UICONTROL 닫기]**&#x200B;를 선택하십시오.
1. 알림을 보려면 Aaron MacDonald의 자격 증명으로 Assets에 로그인하고 **[!UICONTROL 알림]** 아이콘을 클릭하여 알림을 보십시오.

   >[!NOTE]
   >
   >비디오 에셋에 주석을 추가할 수도 있습니다. 비디오에 주석을 달 때 플레이어는 일시 중지하여 프레임에 주석을 달 수 있도록 합니다. 자세한 내용은 [비디오 자산 관리](manage-video-assets.md)를 참조하십시오. 그러나 MXF 비디오 포맷은 비디오 주석에서 아직 지원되지 않습니다.

1. 사용자를 구분할 수 있도록 다른 색상을 선택하려면 프로필 아이콘을 선택하고 **[!UICONTROL 내 환경 설정]**&#x200B;을 선택하세요.

   <!--![chlimage_1-237](assets/chlimage_1-237.png)-->

   **[!UICONTROL 주석 색상]** 상자에서 원하는 색상을 지정한 다음 **[!UICONTROL 수락]**&#x200B;을 선택합니다.
...
1. From the **[!UICONTROL Show All]** list in the timeline, select **[!UICONTROL Comments]** to filter the results based on annotations.
   ...
   이미지에서 해당 주석을 보려면 **[!UICONTROL 타임라인]** 패널에서 주석을 선택하십시오.

   <!--![chlimage_1-241](assets/chlimage_1-241.png)-->

   특정 댓글을 삭제하려면 **[!UICONTROL 삭제]**&#x200B;를 선택하십시오.
...
주석을 인쇄하고 상태를 검토하려면 **[!UICONTROL 인쇄]** 아이콘을 선택하고 마법사의 지침을 따릅니다. **[!UICONTROL 인쇄]** 아이콘은 자산에 하나 이상의 주석 또는 검토 상태가 할당된 경우에만 도구 모음에 표시됩니다.

1. Assets UI에서 에셋에 대한 미리보기 페이지를 엽니다.
1. 다음 중 하나를 수행하십시오.

   * 모든 주석과 검토 상태를 인쇄하려면 3단계를 건너뛰고 바로 4단계로 이동합니다.
   * 특정 주석을 인쇄하고 상태를 검토하려면 [타임라인](/help/assets/manage-digital-assets.md#timeline)을 연 다음 3단계로 이동하십시오.
...
1. 도구 모음에서 **[!UICONTROL 인쇄]** 아이콘을 선택합니다.
...
1. 오른쪽 상단의 옵션을 사용하여 PDF을 다운로드하거나 인쇄합니다.
   ...
   렌더링된 PDF 파일의 모양(예: 설명 및 상태의 글꼴 색, 크기 및 스타일, 배경색)을 수정하려면 구성 관리자에서 **[!UICONTROL 주석 PDF 구성]**&#x200B;을 열고 원하는 옵션을 수정합니다. 예를 들어 승인됨 상태의 표시 색상을 변경하려면 해당 필드의 색상 코드를 수정합니다. 주석의 글꼴 색 변경에 대한 자세한 내용은 [주석 추가](/help/assets/manage-digital-assets.md#annotating)를 참조하십시오.
...
* 다른 애플리케이션에서 이미지를 수정하고 Assets에 업로드합니다. 원본 이미지를 덮어쓰지 않도록 이미지 버전이 만들어집니다.
* 에셋의 메타데이터를 편집합니다.
...
1. GlobalNav 아이콘을 선택하고 메뉴에서 **[!UICONTROL 타임라인]**&#x200B;을 선택합니다.

   ![타임라인](assets/timeline.png)

1. 에셋에서 수행할 수 있는 작업을 보려면 맨 아래에 있는 **[!UICONTROL 작업]**(화살표) 아이콘을 선택하십시오.

   <!--![chlimage_1-249](assets/chlimage_1-249.png)-->

1. 에셋의 버전을 만들려면 **[!UICONTROL 다른 버전으로 저장]**&#x200B;을 선택하십시오.

<!--![chlimage_1-250](assets/chlimage_1-250.png)-->

1. 레이블과 댓글을 추가한 다음 **[!UICONTROL 만들기]**&#x200B;를 클릭하여 버전을 만듭니다. 또는 **취소**&#x200B;를 선택하여 작업을 종료합니다.
...
1. 에셋을 미리 보거나 Assets UI에 표시되도록 활성화하려면 에셋의 특정 버전을 선택하십시오.

   ![select_version](assets/select_version.png)

1. Assets UI의 특정 버전으로 되돌리려면 버전에 대한 레이블과 주석을 추가하십시오.

   ![save_version](assets/save_version.png)

1. 버전에 대한 미리 보기를 생성하려면 **[!UICONTROL 버전 미리 보기]**&#x200B;를 선택하십시오.
1. Assets UI에 이 버전을 표시하려면 **[!UICONTROL 이 버전으로 되돌리기]**&#x200B;를 선택하십시오.
...
1. GlobalNav 아이콘을 선택하고 메뉴에서 **[!UICONTROL 타임라인]**&#x200B;을 선택하여 타임라인을 표시합니다.

   ![타임라인-1](assets/timeline-1.png)

1. 하단의 **[!UICONTROL 작업]**(화살표) 아이콘을 선택하여 에셋에 사용할 수 있는 작업 목록을 엽니다.

   <!--![chlimage_1-252](assets/chlimage_1-252.png)-->

1. 목록에서 **[!UICONTROL 워크플로 시작]**&#x200B;을 선택합니다.
...
1. **[!UICONTROL 시작]**&#x200B;을 선택한 다음 대화 상자에서 **[!UICONTROL 진행]**&#x200B;을 선택하여 확인하십시오. Each step of workflow is displayed in the timeline as an event.
