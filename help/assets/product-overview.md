...
* experience.adobe com에 로그인하고 **[!UICONTROL 바로 가기]** 섹션에서 사용할 수 있는 **[!UICONTROL Experience Manager Assets Content Hub]**를 클릭합니다.
  ![Content Hub 액세스](assets/access-content-hub.png)

* experience.adobe com에 로그인하고 제품 전환기에서 사용할 수 있는 **[!UICONTROL Experience Manager Assets Content Hub]**를 클릭합니다.
...
1. [DAM 작성자 또는 관리자가 Experience Manager 자산을 사용하여 자산을 승인합니다](approve-assets.md).
