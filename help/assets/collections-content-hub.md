...
컬렉션 내에서 사용할 수 있는 에셋을 공유할 수도 있습니다. [Content Hub에서 공개 링크 공유를 사용하도록 설정](configure-content-hub-ui-options.md#configure-collections-content-hub)합니다. **[!UICONTROL 컬렉션]** 탭으로 이동합니다. 자산 카드에서 ![공유 아이콘](assets/share.svg) 아이콘을 선택합니다. 공유 링크가 복사됩니다. 복사한 링크를 수신자와 공유할 수 있습니다. [에서  [!DNL Content Hub]](share-assets-content-hub.md)에셋 공유에 대해 자세히 알아보세요.
...
## 자주 묻는 질문 {#faqs-manage-collections-content-hub}

### AEM Assets Content Hub에서 컬렉션이라고 하는 것은 무엇입니까?

AEM Assets Content Hub의 컬렉션은 사용자 간에 공유할 수 있는 에셋 세트를 의미합니다. 컬렉션에는 참조 무결성을 유지하면서 다른 위치의 에셋이 포함될 수 있습니다. 사용자가 콘텐츠에 효율적으로 접근하고 활용할 수 있는 공유 공간을 조성한다.

### AEM Assets Content Hub에서 새 컬렉션을 만들려면 어떻게 해야 합니까?

AEM Assets Content Hub에서 새 컬렉션을 만들려면 컬렉션 탭으로 이동하여 **컬렉션 만들기**&#x200B;를 클릭합니다. 새 컬렉션 창에서 제목 및 설명 을 추가하고 **액세스 가능한 사용자** 드롭다운 목록에서 액세스 제어 유형을 선택한 다음 **만들기**&#x200B;를 클릭합니다. 그런 다음 자산을 컬렉션에 추가할 수 있습니다.

### AEM Assets Content Hub에서 컬렉션을 만들 때 사용할 수 있는 액세스 제어 유형은 무엇입니까?

AEM Assets Content Hub에는 세 가지 액세스 제어 유형이 있습니다. **개인** - 작성자와 관리자만 편집하고 액세스할 수 있음, **공개** - 보기 전용 - 모든 사용자가 볼 수 있지만 작성자와 관리자만 편집할 수 있음, **공개** - 보기 및 편집 - 모든 사용자가 제한 없이 컬렉션에 액세스하고 편집할 수 있습니다.

### AEM Assets Content Hub의 컬렉션에 대한 작업을 수행할 수 있는 사람은 누구입니까?

AEM Assets Content Hub 사용자는 컬렉션 생성, 보기, 공유, 다운로드, 제거, 삭제, 고정 및 즐겨찾기로 표시 등의 작업을 수행할 수 있습니다. 관리자는 모든 액세스 옵션 보기 및 컬렉션 삭제와 같은 추가 권한을 가집니다.

### AEM Assets Content Hub에서 기존 컬렉션에 에셋을 추가하려면 어떻게 합니까?

AEM Assets Content Hub의 기존 컬렉션에 에셋을 추가하려면 추가할 에셋을 선택하고 **컬렉션에 추가**&#x200B;를 클릭한 다음 목록에서 컬렉션을 선택합니다. 검색 창을 사용하여 컬렉션을 검색할 수도 있습니다. **컬렉션에 추가**&#x200B;를 클릭하여 작업을 확인합니다.

### AEM Assets Content Hub에서 컬렉션을 필터링하고 검색할 수 있습니까?

예. 컬렉션은 AEM Assets Content Hub에서 이름, 액세스 권한 또는 작성자별로 필터링하고 검색할 수 있습니다. 필터에는 **모든 컬렉션**, **나만**, **누구나 볼 수 있음**, **누구나 편집할 수 있음**, **누구나 작성**, **내가 작성** 등의 옵션이 포함됩니다.

### AEM Assets Content Hub의 컬렉션에서 에셋을 다운로드하려면 어떻게 합니까?

AEM Assets Content Hub의 컬렉션에서 에셋을 다운로드하려면 **컬렉션** 탭으로 이동하고 컬렉션 카드에서 다운로드 아이콘을 클릭하여 모든 에셋을 다운로드합니다. 컬렉션을 열고 개별 자산을 선택한 다음 **다운로드**&#x200B;를 클릭하여 별도로 다운로드할 수도 있습니다.

### AEM Assets Content Hub의 컬렉션에서 에셋을 공유하려면 어떻게 해야 합니까?

Assets은 AEM Assets Content Hub에서 공개 링크 공유를 활성화하여 공유할 수 있습니다. 에셋 카드에서 공유 아이콘을 선택하여 공유 링크를 복사하여 수신자에게 전송할 수 있습니다. 비공개 컬렉션은 공유할 수 없습니다.

### AEM Assets Content Hub의 컬렉션에서 에셋을 제거할 수 있는 사람은 누구입니까?

컬렉션 소유자, 관리자 또는 편집 권한이 있는 비관리 사용자는 AEM Assets Content Hub의 컬렉션에서 단일 또는 여러 에셋을 제거할 수 있습니다. 제거하려면 자산을 선택하고 **컬렉션에서 제거**&#x200B;를 클릭한 다음 제거를 확인합니다.

### AEM Assets Content Hub에서 컬렉션을 삭제할 수 있는 사람은 누구이며 어떻게 됩니까?

관리자 및 컬렉션 작성자만 삭제할 수 있습니다. 삭제하려면 컬렉션 탭으로 이동하여 컬렉션을 선택하고 삭제 아이콘을 클릭합니다. 컬렉션이 AEM Assets Content Hub에서 제거됩니다.

### 관리자가 AEM Assets Content Hub에서 컬렉션에 대해 구성할 수 있는 옵션은 모두 무엇입니까?

관리자는 AEM Assets Content Hub의 컬렉션에 대해 다음 옵션을 활성화하거나 비활성화할 수 있습니다.

* 모든 사용자가 액세스할 수 있지만 작성자와 관리자만 편집할 수 있는 컬렉션을 허용하도록 **컬렉션만 보기** 전환을 활성화합니다.

* 모든 사용자가 액세스할 수 있고 편집할 수 있는 컬렉션을 허용하도록 **공용 컬렉션** 토글을 활성화합니다. **컬렉션만 보기** 및 **공용 컬렉션** 전환이 비활성화된 경우 기본적으로 관리자가 아닌 사용자는 전용 컬렉션만 만들 수 있습니다.
