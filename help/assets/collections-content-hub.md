...
### 컬렉션을 만들 때 사용할 수 있는 액세스 제어 유형은 무엇입니까?

세 가지 액세스 제어 유형이 있습니다. **개인** - 작성자와 관리자만 편집하고 액세스할 수 있음, **공개** - 보기 전용 - 모든 사용자가 볼 수 있지만 작성자와 관리자만 편집할 수 있음, **공개** - 보기 및 편집 - 모든 사용자가 제한 없이 컬렉션에 액세스하고 편집할 수 있습니다.

### Content Hub에서 컬렉션에 대한 작업을 수행할 수 있는 사람은 누구입니까?

Content Hub 사용자는 컬렉션 만들기, 보기, 공유, 다운로드, 제거, 삭제, 고정 및 즐겨찾기로 표시 등의 작업을 수행할 수 있습니다. 관리자는 모든 액세스 옵션 보기 및 컬렉션 삭제와 같은 추가 권한을 가집니다.

### AEM Assets Content Hub에서 기존 컬렉션에 에셋을 추가하려면 어떻게 합니까?

추가할 자산을 선택하고 **컬렉션에 추가**&#x200B;를 클릭한 다음 목록에서 컬렉션을 선택하십시오. 검색 창을 사용하여 컬렉션을 검색할 수도 있습니다. **컬렉션에 추가**&#x200B;를 클릭하여 작업을 확인합니다.
...
Assets은 Content Hub에서 공개 링크 공유를 활성화하여 공유할 수 있습니다. 에셋 카드에서 공유 아이콘을 선택하여 공유 링크를 복사하여 수신자에게 전송할 수 있습니다. 비공개 컬렉션은 공유할 수 없습니다.

### AEM Assets Content Hub의 컬렉션에서 에셋을 제거할 수 있는 사람은 누구입니까?

컬렉션의 소유자, 관리자 또는 편집 권한이 있는 관리자가 아닌 사용자는 컬렉션에서 단일 또는 여러 에셋을 제거할 수 있습니다. 제거하려면 자산을 선택하고 **컬렉션에서 제거**&#x200B;를 클릭한 다음 제거를 확인합니다.
