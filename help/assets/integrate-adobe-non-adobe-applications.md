---
title: 컨텐츠 권고자를 사용하여 Adobe 및 Adobe 이외 애플리케이션 내의 AEM 컨텐츠에 액세스합니다
description: Content Advisor는 Adobe 애플리케이션 및 Adobe 이외의 애플리케이션에서 통합된 컨텐츠 검색 환경을 제공하며, 지능적이고 상황에 맞는 검색 기능을 작성 환경에 직접 제공합니다.
...
# 컨텐츠 권고자를 사용하여 Adobe 및 Adobe 이외 애플리케이션에서 AEM 컨텐츠에 액세스합니다{#content-advisor-aem-assets-adobe-non-Adobe-applications}

Content Advisor는 Adobe 및 Adobe 이외의 애플리케이션에서 통합 컨텐츠 검색 환경을 제공합니다. Adobe Workfront, AJO B2C(출시 예정), AEM Sites 및 비 Adobe 애플리케이션과 같은 애플리케이션과 기본적으로 통합되는 Content Advisor는 지능적인 단일 인터페이스에서 컨텐츠(자산 및 컨텐츠 조각)를 함께 제공합니다. 따라서 워크플로우 내에서 가장 관련성이 높은 컨텐츠를 간편하게 검색, 탐색 및 재사용할 수 있으므로 컨텍스트를 손상하지 않고도 보다 빠르게 이동할 수 있습니다.
...
Adobe Experience Manager(AEM) Assets도 기본적으로 Adobe Express과 통합되므로 컨텐츠 권고자를 사용하여 익스프레스 인터페이스 내에서 AEM Assets의 자산을 직접 검색, 액세스 및 사용할 수 있습니다. 자세한 내용은 [콘텐츠 관리자를 사용하여 Adobe Express의 AEM Assets에 액세스](/help/assets/native-integration-adobe-express.md)를 참조하십시오.
...
이렇게 하면 Adobe Express 및 기타 Adobe 애플리케이션에서 사용할 수 있는 경험과 일관성을 유지하면서 외부 애플리케이션 내에서 직접 AEM Assets에서 승인된 자산을 검색, 평가 및 사용할 수 있습니다.

통합, 속성 및 사용자 지정에 대한 자세한 내용은 다음 문서를 참조하십시오.

* [Content Advisor 통합 예제](https://github.com/adobe/aem-assets-selectors-mfe-examples/tree/consolidate-docs-to-experience-league/examples)

* [콘텐츠 관리자 속성](/help/assets/content-advisor-properties.md)

* [콘텐츠 관리자 사용자 지정](/help/assets/content-advisor-customization.md)
