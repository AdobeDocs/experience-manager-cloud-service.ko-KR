...
| 버전 | 문서 링크 |
| -------- | ---------------------------- |
| AEM 6.5 | [여기 클릭](https://experienceleague.adobe.com/ko/docs/experience-manager-65/content/assets/brandportal/brand-portal-publish-assets) |
...
>[!NOTE]
>
>콘텐츠 조각은 Brand Portal에 게시할 수 없습니다. 따라서 AEM Assets에서 콘텐츠 조각을 선택한다면 **[!UICONTROL Brand Portal에 게시]** 동작을 사용할 수 없습니다.
>
>콘텐츠 조각이 포함된 컬렉션이 AEM Assets에서 Brand Portal로 게시되면 콘텐츠 조각을 제외한 폴더의 모든 콘텐츠가 Brand Portal 인터페이스에 복제됩니다.
