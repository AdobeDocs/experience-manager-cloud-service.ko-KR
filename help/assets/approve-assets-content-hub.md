...
### Experience Manager as a Cloud Service에서 Content Hub에 대한 자산을 승인하는 목적은 무엇입니까? {#approving-assets-content-hub}

에셋을 승인하면 Content Hub 내에서 최신 버전과 승인된 버전만 사용할 수 있으므로 모든 채널 및 애플리케이션에서 엄격한 브랜드 일관성을 유지할 수 있습니다. 이렇게 제어된 프로세스를 통해 브랜드 관리자와 마케터의 에셋 관리를 간소화합니다.

### Content Hub에 대한 자산을 승인하는 데 필요한 사전 요구 사항은 무엇입니까?

에셋 메타데이터, 특히 에셋 속성의 **상태** 필드를 편집하려면 AEM Assets as a Cloud Service에 대한 액세스 권한과 쓰기 권한이 있어야 합니다.

### AEM as a Cloud Service에서 Assets 보기를 사용하여 단일 에셋을 승인하려면 어떻게 합니까?

에셋을 선택하고 도구 모음에서 **세부 정보**&#x200B;를 클릭하고 **기본** 탭으로 이동한 다음 **상태** 드롭다운 목록에서 **승인됨**&#x200B;을 선택하고 **저장**&#x200B;을 클릭합니다. Content Hub에서 자산을 사용할 수 있습니다.

### Content Hub에 대해 에셋을 일괄로 승인할 수 있습니까? 그렇다면 어떻게 합니까?

예. 에셋을 일괄 승인할 수 있습니다. Assets 보기에서 여러 자산을 선택하고 **일괄 메타데이터 편집**&#x200B;을 클릭한 다음 속성 아래의 **상태** 필드에서 **승인됨**&#x200B;을 선택하고 **저장**&#x200B;을 클릭합니다. 선택한 모든 에셋은 Content Hub에서 사용할 수 있습니다.

### Content Hub에서 에셋 승인 프로세스는 어떻게 작동합니까? {#asset-approval-content-hub}

자동 승인 토글이 활성화된 경우 Content Hub을 사용하여 업로드된 에셋을 자동으로 사용할 수 있습니다. 비활성화된 경우 업로드된 자산은 Assets as a Cloud Service의 **하이드레이션된 자산** 폴더에 배치되므로 Content Hub에 표시되도록 상태를 **승인됨**(으)로 수동으로 벌크 편집해야 합니다.

### 승인 대상 필드는 무엇이며 에셋 게시에 어떤 영향을 줍니까?
...
### Assets 에셋 세부 사항 보기 페이지에 승인 대상 필드가 표시되지 않으면 어떻게 됩니까?
...
### 관리자 보기에서 새로 수집된 자산에 대한 승인을 자동화하려면 어떻게 합니까?
...
### Content Hub에서 승인된 에셋에 액세스할 수 있는 사용자는 누구이며 어떤 제어 기능이 적용됩니까?

승인된 에셋은 Content Hub 내에서 동일한 조직에 속한 사용자가 사용할 수 있습니다. 엄격한 제어를 통해 승인된 최신 버전만 액세스할 수 있으므로 브랜드 일관성과 보안을 유지할 수 있습니다.
