...
## 자주 묻는 질문 {#faqs-content-hub-approved-assets}

### Experience Manager as a Cloud Service에서 AEM Assets Content Hub에 대한 에셋을 승인하는 목적은 무엇입니까? {#approving-assets-content-hub}

에셋을 승인하면 AEM Assets Content Hub 내에서 최신 버전과 승인된 버전만 사용할 수 있으므로 모든 채널 및 애플리케이션에서 엄격한 브랜드 일관성을 유지할 수 있습니다. 이렇게 제어된 프로세스를 통해 브랜드 관리자와 마케터의 에셋 관리를 간소화합니다.

### AEM Assets Content Hub에 대한 자산을 승인하는 데 필요한 사전 요구 사항은 무엇입니까?

에셋 메타데이터, 특히 에셋 속성의 **상태** 필드를 편집하려면 AEM Assets as a Cloud Service에 대한 액세스 권한과 쓰기 권한이 있어야 합니다.

### AEM Assets Content Hub에서 사용할 수 있도록 AEM as a Cloud Service에서 Assets 보기를 사용하여 단일 자산을 어떻게 승인합니까?

에셋을 선택하고 도구 모음에서 **세부 정보**&#x200B;를 클릭하고 **기본** 탭으로 이동한 다음 **상태** 드롭다운 목록에서 **승인됨**&#x200B;을 선택하고 **저장**&#x200B;을 클릭합니다. 자산은 AEM Assets Content Hub에서 사용할 수 있습니다.

### AEM Assets Content Hub에 대해 에셋을 일괄로 승인할 수 있습니까? 그렇다면 어떻게 합니까?

예. 에셋을 일괄 승인할 수 있습니다. Assets 보기에서 여러 자산을 선택하고 **일괄 메타데이터 편집**&#x200B;을 클릭한 다음 속성 아래의 **상태** 필드에서 **승인됨**&#x200B;을 선택하고 **저장**&#x200B;을 클릭합니다. 선택한 모든 에셋은 AEM Assets Content Hub에서 사용할 수 있습니다.

### AEM Assets Content Hub에서 에셋 승인 프로세스는 어떻게 작동합니까? {#asset-approval-content-hub}

자동 승인 토글이 활성화된 경우 AEM Assets Content Hub을 사용하여 업로드된 에셋을 자동으로 사용할 수 있습니다. 비활성화된 경우 업로드된 자산은 Assets as a Cloud Service의 **하이드레이션된 자산** 폴더에 배치되므로 Content Hub에 표시되도록 상태를 **승인됨**(으)로 수동으로 벌크 편집해야 합니다.

### AEM Assets 보기의 승인 대상 필드는 무엇이며 에셋 게시에 어떤 영향을 줍니까?

에셋 세부 정보 페이지의 **승인 대상** 필드를 사용하면 승인된 에셋을 게시할 위치를 선택할 수 있습니다. 옵션에는 **배달**(OpenAPI 및 Content Hub을 사용하여 Dynamic Media에 게시) 또는 **Content Hub**&#x200B;만 포함됩니다. 옵션을 선택하지 않으면 Assets as a Cloud Service 환경에 대한 기본값이 적용됩니다. 자세한 내용은 [승인된 자산의 기본 승인 대상 및 게시 대상](#default-approval-target-options-publish-destinations)을 참조하십시오.


### AEM Assets 에셋 세부 사항 보기 페이지에 승인 대상 필드가 표시되지 않으면 어떻게 됩니까?

Assets 자산 보기 세부 정보 페이지에서 **승인 대상** 필드가 누락된 경우 메타데이터 양식을 편집하고 사용 가능한 구성 요소에서 양식으로 **승인 대상** 필드를 드래그한 다음 **저장**&#x200B;을(를) 클릭합니다. 이를 통해 에셋에 대한 승인 타겟을 설정할 수 있습니다.

### AEM Assets 관리 보기에서 새로 수집된 자산에 대한 승인을 자동화하려면 어떻게 합니까?

작성자 환경에서 폴더를 만들고 **도구** > **Assets** > **메타데이터 프로필**&#x200B;로 이동하여 메타데이터 프로필을 만들고 편집합니다. 한 줄 텍스트 필드를 추가하고 **승인된 Assets**&#x200B;에 레이블을 지정하고 &#39;에 매핑합니다./jcr:content/metadata/dam:status&#39; 및 해당 기본값을 `approved`(으)로 설정합니다. 폴더에 메타데이터 프로필을 적용합니다. 이렇게 하면 폴더에 추가된 새 에셋이 자동으로 승인됩니다.

### AEM Assets Content Hub에서 승인된 에셋에 액세스할 수 있는 사람은 누구이며 어떤 컨트롤이 적용됩니까?

승인된 에셋은 AEM Assets Content Hub 내에서 동일한 조직에 속한 사용자가 사용할 수 있습니다. 엄격한 제어를 통해 승인된 최신 버전만 액세스할 수 있으므로 브랜드 일관성과 보안을 유지할 수 있습니다.
