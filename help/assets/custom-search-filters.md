...
맞춤형 필터 AEM Assets에서는 맞춤형 검색 필터 캔버스에서 필터 요소의 컬렉션을 사용할 수 있습니다. 이러한 요소들은 검색 속성 속성들의 유용성에 기초하여 재구성될 수 있다. 하지만 요구 사항에 따라 [필터 속성](#filter-properties)을 사용자 지정할 수 있습니다. [!DNL Assets view]에서 다음 필터 요소를 사용할 수 있습니다.
