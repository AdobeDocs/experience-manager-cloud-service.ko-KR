...
Experience Manager 자산은 콘텐츠를 구성하는 여러 방법을 지원합니다. 폴더를 사용하여 계층 구조로 구성할 수도 있고, 태그 등의 예를 사용하여 비순차적인 방식으로 구성할 수도 있습니다. 사용자는 하위 자산, 표현물 및 메타데이터가 표시되는 DAM 자산 편집기에서 태그를 편집할 수 있습니다.

## 폴더 만들기 {#create-folders}

자산 컬렉션을 구성할 때(예: 모든 *Nature* 이미지) 폴더를 만들어 함께 유지할 수 있습니다. 폴더를 사용하여 자산을 분류하고 구성할 수 있습니다. [!DNL Assets] 가 더 잘 작동하도록 하려면 폴더에서 자산을 구성할 필요가 없습니다.
