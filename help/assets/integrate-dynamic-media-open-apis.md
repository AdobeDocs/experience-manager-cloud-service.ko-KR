...
검색 및 게재 API를 사용하여 자체 사용자 지정 사용자 인터페이스를 Experience Manager Assets 저장소와 통합하거나 Adobe의 Content Advisor를 사용할 수 있습니다.
...
콘텐츠 관리자는 [!DNL Experience Manager Assets as a Cloud Service] 저장소와 쉽게 통합되는 사용자 인터페이스를 제공하므로 저장소에서 사용 가능한 승인된 디지털 에셋을 찾아보거나 검색하고 응용 프로그램 작성 환경에서 사용할 수 있습니다. 자세한 내용은 [콘텐츠 관리자](/help/assets/integrate-adobe-non-adobe-applications.md)를 참조하십시오.
