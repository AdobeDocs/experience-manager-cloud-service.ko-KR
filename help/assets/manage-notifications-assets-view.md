...
폴더, 에셋 또는 컬렉션을 시청 및 시청 취소하여 정보를 유지하여 모니터링 중인 에셋에 대한 공동 작업을 향상시킬 수 있습니다.
...
### 콘텐츠 구독 {#subscribe-to-content}

폴더, 에셋 또는 컬렉션을 구독하려면 다음 단계를 따르십시오.

1. 구독할 폴더, 자산 또는 컬렉션을 찾은 다음 **[!UICONTROL 보기]**&#x200B;를 클릭합니다.

1. Assets 보기에 성공 메시지가 표시됩니다. 성공 메시지에서 **[!UICONTROL 알림 환경 설정으로 이동]**&#x200B;을 클릭하여 [알림 범주 구독](#subscribe-to-notification-categories)을 편집할 수 있습니다.

   ![Assets 보기의 알림](assets/watch-assets.png)

이제 Assets 보기에서 구독한 범주에 대한 알림을 보냅니다. 여러 자산, 폴더 또는 컬렉션을 선택하고 **[!UICONTROL 보기]**&#x200B;를 클릭하여 시간을 절약할 수 있습니다. 그러나 여러 항목을 선택하고 일부는 이미 구독한 경우 **[!UICONTROL 보기]** 옵션이 표시되지 않습니다.

### 구독한 콘텐츠 보기 {#view-subscribed-content}

구독한 콘텐츠를 보려면 다음 단계를 따르십시오.

1. **[!UICONTROL 자산 관리]**&#x200B;에서 [!UICONTROL 시청 Assets]&#x200B;(으)로 이동합니다.

1. Assets 보기에는 이름, 유형 및 경로를 포함하여 구독한 에셋 목록이 표시됩니다. 목록에서 에셋, 폴더 또는 컬렉션을 선택하여 해당 세부 정보, 위치를 확인하거나 [구독 취소](#unsubscribe-to-content)하십시오.

   ![구독한 콘텐츠 보기](assets/view-watched-assets.png)

### 콘텐츠 구독자 보기 {#view-content-subscribers}

콘텐츠 구독자를 보려면 다음 단계를 수행합니다.

1. 폴더, 자산 또는 컬렉션을 탐색하고 **[!UICONTROL 세부 정보]**&#x200B;를 선택합니다.

1. 콘텐츠 감시자 목록을 보려면 오른쪽 창에서 눈![눈 아이콘](assets/do-not-localize/eye-icon.png)을 클릭하십시오.

   또는 오른쪽 창에서 ![댓글 아이콘](assets/do-not-localize/comment-icon.svg)을 클릭하여 콘텐츠 감시자를 확인합니다.

### 콘텐츠 구독 취소 {#unsubscribe-to-content}

가입을 해지하려면:

1. **[!UICONTROL 자산 관리]**&#x200B;의 [!UICONTROL 감시 Assets]&#x200B;(으)로 이동합니다.

1. 구독을 취소할 자산, 폴더 또는 컬렉션을 선택하고 **[!UICONTROL 보기 취소]**&#x200B;를 클릭합니다.

   ![콘텐츠 구독 취소](assets/unsubscribe-assets.png)

또는 [!UICONTROL 자산 관리]에서 폴더, 자산 또는 컬렉션을 검색하십시오. [구독한 에셋](#subscribe-to-content)을 선택하고 **[!UICONTROL 시청 취소]**&#x200B;를 클릭합니다.
