...
Adobe Express은 기본적으로 [최소 이미지 요구 사항 검토](https://helpx.adobe.com/kr/express/web/image-creation-and-editing/change-file-formats/image-requirements.html)에서 사용할 수 있는 형식을 지원합니다. 하지만 AEM Assets은 다음과 같은 형식 유형을 지원합니다.
