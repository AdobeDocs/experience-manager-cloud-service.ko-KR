...
| 허용 목록에 추가하다 *dragOptions.drag* | 부울 | 아니요 | | 속성은 선택할 수 없는 에셋의 드래그를 허용하거나 거부하는 데 사용됩니다. [dragOptions 속성](/help/assets/asset-selector-customization.md#drag-options-property)을 참조하세요. |
