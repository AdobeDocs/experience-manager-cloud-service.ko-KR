...
회사는 제어 및 안정적인 메타데이터 어휘가 필요하므로 AEM Assets는 새로운 메타데이터 속성을 임시로 추가하는 것을 허용하지 않습니다. 작성자가 에셋에 대한 새 메타데이터 필드를 추가할 수는 없지만 개발자는 이를 수행할 수 있습니다. 자산에 [대한 새 메타데이터 속성 만들기를 참조하십시오](meta-edit.md#editing-metadata-schema).
...
1. 다음 중 하나를 수행하십시오.
   ...
   * 자산 페이지의 도구 모음에서 속성 **[!UICONTROL 보기를 클릭/]** 탭합니다.
...
1. 노드 유형 관리 페이지 https://&lt; *host>:&lt;port>/crx/explorer/nodetypes/index.jsp로 이동합니다*.
