...
>[!VIDEO](https://video.tv.adobe.com/v/3451966/?captions=kor&learn=on){transcript=true}
...
1. **[!UICONTROL 소스 폴더]** 필드에 데이터 소스의 자산이 포함된 루트 폴더의 이름을 입력합니다.
   ...
   >* 도메인 없이 루트 폴더 이름만 지정하십시오. 폴더의 전체 URL 경로가 `https://my.sharepoint.com/my?id=/personal/user/Documents/Importfolder/`인 경우 `/Importfolder/`Source 폴더&#x200B;**[!UICONTROL 필드에]**&#x200B;을(를) 지정하십시오.
