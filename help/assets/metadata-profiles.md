...
## {#removing-a-metadata-profile-from-folders} 폴더에서 메타데이터 프로필을 제거하는 중
...
### 프로필 사용자 인터페이스 {#removing-metadata-profiles-from-folders-via-profiles-user-interface}을 통해 폴더에서 메타데이터 프로필을 제거하는 중
...
### 속성 {#removing-metadata-profiles-from-folders-via-properties}을 통해 폴더에서 메타데이터 프로필 제거
