...
1. 특정 태그가 생성되지 않은 경우 그에 따라 이미지 유형 태그를 교육할 수 있습니다. [스마트 태그 교육](/help/assets/smart-tags-training.md)을 참조하세요.
...
[스마트 태그 교육의 요구 사항 확인](/help/assets/smart-tags-training.md#smart-tag-training-requirement)을 참조하세요.
