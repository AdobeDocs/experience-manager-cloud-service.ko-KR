...
오퍼를에 Adobe [통합 [!DNL Workfront] 및 [!DNL Adobe Experience Manager Assets] 기본적으로(Assets Essentials 및 자산 as a Cloud Service 지원) 또는 Workfront for Experience Manager 고급 커넥터 사용](https://experienceleague.adobe.com/docs/workfront/using/documents/wf-aem-integrations/wf-aem-essentials/aem-asset-integrations.html). 네이티브 통합의 경우 두 솔루션을 통합하는 커넥터가 필요하지 않습니다.

>[!NOTE]
>
>Adobe은 향상된 Experience Manager 및 Experience Manager 통합을 위해 Workfront을 동시에 사용하는 것을 지원하지 않습니다.
...
|----|----|----|------|-----|-----|
| 배포 메서드 | 적합한 [!DNL Assets] 제공 | Assets Essentials | Cloud Service, Adobe Managed Services, 온-프레미스 | 클라우드 서비스 |
| **일반** |
