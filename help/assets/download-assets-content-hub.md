...
단일 에셋을 다운로드하려면 에셋 카드의 다운로드 아이콘을 클릭합니다. 여러 에셋의 경우 에셋을 선택하고 작업 표시줄에서 다운로드 를 클릭합니다. 관리자가 다운로드를 활성화한 경우 Content Hub에서 원본 렌디션의 에셋 다운로드를 시작합니다. 에셋 변환을 사용할 수 있는 경우 다운로드하기 전에 특정 변환을 선택할 수 있습니다.
...
에셋 렌디션은 다양한 사용 사례에 맞게 조정된 원본 에셋 파일을 다르게 표현합니다. 유형에는 정적 렌디션(예: 썸네일, 웹 또는 모바일에 최적화된 버전, 인쇄용 고해상도 파일), 사용자 지정 정적 렌디션 및 동적 렌디션(스마트 자르기 버전 포함)이 포함됩니다. 정적 렌디션은 미리 생성되는 반면 동적 렌디션은 요청에 따라 실시간으로 생성됩니다.

### 스마트 자르기는 AEM Assets Content Hub의 에셋에서 어떻게 작동합니까?

스마트 자르기는 이미지의 가장 중요한 부분을 식별하고 주변을 지능적으로 자르는 AI 기반 기능입니다. 이렇게 하면 다양한 화면 및 형식에서 시각적 개체가 잘 보입니다. 조직에서 Dynamic Media 기능을 지원하는 경우 이미지 에셋에 스마트 자르기 렌디션을 사용할 수 있습니다.
...
### Content Hub에서 에셋 렌디션을 다운로드하려면 어떻게 합니까?

렌디션을 다운로드하려면 에셋을 선택하고 다운로드 작업을 클릭합니다. 관리자가 렌디션을 활성화한 경우 다운로드할 렌디션을 선택할 수 있는 대화 상자가 나타납니다. 라이센스가 부여된 에셋의 경우 다운로드하기 전에 라이센스 약관에 동의하십시오. 여러 에셋의 경우 에셋을 선택하고 렌디션을 선택한 다음 ZIP 파일로 다운로드합니다. 사용 가능한 모든 렌디션이나 정적 또는 동적 렌디션과 같은 특정 렌디션을 선택할 수 있습니다.
