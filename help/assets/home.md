...
description: Adobe Experience Manager Assets as a Cloud Service 셀프 도움말 리소스 및 설명서 링크
...
# 클라우드 서비스로 AEM 자산 {#aem-assets-guide}

이 페이지에는 Assets에 대한 자체 도움말 리소스가 클라우드 서비스로 표시됩니다.

## 클라우드 서비스 아티클로의 주요 에셋 {#key-articles}

* [클라우드 서비스로 에셋 소개](overview.md)
* [클라우드 서비스로서의 에셋 아키텍처](architecture.md)
...
| [개요](/help/overview/home.md) | 이 안내서에서는 소개, 용어 등을 비롯하여 클라우드 서비스로서의 Experience Manager에 대한 개요를 제공합니다. |
