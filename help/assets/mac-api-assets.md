...
자산 HTTP API를 사용하면 [!DNL Experience Manager] 컨텐츠 조각을 사용하여 구조화된 컨텐츠와 함께 메타데이터, 변환 및 주석을 비롯한 디지털 자산에 대한 CRUD(Create-Read-Update-Delete) 작업을 수행할 수 있습니다. 이것은 `/api/assets`에 노출되며 REST API로 구현됩니다. 여기에는 [컨텐츠 조각 지원](/help/assets/content-fragments/assets-api-content-fragments.md)이 포함됩니다.
...
자세한 내용은 Experience Manager 자산 HTTP API](/help/assets/content-fragments/assets-api-content-fragments.md)의 [콘텐츠 조각 지원을 참조하십시오.
...
컨텐츠 조각의 요소에 대한 자세한 내용은 Experience Manager 에셋 HTTP API[의 컨텐츠 조각 지원을 참조하십시오.](/help/assets/content-fragments/assets-api-content-fragments.md)
...
API를 사용하여 자산을 만드는 방법에 대한 자세한 내용은 [자산 업로드](developer-reference-material-apis.md)를 참조하십시오. HTTP API를 사용하여 에셋 만들기는 더 이상 사용되지 않습니다.

## 자산 이진 {#update-asset-binary} 업데이트

API를 사용하여 자산 이진을 업데이트하는 방법에 대한 자세한 내용은 [자산 업로드](developer-reference-material-apis.md)를 참조하십시오. HTTP API를 사용하여 에셋 바이너리를 업데이트하는 것은 더 이상 사용되지 않습니다.
