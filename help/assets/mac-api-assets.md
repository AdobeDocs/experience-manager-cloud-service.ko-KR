...
>[!NOTE]
>
>일반적으로(예: 표현물)의 자산 또는 이진 파일을 업로드하거나 업데이트하는 것과 관련된 모든 API 호출은 AEM에 대해 클라우드 서비스 배포로 정의됩니다. 바이너리를 업로드하려면 [직접 바이너리 업로드 API를](developer-reference-material-apis.md#asset-upload-technical) 대신 사용하십시오.
...
콘텐츠 조각의 요소에 대한 자세한 내용은 Experience Manager Assets HTTP API의 [콘텐츠 조각 지원을 참조하십시오](/help/assets/assets-api-content-fragments.md).
