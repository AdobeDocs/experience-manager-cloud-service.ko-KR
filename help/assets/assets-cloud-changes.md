...
에셋 마이크로서비스는 클라우드 서비스를 사용하여 자산을 확장 가능하고 탄력적으로 처리할 수 있습니다. Adobe는 다양한 자산 유형 및 처리 옵션을 적절하게 처리하기 위해 클라우드 서비스를 관리합니다. 에셋 마이크로서비스는 일반적인 파일 유형에 즉시 사용 가능한 기능을 제공하면서 타사의 렌더링 툴과 방법(예: ImageMagick 및 FFmpeg 트랜스코딩)이 필요하지 않고 구성을 단순화할 수 있도록 도와줍니다. 현재 ImageMagick 통합 및 FMmpeg 트랜스코딩은 클라우드 서비스에서 사용할 수 없습니다.
