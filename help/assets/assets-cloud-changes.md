...
| MIME 유형 감지 | 지원되지 않습니다. | 확장이 없거나 잘못된 디지털 에셋을 업로드하는 경우 원하는 대로 처리되지 않을 수 있습니다. 사용자는 DAM에 확장명 없이 이진 파일을 저장할 수 있습니다. [6.5 [!DNL Experience Manager] 에서 &#x200B;](https://experienceleague.adobe.com/ko/docs/experience-manager-65/content/assets/administer/detect-asset-mime-type-with-tika)MIME 형식 검색을 참조하십시오. |
