...
[!DNL AEM Assets View]은(는) UI 확장성을 지원하므로 [!DNL Assets View]의 기본 기능에서 충족되지 않는 특정 워크플로 및 비즈니스 요구 사항에 대해 [!DNL AEM Assets View] UI에 사용자 지정 UI 구성 요소를 추가할 수 있습니다. [!DNL AEM Assets View]의 이 UI 확장성 기능은 유연성을 향상시켜 조직에서 특정 워크플로 및 요구 사항에 맞게 인터페이스를 조정할 수 있도록 합니다.\
**자산**, **폴더** 및 **컬렉션** 수준에 확장을 추가할 수 있습니다. 추가된 확장은 **자산**, **컬렉션** 또는 **폴더** **[!UICONTROL 세부 정보]** 페이지의 전용 패널에 표시됩니다.

>[!IMPORTANT]
>
> * [!DNL AEM Assets View]에서 [[!DNL Assets Ultimate]](/help/assets/assets-ultimate-overview.md) UI 확장성을 사용할 수 있습니다.
...
## Assets 보기에서 작업 사용자 지정 {#customize-actions-assets-view}

AEM Assets 보기를 사용하면 찾아보기 보기에서 다음 작업을 사용자 정의할 수 있습니다.

* 작업 표시줄에서 에셋을 하나 이상 선택하면 표시되는 작업을 사용자 지정합니다.

* 에셋 카드에서 추가 옵션(...)을 클릭할 때 표시되는 작업을 사용자 지정합니다.

* 헤더 메뉴에서 사용할 수 있는 작업을 사용자 지정합니다.

자세한 내용은 [보기 찾아보기](https://developer.adobe.com/uix/docs/services/aem-assets-view/api/browse-view/)를 참조하십시오.
