...
# 에셋의 스마트 태그 지정을 위한 Experience Manager 구성 {#configure-aem-for-smart-tagging}
...
* 공개 키 [!DNL Experience Manager] 를 생성하기 위한 구성을 만듭니다. [OAuth 통합에 대한 공용 인증서](#obtain-public-certificate) 획득을 참조하십시오.
* [Adobe 개발자 콘솔에서](#create-aio-integration) 통합을 만들고 생성된 공개 키를 업로드합니다.
...
* [인증서가 만료된 후 다시 구성하십시오](#certrenew).
