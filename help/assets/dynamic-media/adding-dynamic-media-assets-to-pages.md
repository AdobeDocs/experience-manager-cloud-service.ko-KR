...
* **[!UICONTROL 뷰어 수정자]** - 뷰어 수정자는 &amp; 구분 기호가 있는 name=value 쌍의 형태로 구성되며 뷰어 참조 가이드에 설명된 대로 뷰어를 변경할 수 있습니다. 뷰어 수정자의 예는 다음과 같습니다. `posterimage=img.jpg&caption=text.vtt,1` 는 비디오 썸네일에 대해 다른 이미지를 설정하고 닫힌 캡션 파일을 비디오와 연결합니다.
