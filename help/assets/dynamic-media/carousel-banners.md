...
1. 회전판 세트의 시각적 디자인과 동작을 변경할 수 있습니다. 동작 및 모양 탭을 탭하거나 클릭하고 캐러셀 배너의 모양 또는 특정 구성 요소의 작동 방식을 조정합니다. 뷰어 편집기를 사용하는 방법에 대한 자세한 내용은 [뷰어 사전 설정 관리](/help/assets/dynamic-media/viewer-presets.md)를 참조하십시오.
...
미리 보기를 사용하여 고객에게 표시되는 캐러셀 배너를 확인할 수 있습니다. 또한 미리 보기를 사용하면 회전식 배너의 핫스팟과 이미지 맵을 테스트하여 예상대로 작동하는지 확인할 수 있습니다.
