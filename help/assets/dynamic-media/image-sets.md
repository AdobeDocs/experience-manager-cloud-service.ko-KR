...
세트를 만드는 데 문제가 있으면 문제 해결 Dynamic Media의 이미지 및 세트 [를 참조하십시오](/help/assets/dynamic-media/troubleshoot-dm.md#images-and-sets).
...
* 검색에서 **[!UICONTROL 필터**]를 선택한 다음 **[!UICONTROL Dynamic Media** 을 확장하고 **[!UICONTROL 세트를 선택할 수 있습니다]**.
