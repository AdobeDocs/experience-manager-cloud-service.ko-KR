...
Dynamic Media에는 미리 정의된 응용 비디오 인코딩 프로필이 이미 포함되어 있습니다. 이 기본 프로필의 설정은 최상의 보기 환경을 고객에게 제공하기 위해 최적화되어 있습니다. 응용 비디오 인코딩 프로필을 사용하여 기본 소스 비디오를 인코딩할 때 재생 중에 비디오 플레이어는 고객의 인터넷 연결 속도에 따라 비디오 스트림의 품질을 자동으로 조정합니다. 이를 응용 스트리밍이라고 합니다.
...
>[!NOTE]
>
>비디오의 메타데이터와 관련 비디오 이미지 축소판을 생성하려면 비디오 자체가 Dynamic Media의 인코딩 프로세스를 거쳐야 합니다. AEM에서, Dynamic Media을 활성화하고 비디오 클라우드 서비스를 설정한 경우 **[!UICONTROL Dynamic Media 비디오 인코딩]** 워크플로우는 비디오를 인코딩합니다. 이 워크플로우는 워크플로우 프로세스 내역 및 실패 정보를 캡처합니다. [비디오 인코딩 및 YouTube 게시 진행 모니터링](/help/assets/dynamic-media/video.md#monitoring-video-encoding-and-youtube-publishing-progress)을 참조하십시오. Dynamic Media을 활성화하고 비디오 클라우드 서비스를 설정한 경우 비디오를 업로드할 때 **[!UICONTROL Dynamic Media 비디오 인코딩]** 워크플로우가 자동으로 적용됩니다. (Dynamic Media을 사용하지 않는 경우 **[!UICONTROL DAM 자산 업데이트]** 워크플로우가 적용됩니다.)
>
...
Adobe Sensei은 현재 9,000프레임으로 제한됩니다. 즉, 30FPS로 5분 정도 소요됩니다. 비디오에 FPS가 더 높은 경우 지원되는 최대 비디오 지속 시간이 줄어듭니다. 예를 들어 60FPS 비디오는 Adobe 센사이 및 스마트 자르기에서 지원되려면 2분 30초 분이어야 합니다.
...
그러나 사전 정의된 이 프로필이 사용자의 요구 사항을 충족하지 않을 경우 자신만의 응용 비디오 인코딩 프로필을 만들도록 선택할 수 있습니다. 응용 스트리밍을 위해 **[!UICONTROL 인코딩 설정을 사용하는 경우 프로파일에 추가하는 최적의 모든 인코딩 사전 설정으로 모든 비디오의 종횡비가 동일한지 확인할 수 있습니다.]** 또한 인코딩된 비디오는 스트리밍을 위한 다중 비트 전송률 세트로 처리됩니다.
...
1. AEM 로고를 누르고 **[!UICONTROL 도구]** > **[!UICONTROL 자산]** > **[!UICONTROL 비디오 프로필]**&#x200B;으로 이동합니다.
...
1. 다음 중 하나를 수행하십시오.
   * 4-10단계를 반복하여 추가 인코딩 사전 설정을 만듭니다. 응용 비디오 스트리밍에는 둘 이상의 비디오 사전 설정이 필요합니다.
   * 다음 단계로 이동합니다.
...
자세한 내용은 [비디오 인코딩 모범 사례](/help/assets/dynamic-media/video.md#best-practices-for-encoding-videos)를 참조하십시오.

다른 에셋 유형에 대한 고급 처리 매개 변수를 정의하려면 [에셋 처리 구성](/help/assets/dynamic-media/config-dm.md#configuring-asset-processing)을 참조하십시오.

**점진적 스트리밍을 위한 비디오 프로파일을 만들려면**

1. AEM 로고를 누르고 **[!UICONTROL 도구]** > **[!UICONTROL 에셋]** > **[!UICONTROL 비디오 프로필]**&#x200B;으로 이동합니다.
1. 새 비디오 프로필을 추가하려면 **[!UICONTROL 만들기]**&#x200B;를 탭합니다.
1. 프로필의 이름과 설명을 입력합니다.
1. 비디오 인코딩 사전 설정 만들기/편집 페이지에서 **[!UICONTROL 비디오 인코딩 사전 설정 추가]**&#x200B;를 누릅니다.
1. **[!UICONTROL 기본]** 탭에서 비디오 및 오디오 옵션을 설정합니다.
선택한 비디오 형식 코덱에 따라 추가 설명 또는 권장 설정을 보려면 각 옵션 옆에 있는 정보 아이콘을 누릅니다.
1. (선택 사항) 비디오 크기 제목에서 **[!UICONTROL 종횡비 유지]**&#x200B;의 선택을 취소합니다.
1. 다음을 수행합니다.
   * **[!UICONTROL 폭]** 필드에 **[!UICONTROL auto]**&#x200B;를 입력합니다.
   * **[!UICONTROL 높이]** 필드에 픽셀 단위로 값을 입력합니다.
비디오의 크기를 시각화하는 데 도움이 되도록 높이의 정보 아이콘을 눌러 **[!UICONTROL 크기 계산기]** 페이지를 엽니다. **[!UICONTROL 크기 계산기]** 페이지를 사용하여 원하는 비디오 치수(파란색 상자)를 추가로 설정합니다. 완료되면 대화 상자의 오른쪽 상단에서 **[!UICONTROL X]**&#x200B;을 누릅니다.
...
1. 페이지의 오른쪽 상단에서 **[!UICONTROL 저장]**&#x200B;을 눌러 사전 설정을 저장합니다.
1. 다음 중 하나를 수행하십시오.

   * 4-9단계를 반복하여 추가 인코딩 사전 설정을 만듭니다.
   * 다음 단계로 진행합니다.

1. (선택 사항) 이 프로파일이 적용될 비디오에 비디오 스마트 자르기를 추가하려면 다음을 수행합니다.

   * 비디오 프로필 편집 페이지의 스마트 자르기 비율 머리글 오른쪽에서 **[!UICONTROL 새로 추가]**&#x200B;를 누릅니다.
   * [이름] 필드에 쉽게 식별할 수 있는 자르기 비율의 이름을 입력합니다.
   * **[!UICONTROL 자르기 비율]** 드롭다운 목록에서 사용할 비율을 선택합니다.
...
1. 페이지의 오른쪽 상단에서 **[!UICONTROL 저장]**&#x200B;을 눌러 프로필을 저장합니다.

이제 비디오가 포함된 폴더에 프로파일을 적용할 수 있습니다. 폴더](#applying-a-video-profile-to-folders) 또는 &lt; a2/>전역으로 비디오 프로필 적용](#applying-a-video-profile-globally)을 참조하십시오.[[

## 사용자가 추가한 비디오 인코딩 매개 변수 사용 {#using-custom-added-video-encoding-parameters}

AEM에서 비디오 프로필을 만들거나 편집할 때 사용자 인터페이스에 없는 고급 비디오 인코딩 매개 변수를 활용하려면 기존 비디오 인코딩 프로필을 편집할 수 있습니다. 기존 프로파일에 minBitrate 및 maxBitrate 등의 고급 매개 변수를 하나 이상 사용자 정의할 수 있습니다.

**사용자 정의 추가 비디오 인코딩 매개 변수를 사용하려면 다음을 수행합니다**.

1. AEM 로고를 누른 다음 **[!UICONTROL 도구]** > **[!UICONTROL 일반]** > **[!UICONTROL CRXDE Lite]**&#x200B;으로 이동합니다.
1. CRXDE Lite 페이지의 왼쪽에 있는 탐색기 패널에서 다음 항목으로 이동합니다.

   `/conf/global/settings/dam/dm/presets/video/*name_of_video_encoding_profile_to_edit`

1. 페이지의 오른쪽 아래 패널의 [속성] 탭에서 사용할 매개 변수의 **[!UICONTROL 이름]**, **[!UICONTROL Type]** 및 **[!UICONTROL 값]**&#x200B;을 지정합니다.

   다음과 같은 고급 매개 변수를 사용할 수 있습니다.
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td><p>10 * h264 레벨</p> <p>예를 들어 3.0 = 30, 1.3 = 13)입니다.</p> <p>기본값이 없습니다.</p> </td>
  </tr>
  <tr>
   <td><code>keyframe</code></td>
   <td>키프레임 사이의 대상 프레임 수입니다. 2-10초마다 키프레임을 생성하려면 이 값을 계산합니다. 예를 들어 초당 30프레임에서 키프레임 간격은 60-300이어야 합니다.<br /> <br /> 키프레임 간격이 낮을수록 적응형 비디오 인코딩에 대한 스트림 검색 및 스트림 전환 동작이 향상되고, 동작이 많은 비디오의 품질도 향상될 수 있습니다. 그러나 키프레임의 파일 크기가 커지므로 키프레임 간격이 낮을수록 일반적으로 지정된 비트 전송률에서 전반적인 비디오 품질이 떨어집니다.</td>
   <td><code>String</code></td>
   <td><p>양수</p> <p>기본값은 300입니다.</p> <p>HLS(HTTP Live Streaming)의 권장 값은 60-90입니다.</p> </td>
  </tr>
  <tr>
   <td><code>minBitrate</code></td>
   <td><p>가변 비트 전송률 인코딩을 허용하는 최소 비트 전송률(Kbps/초당 킬로비트)</p> <p>이 매개 변수는 비디오 인코딩 프로파일을 만들거나 편집할 때 [고급] 탭에서 [상수 비트 전송률 사용</strong>]이 선택 해제된 경우에만 적용됩니다.<strong></strong></p> <p>자세한 내용은 <a href="/help/assets/dynamic-media/video.md#bitrate">비트 전송률</a>을 참조하십시오.</p> </td>
   <td><code>String</code></td>
   <td><p>양수(Kbps)입니다.</p> <p>기본값이 없습니다.</p> </td>
  </tr>
  <tr>
   <td><code>maxBitrate</code></td>
   <td><p>가변 비트 전송률 인코딩을 허용하는 최대 비트 전송률(Kbps)입니다.</p> <p>이 매개 변수는 비디오 인코딩 프로파일을 만들거나 편집할 때 [고급] 탭에서 [상수 비트 전송률 사용</strong>]이 선택 해제된 경우에만 적용됩니다.<strong></strong></p> <p>자세한 내용은 <a href="/help/assets/dynamic-media/video.md#bitrate">비트 전송률</a>을 참조하십시오.</p> </td>
   <td><code>String</code></td>
   <td><p>양수(Kbps)입니다.</p> <p>기본값이 없습니다. 그러나 인코딩 비트 전송률의 최대 두 배까지 권장됩니다.</p> </td>
  </tr>
  <tr>
   <td><code>audioBitrateCustom</code></td>
   <td>오디오 코덱에서 지원하는 경우 오디오 스트림에 대해 일정한 비트 전송률을 적용하려면 값을 <code>true</code>로 설정합니다.</td>
   <td><code>String</code></td>
...
1. 페이지의 오른쪽 아래 모퉁이 근처에서 **[!UICONTROL 추가]**&#x200B;를 누릅니다.
1. 다음 중 하나를 수행하십시오.

   * 3단계와 4단계를 반복하여 비디오 인코딩 프로파일에 다른 매개 변수를 추가합니다.
   * 페이지의 왼쪽 위 모서리 근처에 있는 **[!UICONTROL 모두 저장]**&#x200B;을 누릅니다.

1. CRXDE Lite 페이지의 왼쪽 상단에서 **[!UICONTROL Back Home]** 아이콘을 눌러 AEM으로 돌아갑니다.

### 비디오 프로필 편집 {#editing-a-video-encoding-profile}

만든 비디오 프로필을 편집하여 해당 프로필 내에서 비디오 사전 설정을 추가, 편집 또는 삭제할 수 있습니다.

기본적으로 Dynamic Media과 함께 제공되는 사전 정의된 기본 제공 **[!UICONTROL 적응형 비디오 인코딩]** 프로필은 편집할 수 없습니다. 대신 쉽게 프로파일을 복사하여 새 이름으로 저장할 수 있습니다. 그런 다음 복사된 프로필에서 원하는 사전 설정을 편집할 수 있습니다.

자세한 내용은 [비디오 인코딩 모범 사례](/help/assets/dynamic-media/video.md#best-practices-for-encoding-videos)를 참조하십시오.

다른 에셋 유형에 대한 고급 처리 매개 변수를 정의하려면 [에셋 처리 구성](/help/assets/dynamic-media/config-dm.md#configuring-asset-processing)을 참조하십시오.

**비디오 프로파일을 편집하려면 다음을 수행합니다**.

1. AEM 로고를 누르고 **[!UICONTROL 도구]** > **[!UICONTROL 에셋]** > **[!UICONTROL 비디오 프로필]**&#x200B;으로 이동합니다.
1. 비디오 프로필 페이지에서 비디오 프로필 이름 하나를 선택합니다.
1. 도구 모음에서 **[!UICONTROL 편집]**&#x200B;을 누릅니다.
1. [비디오 인코딩 프로파일] 페이지에서 원하는 대로 이름과 설명을 편집합니다.
1. 최상의 방법으로 **[!UICONTROL 적응형 스트리밍에 인코딩]** 확인란이 선택되어 있는지 확인하십시오.
적응형 스트리밍에 대한 설명을 보려면 정보 아이콘을 누릅니다. 프로그레시브 비디오 프로파일을 편집하는 경우에는 이 확인란을 선택하지 마십시오.
1. [비디오 인코딩 사전 설정] 머리글 아래에서 프로파일을 구성하는 비디오 인코딩 사전 설정을 추가, 편집 또는 삭제합니다.

   선택한 비디오 형식 코덱에 따라 추가 설명 또는 권장 설정을 보려면 **[!UICONTROL 기본]** 및 **[!UICONTROL 고급]** 탭의 각 옵션 옆에 있는 정보 아이콘을 누릅니다.

1. 페이지의 오른쪽 상단에서 **[!UICONTROL 저장]**&#x200B;을 누릅니다.
...
1. [비디오 인코딩 프로파일] 페이지에서 프로파일의 새 이름을 입력합니다.
1. 최상의 방법으로 **[!UICONTROL 적응형 스트리밍에 인코딩]** 확인란이 선택되어 있는지 확인하십시오. 적응형 스트리밍에 대한 설명을 보려면 정보 아이콘을 누릅니다. 점진적 비디오 프로필을 복사하는 경우에는 확인란을 선택하지 마십시오.

   Dynamic Media - 하이브리드 모드에서 WebM 비디오 사전 설정이 비디오 프로필의 일부인 경우 모든 사전 설정이 MP4여야 하므로 **[!UICONTROL 적응형 스트리밍용으로 인코딩]**&#x200B;이 불가능합니다.
1. [비디오 인코딩 사전 설정] 머리글 아래에서 프로파일을 구성하는 비디오 인코딩 사전 설정을 추가, 편집 또는 삭제합니다.
...
## 폴더 {#applying-a-video-profile-to-folders}에 비디오 프로파일 적용

폴더에 비디오 프로파일을 할당하면 하위 폴더가 해당 상위 폴더의 프로파일을 자동으로 상속합니다. 즉, 하나의 폴더에 하나의 비디오 프로파일만 할당할 수 있습니다. 따라서 에셋을 업로드, 저장, 사용 및 보관하는 폴더 구조를 신중하게 고려하십시오.

폴더에 다른 비디오 프로필을 할당하면 새 프로필은 이전 프로필을 재정의합니다. 이전에 기존 폴더 에셋은 변경되지 않습니다. 새 프로파일은 나중에 폴더에 추가된 에셋에 적용됩니다.

프로파일이 할당된 폴더는 카드 이름에 나타나는 프로파일의 이름으로 사용자 인터페이스에 표시됩니다.

![chlimage_1-517](assets/chlimage_1-517.png)

특정 폴더에 비디오 프로파일을 적용하거나 모든 에셋에 전역적으로 적용할 수 있습니다.
...
### 특정 폴더 {#applying-video-profiles-to-specific-folders}에 비디오 프로파일 적용

**[!UICONTROL 도구]** 메뉴 내에서 또는 폴더에 있는 경우 **[!UICONTROL 속성]**&#x200B;에서 비디오 프로필을 폴더에 적용할 수 있습니다. 이 섹션에서는 두 가지 방법 모두에서 폴더에 비디오 프로파일을 적용하는 방법에 대해 설명합니다.

프로파일이 이미 할당된 폴더는 폴더 이름 바로 아래에 프로파일 이름을 표시하여 표시됩니다.

처리 프로필](/help/assets/dynamic-media/about-image-video-profiles.md#reprocessing-assets)을 편집한 후 폴더에서 [자산 재처리를 참조하십시오.

#### 프로파일 사용자 인터페이스 {#applying-video-profiles-to-folders-by-way-of-the-profiles-user-interface}를 통해 폴더에 비디오 프로파일 적용

1. AEM 로고를 누르고 **[!UICONTROL 도구]** > **[!UICONTROL 에셋]** > **[!UICONTROL 비디오 프로필]**&#x200B;으로 이동합니다.
1. 폴더 또는 여러 폴더에 적용할 비디오 프로필을 선택합니다.
1. **[!UICONTROL 폴더에 프로필 적용]**&#x200B;을 누르고 새로 업로드된 에셋을 받는 데 사용할 폴더 또는 폴더를 여러 개 선택하고 **[!UICONTROL 적용]**&#x200B;을 누릅니다. 프로파일이 이미 할당된 폴더는 **[!UICONTROL 카드 보기]**에 있는 동안 폴더 이름 바로 아래에 프로필 이름을 표시하여 표시됩니다.
[비디오 프로파일 처리 작업 진행 상황을 모니터링할 수 있습니다](#monitoring-the-progress-of-an-encoding-job).

#### 속성 {#applying-video-profiles-to-folders-from-properties}의 폴더에 비디오 프로파일 적용

1. AEM 로고를 누르거나 클릭하고 **[!UICONTROL 에셋]**&#x200B;으로 이동한 다음 비디오 프로필을 적용할 폴더로 이동합니다.
1. 폴더에서 확인 표시를 눌러 선택한 다음 **[!UICONTROL 속성]**&#x200B;을 누릅니다.
1. **[!UICONTROL 비디오 프로필]** 탭을 선택하고 드롭다운 메뉴에서 프로필을 선택한 다음 **[!UICONTROL 저장 및 닫기]**&#x200B;를 클릭합니다. 프로파일이 이미 할당된 폴더는 폴더 이름 바로 아래에 프로파일 이름을 표시하여 표시됩니다.

   ![chlimage_1-518](assets/chlimage_1-518.png)
비디오 프로파일  [처리 작업의 진행률을 모니터링할 수 있습니다](#monitoring-the-progress-of-an-encoding-job).

### 전역적으로 비디오 프로파일 적용 {#applying-a-video-profile-globally}

폴더에 프로파일을 적용하는 것 외에도 AEM 에셋에 업로드된 모든 내용에 선택된 프로파일이 적용되도록 프로파일을 전체적으로 적용할 수도 있습니다.

[폴더](/help/assets/dynamic-media/about-image-video-profiles.md#reprocessing-assets)의 자산 재처리를 참조하십시오.

**전체** 비디오 프로파일을 적용하려면

* 다음 노드로 CRXDE Lite으로 이동합니다.`/content/dam/jcr:content`. 속성 `videoProfile:/libs/settings/dam/video/dynamicmedia/<name of video encoding profile>`을 추가하고 **[!UICONTROL 모두 저장]**&#x200B;을 누릅니다.
...
비디오 프로파일 처리 작업의 진행률을 시각적으로 모니터링할 수 있도록 처리 표시기(또는 진행률 표시줄)가 표시됩니다.

또한 `error.log` 파일을 통해 인코딩 작업의 진행률을 모니터링하거나 인코딩이 완료되었는지 확인하거나 작업 오류를 확인할 수 있습니다. `error.log`은 AEM 인스턴스가 설치된 `logs` 폴더에 있습니다.

## 폴더 {#removing-a-video-profile-from-folders}에서 비디오 프로필 제거

폴더에서 비디오 프로필을 제거하면 모든 하위 폴더가 해당 상위 폴더에서 해당 프로필의 제거를 자동으로 상속합니다. 그러나 폴더 내에서 발생한 모든 파일 처리는 그대로 유지됩니다.

**[!UICONTROL 도구]** 메뉴 내에서 또는 폴더에 있는 경우 **[!UICONTROL 폴더 설정]**&#x200B;에서 비디오 프로필을 제거할 수 있습니다. 이 섹션에서는 두 가지 방법 모두에서 비디오 프로파일을 제거하는 방법에 대해 설명합니다.
...
### 속성 {#removing-video-profiles-from-folders-by-way-of-properties}을 통해 폴더에서 비디오 프로필 제거

1. AEM 로고를 누르거나 클릭하고 **[!UICONTROL 에셋]**&#x200B;으로 이동한 다음 비디오 프로필을 제거할 폴더로 이동합니다.
1. 폴더에서 체크 표시를 누르거나 클릭하여 선택한 다음 **[!UICONTROL 속성]**&#x200B;을 누릅니다.
1. **[!UICONTROL 비디오 프로필]** 탭을 선택하고 드롭다운 메뉴에서 **[!UICONTROL 없음]**&#x200B;을 선택하고 **[!UICONTROL 저장 및 닫기]**&#x200B;를 클릭합니다. 프로파일이 이미 할당된 폴더는 폴더 이름 바로 아래에 프로파일 이름을 표시하여 표시됩니다.
