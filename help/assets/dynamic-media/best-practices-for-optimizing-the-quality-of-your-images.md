---
title: 이미지 품질 최적화를 위한 모범 사례
description: Dynamic Media에서 이미지 품질을 최적화하기 위한 모범 사례 알아보기
...
# 이미지 품질 최적화를 위한 모범 사례 {#best-practices-for-optimizing-the-quality-of-your-images}
...
AEM에는 이미지 조정 및 최적화와 렌더링 결과를 위한 100개 이상의 Dynamic Media 이미지 제공 명령이 포함되어 있습니다. 다음 지침은 몇 가지 필수 명령과 우수 사례를 사용하여 프로세스를 간소화하고 좋은 결과를 신속하게 얻을 수 있도록 도와줍니다.
...
모범 사례 백서 Adobe [Scene7 Publishing System 및 이미지 서버에서](/help/assets/dynamic-media/assets/s7_sharpening_images.pdf) 이미지를 선명하게 하는 것도 AEM에 적용됩니다.

Adobe TV에서 선명한 [마스크로](https://helpx.adobe.com/photoshop/atv/cs6-tutorials/sharpening-an-image-with-unsharp-mask.html)이미지 선명하게 하기를 시청하십시오.
...
* 언샵 마스킹( `&op_USM`) - 언샵 마스크는 업계 표준의 선명하게 하기 필터입니다. 아래 지침에 따라 언샵 마스킹을 사용하여 이미지를 선명하게 하는 것이 좋습니다. 언샵 마스킹을 사용하면 다음 세 가지 매개 변수를 제어할 수 있습니다.
   ...
   * `&op_sharpen=`amount,radius,threshold
      ...
      * **[!UICONTROL 임계값]** (0-255, 효과의 민감도)
      ...
      모범 사례 백서 Adobe [Scene7 Publishing System 및 이미지 서버에서 이미지를 선명하게 합니다](/help/assets/dynamic-media/assets/s7_sharpening_images.pdf).
...
## JPEG 크기 조정(`&jpegSize=`) 우수 사례 {#best-practices-for-jpeg-sizing-jpegsize}
