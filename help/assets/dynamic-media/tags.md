...
* 사용자가 *viewer1*&#x200B;에서 패닝하면 **[!UICONTROL TrackPan]** 규칙이 트리거되므로 첫 번째 호출이 발생합니다. 해당 호출은 *viewer1*&#x200B;이(가) 규칙을 트리거한 것을 인식하고 해당 배율 값을 검색하므로 **50%**&#x200B;을(를) **[!UICONTROL ZoomScale]** 데이터 요소의 값으로 보냅니다.
