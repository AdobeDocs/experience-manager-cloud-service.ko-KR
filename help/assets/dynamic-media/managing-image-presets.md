...
AEM as a Cloud Service에서 렌디션은 [에셋 마이크로서비스](https://experienceleague.adobe.com/ko/docs/experience-manager-cloud-service/content/assets/manage/asset-microservices-configure-and-use#)를 사용하여 생성됩니다. DAM 자산 업데이트 워크플로우를 Cloud Service에서 사용자 정의할 수 없습니다.
...
1. [처리 프로필](https://experienceleague.adobe.com/ko/docs/experience-manager-cloud-service/content/assets/manage/asset-microservices-configure-and-use#)을 만들거나 편집합니다.
2. 필요한 렌디션 정의를 구성합니다.
