...
| 버전 | 문서 링크 |
| -------- | ---------------------------- |
| AEM 6.5 | [여기를 클릭하십시오.](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/previewing-3d-assets.html?lang=en) |
...
또한 워크스테이션, 노트북 또는 모바일 터치 장치와 같은 클라이언트 컴퓨터의 기능도 대화식으로 카메라를 조작할 때 고려해야 합니다. 그래픽 성능이 뛰어난 강력한 시스템을 사용하면 대화형 3D 보기 환경을 더욱 원활하고 유용하게 만들 수 있습니다.
...
1. 3D 자산에 대한 자산 세부 사항 보기 페이지에서 다음 중 하나를 수행합니다.
   ...
   | **카메라 다시 입력** | 3D 장면에서 개체의 한 지점으로 카메라를 다시 입력합니다. | 두 번 클릭합니다. | 두 번 탭하세요. |
