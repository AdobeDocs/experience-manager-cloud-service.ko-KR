...
>[!NOTE]
>
>Adobe Experience Manager의 웹 페이지(사이트)에 있는 경우 **[!UICONTROL 편집]** 모드에서 자산을 미리 볼 수 없습니다. 대신 페이지의 오른쪽 상단에 있는 **[!UICONTROL 미리 보기]**&#x200B;를 클릭하여 미리 보기 모드로 이동합니다.
...
1. **[!UICONTROL Experience Manager]**&#x200B;탐색&#x200B;]**페이지에서**[!UICONTROL &#x200B;자산&#x200B;]**을 탭한 다음,**[!UICONTROL &#x200B;파일&#x200B;]**을 탭하여 자산에 액세스합니다.**[!UICONTROL 
...
1. 클릭한 자산 유형에 따라 다음 중 하나를 수행합니다.
   ...
   <table>
    <tbody>
      ...
      <li>이미지를 원래 확대/축소판으로 돌아가려면 <strong>재설정</strong>을 누릅니다.</li>
      <li>표시 장치에서 뷰어를 극대화하려면 <strong>전체 화면</strong>을 누릅니다.</li>
      </ul>
      ...
      <td><p><strong>특정 표현물의 자산을 미리 보려면</strong></p>
        ...
        </ul><p><strong>+</strong> 및 <strong>-</strong>아이콘을 사용하여 선택한 이미지의 확대/축소를 각각 늘리거나 줄이십시오. 이미지를 원래 확대/축소로 되돌리려면 <strong>재설정</strong>을 누릅니다.<br />터치 스크린을 사용하는 경우 이미지를 두 번 탭하여 단계별로 확대합니다. 최대 확대/축소에 도달하면 이미지를 다시 두 번 탭하여 확대/축소 상태를 재설정합니다. 이미지를 드래그하여 패닝합니다.</p> </td>
      </tr>
      <tr>
      <td>멀티미디어</td>
      <td>예</td>
