...
1. 연결에 성공하면 다음을 설정할 수 있습니다.
   ...
   | 속성 | 설명 |
   |---|---|
   | 회사 | Dynamic Media 계정의 이름입니다. 다양한 하위 브랜드, 사업부 또는 스테이징/프로덕션 환경에 대한 여러 Dynamic Media 계정이 있을 수 있습니다.<br>참조 - [Dynamic Media 회사 별칭 계정 구성](/help/assets/dynamic-media/dm-alias-account.md). |
