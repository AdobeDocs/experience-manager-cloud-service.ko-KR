---
title: 선택기를 사용하여 작업
description: Dynamic Media에서 대화형 이미지, 대화형 비디오 및 회전 배너의 자산을 선택하는 데 사용할 수 있는 방법에 대해 알아봅니다.
...
핫스팟이나 이미지 맵이 이동할 위치를 수동으로 입력하지 않고 선택하는 경우에는 선택기를 사용합니다. 사이트 선택기는 [!DNL Adobe Experience Manager Sites] 고객인 경우에만 작동합니다. 제품 선택기에도 [!DNL Experience Manager Commerce]이(가) 필요합니다.
...
1. **[!UICONTROL 제품 선택기]** 아이콘(돋보기)을 선택하고 카탈로그의 제품으로 이동합니다.
   ...
   **[!UICONTROL 필터]**&#x200B;를 탭하고 키워드를 입력하거나 태그를 선택하거나 둘 다 선택하여 키워드나 태그로 필터링할 수 있습니다.

   ![chlimage_1-523](assets/chlimage_1-523.png)

   **[!UICONTROL 찾아보기]**&#x200B;를 탭하고 다른 폴더로 이동하여 [!DNL Experience Manager]에서 제품 데이터를 찾는 위치를 변경할 수 있습니다.

   ![chlimage_1-524](assets/chlimage_1-524.png)

   **[!UICONTROL 정렬 기준]**&#x200B;을 선택하여 [!DNL Experience Manager]을(를) 가장 최근에서 가장 오래된 순으로 정렬할지 또는 가장 오래된 항목에서 가장 최근으로 정렬할지를 변경합니다.
...
1. **[!UICONTROL 미리 보기]** 모드에서는 핫스팟 또는 이미지 맵을 선택하고 빠른 보기가 표시되는 방식을 확인할 수 있습니다.

   ![chlimage_1-528](assets/chlimage_1-528.png)

## Dynamic Media에서 사이트 선택 {#selecting-sites}

[!DNL Experience Manager] 사이트에서 관리되는 웹 페이지에 핫스팟이나 이미지 맵을 연결하려면 사이트 선택기를 사용하여 웹 페이지를 선택하십시오.
...
1. **[!UICONTROL 사이트 선택기]** 아이콘(확대경이 있는 폴더)을 선택하고 [!DNL Experience Manager] 사이트에서 핫스팟이나 이미지 맵을 연결할 페이지로 이동합니다.
...
1. **[!UICONTROL 미리 보기]** 모드에서는 핫스팟 또는 이미지 맵을 선택하면 지정한 [!DNL Experience Manager] 사이트 페이지로 이동합니다.
...
자세한 내용은 [자산 선택기](/help/assets/search-assets.md#asset-selector)도 참조하세요.
...
1. **[!UICONTROL 자산 선택기]** 아이콘(확대경이 있는 폴더)을 선택하고 자산으로 이동합니다.
   ...
   **[!UICONTROL 경로]** 필드의 다른 폴더로 이동하여 [!DNL Experience Manager]에서 자산을 찾는 위치를 변경할 수 있습니다.
