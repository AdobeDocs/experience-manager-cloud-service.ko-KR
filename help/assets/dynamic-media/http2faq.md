...
* 일반 Dynamic Media 도메인(`images.company.com`, `mycompany.scene7.com` 또는 `s7d1.scene7.com`)이 아닌 전용 도메인(`s7d2.scene7.com` 또는 `s7d13.scene7.com`)을 사용하십시오.
...
1. 지원 사례에 다음 정보를 제공하십시오.
   ...
   * 전용 도메인을 사용 중인지 확인합니다. 즉, `images.company.com`, `mycompany.scene7.com`, `s7d1.scene7.com`과(와) 같은 일반 Dynamic Media 도메인이 아닌 `s7d2.scene7.com` 또는 `s7d13.scene7.com`입니다.
