...
description: 비디오 인코딩 모범 사례 및 YouTube에 비디오 게시와 같이 Dynamic Media에서 비디오로 작업하는 방법에 대해 알아봅니다. 또한 폐쇄 캡션, 캡션 또는 챕터 마커를 비디오에 추가하는 방법도 알아봅니다.
...
Dynamic Media는 [!DNL Experience Manager Assets]에 대한 플러그인이므로 대부분의 키보드 제어 동작은 [!DNL Experience Manager Assets]과(와) 동일합니다. 예를 들어 Dynamic Media의 `Cancel` 단추는 [!DNL Experience Manager Assets]과(와) 동일한 포커스 강조 표시를 갖습니다. 또한 `Spacebar`에서와 같이 [!DNL Experience Manager Assets] 키에도 반응합니다. [Assets의 키보드 단축키](/help/assets/accessibility.md#keyboard-shortcuts)를 참조하십시오.
...
Dynamic Media 뷰어 참조 안내서의 뷰어 사용자 지정 항목에서 **보조 기술 지원** 도움말 항목을 참조하십시오. 예를 들어 비디오 뷰어의 경우 [보조 기술 지원](https://experienceleague.adobe.com/ko/docs/dynamic-media-developer-resources/library/viewers-aem-assets-dmc/video/r-html5-video-viewer-20-assistive#) 또는 대화형 이미지 뷰어의 경우 [보조 기술 지원](https://experienceleague.adobe.com/ko/docs/dynamic-media-developer-resources/library/viewers-for-aem-assets-only/interactive-images/c-html5-aem-interactive-image-assistive#viewers-for-aem-assets-only)을 참조하십시오.
...
>[!MORELIKETHIS]
>
>* [Adobe 솔루션에 대한 접근성](https://www.adobe.com/trust/accessibility.html)
