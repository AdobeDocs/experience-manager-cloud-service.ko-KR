...
description: 언샵 마스크, 스마트 자르기 또는 스마트 견본 또는 두 가지 모두에 대한 설정이 포함된 Dynamic Media 이미지 프로필을 만드는 방법을 알아봅니다. 그런 다음 이미지 자산 폴더에 프로필을 적용합니다.
  ...
  <tr>
   ...
   <td><p>이 옵션을 사용하려면 [자르기 옵션] 드롭다운 목록에서 <strong>픽셀 자르기</strong>를 선택합니다.</p> <p>이미지의 양쪽에서 자르려면 이미지의 측면 또는 양쪽에서 자를 픽셀 수를 입력합니다. 이미지 파일의 ppi(인치당 픽셀 수) 설정에 따라 이미지의 크기가 잘립니다.</p> <p>이미지 프로필 픽셀 자르기는 다음 방식으로 렌더링됩니다.<br /> </p>
    <ul>
     ...
     <li>수평 계산:원본 이미지의 가로 픽셀 크기를 [왼쪽]으로 표시한 다음 [오른쪽]을 뺀 다음</li>
...
>[!NOTE]
>
>언샵 마스크는 50% 이상 다운샘플링된 PTIFF(피라미드형 tiff) 내의 축소된 변환에만 적용됩니다. 즉, PTIFF 내에서 가장 큰 크기의 변환이 언샵 마스크의 영향을 받지 않습니다. 반면 축소판과 같은 작은 크기의 표현물은 변경됩니다(그리고 언샵 마스크 표시).
...
1. Adobe Experience Manager 로고를 누르고 **[!UICONTROL 도구]** > **[!UICONTROL 자산]** > **[!UICONTROL 이미지 프로필]**&#x200B;으로 이동합니다.
...
1. Experience Manager 로고를 누르고 **[!UICONTROL 도구]** > **[!UICONTROL 자산]** > **[!UICONTROL 이미지 프로필]**&#x200B;으로 이동합니다.
...
1. Experience Manager 로고를 누르고 **[!UICONTROL 자산]**&#x200B;으로 이동한 다음 이미지 프로필을 적용할 폴더로 이동합니다.
...
1. Experience Manager 로고를 누르고 **[!UICONTROL 자산]**&#x200B;으로 이동한 다음 스마트 자르기 또는 스마트 견본 이미지 프로필이 적용된 폴더로 이동합니다.
1. 콘텐트를 열려면 폴더를 누릅니다.
...
스마트 자르기를 포함하는 이미지 프로필을 폴더에 적용하면 해당 폴더의 모든 이미지에는 자르기가 적용됩니다. 원하는 경우 여러 이미지의 스마트 자르기 창을 수동으로 *다시 정렬하거나 크기를 조정하여 초점을 더 세분화할 수 있습니다.*
...
1. Experience Manager 로고를 누르고 **[!UICONTROL 자산]**&#x200B;으로 이동한 다음 이미지 프로필을 제거할 폴더로 이동합니다.
1. 폴더에서 확인 표시를 눌러 선택한 다음 **[!UICONTROL 속성]**&#x200B;을 누릅니다.
