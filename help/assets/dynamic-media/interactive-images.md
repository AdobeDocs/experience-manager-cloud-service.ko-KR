...
1. **(선택 사항) 핫스팟 변수를 식별합니다**. Adobe Experience Manager Assets 및 Dynamic Media 독립 실행형 을 사용하는 경우 기존 Quickview 구현에 사용된 동적 변수를 식별합니다. 이렇게 하면 대화형 이미지를 만들 때 핫스팟 데이터를 입력할 수 있습니다. 다음을 참조하십시오 [(선택 사항) 핫스팟 변수 식별](#optional-identifying-hotspot-variables).
...
1. 페이지의 오른쪽 상단 모서리 근처에서 을 선택합니다. **[!UICONTROL 만들기]**.
...
1. 페이지의 왼쪽 상단 모서리 근처에서 을 선택합니다. **[!UICONTROL 핫스팟]**.
   ...
   1. (선택 사항) 핫스팟을 삭제하려면 이미지에서 핫스팟을 선택한 다음 를 선택합니다 **[!UICONTROL 삭제]** (휴지통 아이콘) 아래 **[!UICONTROL 핫스팟]** 제목.
...
1. 다음 중 하나를 수행하십시오.
   ...
   * 선택 **[!UICONTROL 빠른 보기]**.
      ...
      * Experience Manager Sites 또는 eCommerce 고객의 경우 제품 선택기 아이콘(돋보기)을 선택하여 제품 선택 페이지를 엽니다. 사용할 제품을 선택한 다음 을 선택합니다. **선택** 페이지의 오른쪽 상단 모서리에서 을 참조하십시오. 핫스팟 관리 페이지로 돌아갑니다.
      * 다음과 같은 경우 *아님* Experience Manager Sites 또는 eCommerce 고객
         ...
         * (선택 사항) Quickview 내에 제품을 추가로 식별하는 데 사용되는 다른 변수가 있으면 을 선택합니다. **[!UICONTROL 일반 변수 추가]**. 텍스트 필드에 추가 변수를 지정합니다. 예를 들어, `category=Mens` 는 추가된 변수입니다.
   ...
   * 선택 **[!UICONTROL 경험 조각]**.
      ...
      * Experience Manager Sites 고객인 경우 검색 아이콘(돋보기)을 선택하여 경험 조각 페이지를 엽니다. 사용할 경험 조각을 선택합니다. 그런 다음 을 선택합니다 **[!UICONTROL 선택]** 페이지의 오른쪽 상단 모서리에서 을 참조하십시오. 핫스팟 관리 페이지로 돌아갑니다.
다음을 참조하십시오 [경험 조각](/help/sites-cloud/authoring/fragments/content-fragments.md).
...
1. 에셋 보기에서 생성한 기존 대화형 이미지로 이동한 다음 선택하여 미리보기에서 엽니다.
1. 미리보기 페이지의 왼쪽 상단 모서리 근처에 있는 콘텐츠 드롭다운 목록에서 을(를) 선택합니다. **[!UICONTROL 뷰어]**.
1. 뷰어 목록에서 다음을 선택합니다. **[!UICONTROL Shopable_Banner]** 또는 만든 대화형 이미지 뷰어 사전 설정의 이름입니다.
