...
[페이지에 Dynamic Media 자산 추가](/help/assets/dynamic-media/adding-dynamic-media-assets-to-pages.md)도 참조하세요.
...
*을(를) WCM으로 사용하여* not[!DNL Experience Manager]하는 경우 Dynamic Media 3D 자산을 게시하는 데 다음 두 가지 방법을 사용하십시오.
