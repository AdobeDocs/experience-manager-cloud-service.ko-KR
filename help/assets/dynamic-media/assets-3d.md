...
Dynamic Media에서 3D 자산으로 작업하기 전에 AEM 관리자가 이미 Dynamic Media Cloud Service을 활성화하고 구성했는지 확인하십시오.

Dynamic Media [Cloud Service 구성을 참조하십시오.](/help/assets/dynamic-media/config-dm.md#configuring-dynamic-media-cloud-services)
...
1. 3D 자산을 AEM에 업로드했는지 확인합니다.
   ...
   Dynamic Media [에서 사용할 3D 자산 업로드를 참조하십시오.](/help/assets/add-assets.md#upload-assets)
...
![3D 미디어 구성 요소 내부에 표시되는 3D 자산](/help/assets/dynamic-media/assets/3d-asset-in-3d-mediaa.png)미리 보기 **[!UICONTROL 모드에서 표시된 대로 완전히 인터랙티브한 3D 자산]** .   미리 **[!UICONTROL 보기]** 모드에서 다음 중 하나를 수행합니다.](/help/assets/dynamic-media/assets/3d-asset-in-3d-mediaa.png)]**

1. **카메라** 회전 - 3D 장면 및 개체 주위를 따라 주위를 선회할 수 있습니다.]**
...
## Dynamic Media에는 웹 페이지에서 3D 모델을 대화형 볼 수 있도록 AEM Sites에서 사용할 수 있는 Dynamic Media 3D 미디어 구성 요소가 포함되어 있습니다.{#working-with-three-d-media-component}
...
* 페이지 템플릿에 3D 미디어 구성 요소 추가 {#adding-three-d-media-component-to-page-template}](#assigning-a-three-d-asset-to-the-component)


## 도구 > **[!UICONTROL 일반 > 템플릿으로 이동합니다]**.
...
1. ![3d-media-component-structure](/help/assets/dynamic-media/assets/3d-media-component-structurea.png)]**
   ...
   레이아웃 컨테이너 **[!UICONTROL 영역에서]** 빈 영역을 눌러 선택하고 관련 도구 모음을 엽니다.](/help/assets/dynamic-media/assets/3d-media-component-structurea.png)

1. 도구 모음에서 **[!UICONTROL 정책]** 아이콘을 눌러 **[!UICONTROL 정책 편집기를 엽니다]**.
1. [ **[!UICONTROL 속성]** ] **** 섹션의 [허용된 구성 요소 ** 탭에서]** Dynamic Media **[!UICONTROL 으로 스크롤한 다음 목록을 확장하고]** 3D Media을 확인합니다.
1. 완료를 **[!UICONTROL 눌러]** 변경 사항을 저장하고 **[!UICONTROL 정책 편집기를 닫습니다]**.********
1. 이제 이 템플릿을 사용하는 모든 페이지에 Dynamic Media 3D 미디어 구성 요소를 배치할 수 있습니다.********

   웹 페이지에 3D 미디어 구성 요소 추가 {#adding-the-three-d-media-component-to-a-web-page}

## 웹 컨텐츠 관리 시스템으로 Adobe Experience Manager을 사용하는 경우 3D 미디어 구성 요소를 통해 웹 페이지에 3D 자산을 추가할 수 있습니다.{#adding-the-three-d-media-component-to-a-web-page}

See also [Adding Dynamic Media assets to pages.](/help/assets/dynamic-media/adding-dynamic-media-assets-to-pages.md)

AEM Sites을 열고 Dynamic Media 3D 미디어 구성 요소를 추가할 웹 페이지를 선택합니다.[](/help/assets/dynamic-media/adding-dynamic-media-assets-to-pages.md)
...
1. ![3d-media-component-add](/help/assets/dynamic-media/assets/3d-media-component-edita.png)]******
   ...
   ![도구 모음에서 사이드 패널 아이콘을 눌러 패널 표시를 켜거나 전환합니다.](/help/assets/dynamic-media/assets/3d-media-component-edita.png)
...
1. ![3d-media-component-drag-drop](/help/assets/dynamic-media/assets/3d-assets-filtera.png)]**
   ...
   [ **[!UICONTROL 구성 요소]** ] 목록에서 **[!UICONTROL 3D 미디어]** 구성 요소를 3D 뷰어를 표시할 페이지의 위치로 드래그합니다.](/help/assets/dynamic-media/assets/3d-assets-filtera.png)

1. 이제 구성 요소에 3D 자산을 할당할 준비가 되었습니다.********

3D [미디어 구성 요소에 3D 자산 할당을 참조하십시오.](#assigning-a-three-d-asset-to-the-component)

선택 사항 - 3D 미디어 구성 요소 구성 {#configuring-the-three-d-component}](#assigning-a-three-d-asset-to-the-component)

### AEM Sites 페이지 편집기에서 이전에 페이지에 추가한 **[!UICONTROL 3D 미디어 뷰어]** 구성 요소를 선택합니다.
...
1. ![3d-media-component-config](/help/assets/dynamic-media/assets/3d-media-component-configa.png)]**
   ...
   [3D 미디어] 대화 상자의 [뷰어 사전 설정] 드롭다운 목록에서 **[!UICONTROL 차원을]** 선택하여 Dimensity viewer 사전 설정을 구성 요소에 지정합니다.](/help/assets/dynamic-media/assets/3d-media-component-configa.png)

1. ![3d-media-component-edit-config](/help/assets/dynamic-media/assets/3d-media-component-edit-configa.png)]**

   ![오른쪽 상단 모서리에서 확인 표시를 눌러 변경 사항을 저장합니다.](/help/assets/dynamic-media/assets/3d-media-component-edit-configa.png)

1. 3D 미디어 구성 요소에 3D 자산 할당 {#assigning-a-three-d-asset-to-the-component}

## 웹 페이지에 3D 미디어 구성 요소를 추가한 후 3D 자산을 할당할 수 있습니다.{#assigning-a-three-d-asset-to-the-component}

웹 [페이지에 3D 미디어 구성 요소 추가를 참조하십시오.](#adding-the-three-d-media-component-to-a-web-page)

AEM Sites 페이지 편집기에서 **[!UICONTROL 자산]** 아이콘을 클릭하여 사이드 패널에서 **[!UICONTROL 자산을]** 엽니다.](#adding-the-three-d-media-component-to-a-web-page)
...
1. ![3d 미디어 구성 요소에 3d 에셋 할당](/help/assets/dynamic-media/assets/3d-asset-adda.png)]**
...
[ **[!UICONTROL 카드 보기]**]에서 작은 둥근 모양 아이콘이 자산 이름 바로 아래, 해당 날짜 및 시간 왼쪽에 표시되어 게시되었음을 나타냅니다. 목록 보기 **[!UICONTROL 에서]**&#x200B;게시된 **** 열은 게시되었거나 게시되지 않은 자산을 나타냅니다.](/help/assets/dynamic-media/linking-urls-to-yourwebapplication.md#obtaining-a-url-for-a-static-asset)
...
**3D 자산(GLB, OBJ 또는 STL 파일 형식)을 열어 자산 세부 사항 페이지에서 볼 수 있습니다.**

1. 도구 모음에서 **[!UICONTROL 빠른 게시를 누릅니다]**.
1. ![3d-asset-quick-publish](/help/assets/dynamic-media/assets/3d-asset-quick-publisha.png)]**

   닫기 **[!UICONTROL 를]** 눌러 대화 상자를 종료하고 자산 세부 사항 페이지로 돌아갑니다.](/help/assets/dynamic-media/assets/3d-asset-quick-publisha.png)
...
1. ![3d-asset-renditions](/help/assets/dynamic-media/assets/3d-asset-renditionsa.png)]**
   ...
   원본을 **[!UICONTROL 누릅니다]**. 3D 자산을 게시하거나 &quot;활성화&quot;하면 다음 3D 자산 조건이 모두 충족되는 경우 페이지의 왼쪽 아래 모서리 근처에 **[!UICONTROL URL]** 단추가 표시됩니다.](/help/assets/dynamic-media/assets/3d-asset-renditionsa.png)

1. 3D 자산은 지원되는 형식(GLB, OBJ, STL 및 USDZ)입니다.********
   * 3D 자산이 Dynamic Media IPS(Image Production System)로 수집되었습니다.
   * 3D 자산이 게시됩니다.
   * ![3d-asset-url](/help/assets/dynamic-media/assets/3d-asset-urla.png)

   URL **[!UICONTROL 을]** 눌러 웹 페이지에서 복사하고 사용할 수 있는 3D 자산의 직접 제작 URL을 표시합니다.](/help/assets/dynamic-media/assets/3d-asset-urla.png)

1. 차원 뷰어를 사용하여 Dynamic Media 3D 자산을 게시하는 대체 방법 {#alternate-publish-methods}]**
...
* See [Linking URLs to your web application.](/help/assets/dynamic-media/linking-urls-to-yourwebapplication.md#obtaining-a-url-for-an-asset)]******
   ...
   **[!UICONTROL 포함]** - **[!UICONTROL 차원]** 뷰어를 사용하여 웹 페이지에 포함된 Dynamic Media 3D 자산을 보려는 경우 포함을 사용합니다. 포함 코드를 클립보드에 복사하여 웹 페이지에 붙여넣을 수 있습니다. 포함 대화 상자에서 코드 편집이 **[!UICONTROL 허용되지]** 않습니다.](/help/assets/dynamic-media/linking-urls-to-yourwebapplication.md#obtaining-a-url-for-an-asset)
