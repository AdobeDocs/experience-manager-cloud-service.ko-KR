...
또한 [소프트웨어 인터페이스를 사용하여 자산 미리 보기](/help/assets/dynamic-media/previewing-assets.md)를 참조하십시오.
...
1. [!DNL Experience Manager]탐색&#x200B;]**페이지의**[!UICONTROL &#x200B;자산 > 파일&#x200B;]**을 선택합니다.**[!UICONTROL 
1. 페이지의 오른쪽 위 모서리 근처에 있는 **[!UICONTROL 보기]** 드롭다운 목록에서 **[!UICONTROL 카드 보기]**&#x200B;를 선택합니다.
1. 보려는 3D 자산으로 이동합니다.
...
1. 페이지의 오른쪽 위 모서리에서 **[!UICONTROL 닫기]**&#x200B;를 선택하여 자산 페이지로 돌아갑니다.
...
1. 템플릿을 열려면 **[!UICONTROL 편집]**&#x200B;을 선택합니다.
...
1. 페이지를 페이지 편집기로 열려면 **[!UICONTROL 편집]** (연필) 아이콘을 선택합니다. **[!UICONTROL 편집]** 모드가 페이지 오른쪽 상단 근처에 있는지 확인합니다.
...
[3D 자산을 3D 미디어 구성 요소에 할당](#assigning-a-three-d-asset-to-the-component)을 참조하십시오

### 선택 사항 - 3D Media 구성 요소 구성 {#configuring-the-three-d-component}

1. [!DNL Experience Manager Sites] 페이지 편집기에서 이전에 페이지에 추가한 **[!UICONTROL 3D Media Viewer]** 구성 요소를 선택합니다.
1. 구성 요소 구성 대화 상자를 열려면 **[!UICONTROL 구성]** 아이콘(공구모양)을 선택합니다.
...
1. 3D 자산 파일 이름의 왼쪽에 있는 드롭다운 목록에서 **[!UICONTROL 표현물]**&#x200B;을 선택합니다.
...
1. 웹 페이지에서 복사하고 사용할 수 있는 3D 자산의 직접 프로덕션 URL을 표시하려면 **[!UICONTROL URL]**&#x200B;을 선택합니다.
...
* **[!UICONTROL URL]**  - 타사 웹 컨텐츠 관리 시스템을 사용하고  **** 차원 뷰어를 사용하여 Dynamic Media 3D 자산을 웹 페이지에 연결하려면 URL을 사용하십시오.
   ...
   [웹 애플리케이션에 URL 연결](/help/assets/dynamic-media/linking-urls-to-yourwebapplication.md#obtaining-a-url-for-an-asset)을 참조하십시오.
