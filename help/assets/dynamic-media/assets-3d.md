...
* 3D 이미지의 한 번의 클릭으로 게시(도구 모음에서 **[!UICONTROL 빠른 게시]** 사용)하여 URL을 생성합니다.
* Adobe Dimension 기반의 고품질의 인터랙티브한 차원 뷰어 사전 설정을 사용하여 3D 자산을 볼 수 있도록 최적화된 지원을 제공합니다. 뷰어 사전 설정에는 궤도, 확대/축소 및 패닝을 위한 인터랙티브한 카메라 컨트롤 컬렉션이 포함되어 있습니다.
* 3D Media WCM 구성 요소를 사용하면 AEM Sites 페이지에 3D 자산을 쉽게 추가할 수 있습니다.

Dynamic Media에서는 3D 자산을 사용하기 위한 어떠한 종류의 설치나 구성이 없습니다.

![3d 신발](/help/assets/dynamic-media/assets/3d-dimensional-viewer-quickpublish-url-embed2.png)
...
|---|---|---|---|
| GLB | 이진 GL 전송 | model/gltf-binary | 외부 이미지로 참조하는 대신 에셋과 텍스처를 포함합니다. |
| OBJ | WaveFront 3D 개체 파일 | application/x-tgif |  |
| STL | 입체사진 | application/vnd.ms-pki.stl |  |
| USDZ | 범용 장면 설명 Zip 아카이브 | model/vnd.usdz+zip | *섭취 전용 지원; 보기 또는 상호 작용을 사용할 수 없습니다.* USDZ는 Safari 또는 iOS에서만 볼 수 있는 Apple의 독점적인 3D 포맷입니다. |
...
1. 웹 페이지가 **[!UICONTROL 편집]** 모드에 있는 동안 다음 중 하나를 수행합니다.
   ...
   * 브라우저의 페이지 URL `/editor.html` 에서 삭제합니다.
   ![3D 미디어 구성 요소 내부에 표시되는 3D 자산](/help/assets/dynamic-media/assets/3d-asset-in-3d-media.png)미리 보기 **[!UICONTROL 모드에서 표시된 대로 완전히 인터랙티브한 3D 자산]** .
...
1. 자산 사이드 패널에서 3D 자산을 드래그하여 이전에 페이지에 추가한 **[!UICONTROL 3D 미디어]** 구성 요소에 놓습니다.
   ...
   ![3d 미디어 구성 요소에 3d 에셋 할당](/help/assets/dynamic-media/assets/3d-asset-add.png)
...
>[!MORELIKETHIS]
>
>타사 웹 컨텐츠 관리 시스템을 사용하는 경우 웹 페이지에 3D 자산을 연결하거나 포함할 수 있습니다.
>
...
1. 원본을 **[!UICONTROL 누릅니다]**. 3D 자산을 게시하거나 &quot;활성화&quot;하면 다음 3D 자산 조건이 모두 충족되는 경우 페이지의 왼쪽 아래 모서리 근처에 URL 단추가 나타납니다.
...
1. URL **[!UICONTROL 을]** 눌러 3D 자산의 프로덕션 URL을 표시합니다.
