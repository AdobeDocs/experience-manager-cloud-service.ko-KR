...
[ **[!UICONTROL 카드 보기]**]에서 작은 둥근 모양 아이콘이 자산 이름 바로 아래, 해당 날짜 및 시간 왼쪽에 표시되어 게시되었음을 나타냅니다. 목록 보기 **[!UICONTROL 에서]**&#x200B;게시된 **** 열은 게시되었거나 게시되지 않은 자산을 나타냅니다.](/help/assets/dynamic-media/publishing-dynamicmedia-assets.md)
...
>[!MORELIKETHIS]
>
>타사 웹 컨텐츠 관리 시스템을 사용하는 경우 웹 페이지에 3D 자산을 연결하거나 포함할 수 있습니다.[](/help/assets/dynamic-media/linking-urls-to-yourwebapplication.md)
...
1. ![3d-asset-renditions](/help/assets/dynamic-media/assets/3d-asset-renditionsa.png)]**
   * 원본을 **[!UICONTROL 누릅니다]**. 3D 자산을 게시하거나 &quot;활성화&quot;하면 다음 3D 자산 조건이 모두 충족되는 경우 페이지의 왼쪽 아래 모서리 근처에 URL 단추가 나타납니다.
