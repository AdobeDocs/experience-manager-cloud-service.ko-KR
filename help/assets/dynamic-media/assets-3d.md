...
* 3D 자산의 한 번의 클릭으로 게시(도구 모음에서 **[!UICONTROL 빠른 게시]** 사용)하여 URL을 생성합니다.
* Adobe Dimension 기반의 고품질의 대화형 차원 뷰어 사전 설정을 사용하여 3D 자산 보기를 지원하도록 최적화되었습니다.
* 3D Media WCM 구성 요소를 사용하면 3D 자산을 [!DNL Adobe Experience Manager Sites] 페이지에 쉽게 추가할 수 있습니다.
...
지원되는 [3D 형식도 참조하십시오](/help/assets/file-format-support.md#support-3d-formats)
...
Dynamic Media에서 3D 자산으로 작업하기 전에 [!DNL Experience Manager] 관리자가 이미 Dynamic Media Cloud Services을 활성화 및 구성했는지 확인하십시오.
...
소프트웨어 인터페이스를 사용하여 자산 미리 보기](/help/assets/dynamic-media/previewing-assets.md)도 참조하십시오.[

**자산 세부 사항 페이지에서 3D 자산을 보고 상호 작용하려면 다음을 수행하십시오.**

1. 3D 자산을 [!DNL Experience Manager]에 업로드했는지 확인합니다.

   Dynamic Media](/help/assets/add-assets.md#upload-assets)에서 사용할 3D 자산 업로드 를 참조하십시오.[

1. [!DNL Experience Manager]탐색&#x200B;]**페이지에서**[!UICONTROL &#x200B;자산 > 파일&#x200B;]**을 탭합니다.**[!UICONTROL 
...
>[!IMPORTANT]
>
>웹 페이지에 3D Media 구성 요소를 추가하고 구성 요소에 3D 자산을 할당한 후에만 이 작업을 수행할 수 있습니다. [웹 페이지에 3D Media 구성 요소 추가](#adding-the-three-d-media-component-to-a-web-page) 및 [3D Media 구성 요소에 3D 자산 할당](#assigning-a-three-d-asset-to-the-component)을 참조하십시오.

소프트웨어 인터페이스를 사용하여 자산 미리 보기](/help/assets/dynamic-media/previewing-assets.md)도 참조하십시오.[

**3D Media 구성 요소 내에서 3D 자산을 보고 상호 작용하려면 다음을 수행하십시오.**

1. 웹 페이지가 **[!UICONTROL 편집]** 모드에 있는 동안 다음 중 하나를 수행하십시오.

   * 페이지 오른쪽 상단 근처에 있는 **[!UICONTROL 미리 보기]**&#x200B;를 클릭하여 **[!UICONTROL 미리 보기]** 모드를 입력합니다.
   * 브라우저의 페이지 URL에서 `/editor.html`을 삭제합니다.

에 표시되는 완전히 대화형 3D 자산    ![3D Media ](/help/assets/dynamic-media/assets/3d-asset-in-3d-mediaa.png)
구성 요소 내부에 표시되는 3D 자산미리 보기 모드에 표시된  **** 대화형 3D 자산입니다.
...
Dynamic Media에는 웹 페이지에서 3D 모델을 대화형 볼 수 있도록 [!DNL Experience Manager Sites]에서 사용할 수 있는 Dynamic Media 3D Media 구성 요소가 포함되어 있습니다.
...
1. 페이지의 오른쪽 위 근처에 있는 드롭다운 메뉴에서 **[!UICONTROL 구조]** 모드가 아직 활성화되어 있지 않으면 선택합니다.

   ![3d-media-component-structure](/help/assets/dynamic-media/assets/3d-media-component-structurea.png)

1. 빈 영역을 선택하고 연결된 도구 모음을 열려면 **[!UICONTROL 레이아웃 컨테이너]** 영역에서 빈 영역을 누릅니다.
1. 도구 모음에서 **[!UICONTROL 정책]** 아이콘을 탭하여 **[!UICONTROL 정책 편집기]**&#x200B;를 엽니다.
1. **[!UICONTROL 속성]** 섹션의 **[!UICONTROL 허용된 구성 요소]** 탭에서 **[!UICONTROL Dynamic Media]**&#x200B;로 스크롤한 다음 목록을 확장하고 **[!UICONTROL 3D Media]**&#x200B;을 선택합니다.
1. **[!UICONTROL 완료]**&#x200B;를 눌러 변경 사항을 저장하고 **[!UICONTROL 정책 편집기]**&#x200B;를 닫습니다.

   이제 이 템플릿을 사용하는 모든 페이지에 Dynamic Media 3D Media 구성 요소를 배치할 수 있습니다.

## 웹 페이지에 3D Media 구성 요소 추가 {#adding-the-three-d-media-component-to-a-web-page}

웹 컨텐츠 관리 시스템으로 [!DNL Experience Manager] 을 사용하는 경우 3D 미디어 구성 요소를 통해 웹 페이지에 3D 자산을 추가할 수 있습니다.

또한 [페이지에 Dynamic Media 자산 추가](/help/assets/dynamic-media/adding-dynamic-media-assets-to-pages.md)를 참조하십시오.

1. [!DNL Experience Manager Sites] 을 열고 Dynamic Media 3D Media 구성 요소를 추가할 웹 페이지를 선택합니다.
1. 페이지를 페이지 편집기로 열려면 **[!UICONTROL 편집]** (연필) 아이콘을 누릅니다. **[!UICONTROL 편집]** 모드가 페이지 오른쪽 상단 근처에 있는지 확인합니다.

   ![3d-media-component-add](/help/assets/dynamic-media/assets/3d-media-component-edita.png)

1. 도구 모음에서 사이드 패널 아이콘을 탭하여 패널 표시를 전환하거나 &quot;켜기&quot;합니다.

1. 사이드 패널에서 더하기 기호 아이콘을 탭하여 **[!UICONTROL 구성 요소]** 목록을 엽니다.

   ![3d media-component-drag-drop](/help/assets/dynamic-media/assets/3d-assets-filtera.png)

1. **[!UICONTROL 3D Media]** 구성 요소를 **[!UICONTROL 구성 요소]** 목록에서 3D 뷰어를 표시할 페이지의 위치로 드래그합니다.

이제 구성 요소에 3D 자산을 할당할 준비가 되었습니다.

[3D 자산을 3D Media 구성 요소에 할당](#assigning-a-three-d-asset-to-the-component)을 참조하십시오

### 선택 사항 - 3D 미디어 구성 요소 {#configuring-the-three-d-component} 구성

1. [!DNL Experience Manager Sites] 페이지 편집기에서 이전에 페이지에 추가한 **[!UICONTROL 3D Media Viewer]** 구성 요소를 선택합니다.
1. 구성 요소 구성 대화 상자를 열려면 **[!UICONTROL 구성]** 아이콘(공구모양)을 누릅니다.

   ![3d-media-component-config](/help/assets/dynamic-media/assets/3d-media-component-configa.png)

1. [3D 미디어] 대화 상자의 [뷰어 사전 설정] 드롭다운 목록에서 **[!UICONTROL Dimensional]** 을 선택하여 Dimensional Viewer 사전 설정을 구성 요소에 할당합니다.
...
[웹 페이지에 3D Media 구성 요소 추가](#adding-the-three-d-media-component-to-a-web-page)를 참조하십시오.

1. [!DNL Experience Manager Sites] 페이지 편집기에서 **[!UICONTROL Assets]** 아이콘을 클릭하여 사이드 패널에서 **[!UICONTROL Assets]**&#x200B;를 엽니다.
1. 드롭다운 목록에서 **[!UICONTROL 3D]**&#x200B;을 선택하여 3D 자산 파일 형식만 표시합니다.
1. 사이드 패널에서 편집 중인 페이지에서 볼 3D 자산을 검색하거나 스크롤합니다.
1. 자산 사이드 패널에서 3D 자산을 **[!UICONTROL 3D Media]** 구성 요소에 끌어다 놓습니다. 이 구성 요소는 이전에 페이지에 추가한 것입니다.

   ![3d Media 구성 요소에 3d 자산 할당](/help/assets/dynamic-media/assets/3d-asset-adda.png)

>[!NOTE]
>
>웹 페이지가 [!DNL Experience Manager Sites] **[!UICONTROL 편집]** 모드에 있는 동안 3D 미디어 구성 요소에 3D 자산이 표시되지만 자산과 상호 작용할 수는 없습니다. 자산을 대화형으로 만들려면 **[!UICONTROL 미리 보기]** 기능을 사용하여 3D Media 구성 요소의 기능에 대한 전체 액세스 권한이 있는 페이지 편집기에서 웹 페이지를 볼 수 있습니다.

## 정적 Dynamic Media 3D 자산 게시 {#publishing-three-d-assets}

Dynamic Media은 Dynamic Media에서 *정적 콘텐츠*&#x200B;로 지원되는 다양한 3D 파일 형식을 허용합니다. 정적 컨텐츠는 3D 자산을 업로드하고 게시할 수 있지만 3D 자산과 연결된 *dynamic* 이미징 또는 이미지 리퍼팅을 지원하지 않음을 의미합니다. 이유는 Dynamic Media 이미징 서버에서 3D 형식을 인식하지 못하기 때문입니다. 따라서 Dynamic Media에서 3D 자산을 게시하면 복사할 수 있는 인스턴트 URL이 제공됩니다. 3D 자산의 URL은 일반적인 Dynamic Media URL 구조를 따릅니다. 하지만 Dynamic Media의 기존 이미지 자산과 달리 자산의 URL에서는 매개 변수를 편집할 수 없습니다.

[정적 자산에 대한 URL 가져오기](/help/assets/dynamic-media/linking-urls-to-yourwebapplication.md#obtaining-a-url-for-a-static-asset)도 참조하십시오.
...
WCM으로 [!DNL Experience Manager]을 사용하는 경우 이 게시 방법을 사용하여 웹 페이지에서 바로 Dynamic Media 3D 자산을 추가하십시오.

또한 [Dynamic Media 자산 게시](/help/assets/dynamic-media/publishing-dynamicmedia-assets.md)를 참조하십시오.
...
1. 세부 정보 페이지의 도구 모음에서 **[!UICONTROL 빠른 게시]**&#x200B;를 누릅니다.

   ![3d-asset-quick-publish](/help/assets/dynamic-media/assets/3d-asset-quick-publisha.png)

1. **[!UICONTROL Close]**&#x200B;를 눌러 대화 상자를 종료하고 자산 세부 사항 페이지로 돌아갑니다.
...
1. **[!UICONTROL 원래]**&#x200B;을 누릅니다. 3D 자산이 게시되면(또는 &quot;활성화됨&quot;), 다음 3D 자산 조건이 모두 충족되면 페이지의 왼쪽 하단 모서리에 **[!UICONTROL URL]** 단추가 표시됩니다.
...
1. 웹 페이지에서 복사하고 사용할 수 있는 3D 자산의 직접 프로덕션 URL을 표시하려면 **[!UICONTROL URL]**&#x200B;을 탭합니다.

### 차원 뷰어 {#alternate-publish-methods}를 사용하여 Dynamic Media 3D 자산을 게시하는 대체 방법

[!DNL Experience Manager]를 WCM으로 사용하지 않고 *이 인 경우 Dynamic Media 3D 자산을 게시하기 위해 다음 두 가지 방법을 사용하십시오.*

* **[!UICONTROL URL]**  - 타사 웹 컨텐츠 관리 시스템을 사용하고  **** 차원 뷰어를 사용하여 Dynamic Media 3D 자산을 웹 페이지에 연결하려면 URL을 사용하십시오.

   [URL을 웹 애플리케이션에 연결](/help/assets/dynamic-media/linking-urls-to-yourwebapplication.md#obtaining-a-url-for-an-asset)을 참조하십시오.

* **[!UICONTROL 포함]**  -  **** 차원 뷰어를 사용하여 웹 페이지에 포함된 Dynamic Media 3D 자산을 보려면 포함 을 사용합니다. 포함 코드를 클립보드에 복사하여 웹 페이지에 붙여넣을 수 있습니다. **[!UICONTROL 포함]** 대화 상자에서는 코드 편집이 허용되지 않습니다.

   웹 페이지에 [Dynamic Media 비디오, 이미지 뷰어 또는 Dimensional 뷰어 포함](/help/assets/dynamic-media/embed-code.md#embedding-the-video-or-image-viewer-on-a-web-page)을 참조하십시오.
