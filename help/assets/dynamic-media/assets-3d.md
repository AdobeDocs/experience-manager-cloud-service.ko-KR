...
## Dynamic Media에는 AEM Sites에서 사용할 수 있는 Dynamic Media 3D 미디어 구성 요소가 포함되어 있으므로 웹 페이지에서 3D 모델을 인터랙티브하게 볼 수 있습니다.{#working-with-three-d-media-component}
...
## Adobe Experience Manager를 웹 컨텐츠 관리 시스템으로 사용하는 경우 3D 미디어 구성 요소를 통해 웹 페이지에 3D 자산을 추가할 수 있습니다.{#adding-the-three-d-media-component-to-a-web-page}

See also [Adding Dynamic Media assets to pages](/help/assets/dynamic-media/adding-dynamic-media-assets-to-pages.md).

AEM Sites를 열고 Dynamic Media 3D 미디어 구성 요소를 추가할 웹 페이지를 선택합니다.[](/help/assets/dynamic-media/adding-dynamic-media-assets-to-pages.md)
...
### AEM Sites 페이지 편집기에서 이전에 페이지에 추가한 **[!UICONTROL 3D Media Viewer]** 구성 요소를 선택합니다.
...
1. ![3d-asset-renditions](/help/assets/dynamic-media/assets/3d-asset-renditionsa.png)]**
   ...
   원본을 **[!UICONTROL 누릅니다]**. 3D 자산을 게시하거나 &quot;활성화&quot;하면 다음 3D 자산 조건이 모두 충족되는 경우 페이지의 왼쪽 아래 모서리 근처에 URL 단추가 나타납니다.](/help/assets/dynamic-media/assets/3d-asset-renditionsa.png)
...
1. 3D 자산은 지원되는 형식(GLB, OBJ, STL 및 USDZ)입니다.****
   ...
   * ![3d-asset-url](/help/assets/dynamic-media/assets/3d-asset-urla.png)
   ...
   URL **[!UICONTROL 을]** 눌러 3D 자산의 프로덕션 URL을 표시합니다.](/help/assets/dynamic-media/assets/3d-asset-urla.png)
