...
1. [응용 비디오 프로필을 폴더에](/help/assets/dynamic-media/video-profiles.md#applying-a-video-profile-to-folders)적용합니다.
...
1. [비디오를 폴더에](/help/assets/manage-video-assets.md#upload-and-preview-video-assets)업로드합니다.
...
360 [비디오를 게시하는](/help/assets/dynamic-media/publishing-dynamicmedia-assets.md) 방법에 대한 자세한 내용은 다이내믹 미디어 자산 게시를 참조하십시오.
웹 [페이지에 비디오 또는 이미지 뷰어 포함을 참조하십시오](/help/assets/dynamic-media/embed-code.md).
웹 [애플리케이션에](/help/assets/dynamic-media/linking-urls-to-yourwebapplication.md)URL 연결을 참조하십시오. 인터랙티브한 컨텐츠에 상대 URL이 있는 링크, 특히 AEM Sites 페이지에 대한 링크가 있는 경우에는 URL 기반 링크 방법이 불가능합니다.
