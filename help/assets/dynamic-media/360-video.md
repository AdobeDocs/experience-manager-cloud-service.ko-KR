...
[AEM Assets에서 Dynamic Media 360 비디오 및 사용자 지정 비디오 썸네일 사용](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/dynamic-media/dynamic-media-360-video-custom-thumbnail-feature-video-use.html#dynamic-media)을 참조하십시오.
...
1. **[!UICONTROL Assets]**&#x200B;에서 생성한 기존 360 비디오로 이동합니다. 미리 보기 모드에서 열려면 360 비디오 자산을 선택합니다.
   ...
   ![Experience Manager 카드 보기에 표시된 업로드된 360개 비디오 자산의 스크린샷입니다.](assets/6_5_360video-selecttopreview-1.png)
