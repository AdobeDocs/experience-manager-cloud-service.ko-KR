...
이 문서에서는 [!DNL Dynamic Media] Prime 및 Ultimate 서비스를 사용하도록 설정하는 전체 워크플로에 대해 설명합니다.
...
1. 환경 세부 정보 페이지의 **[!UICONTROL 환경 정보]** 섹션에 있는 **[!UICONTROL Dynamic Media]** 행에서 **[!UICONTROL 활성화하려면 클릭]**을(를) 선택하십시오.
   ![OpenAPI 기능을 사용하여 Dynamic Media 활성화](/help/assets/assets/activate-adv-capabiliites-of-dm-openAPI.png){width="700" align="center"}
...
* ![DM 활성화됨](/help/assets/assets/Images_icon.svg)**[!UICONTROL Dynamic Media ]**:**[!UICONTROL  OpenAPI 기능을 활성화하지 못함&#x200B;]**  ![활성화 다시 시도](/help/assets/assets/retry-dm-openapi-failed-activation.png){width="700" align="center"}
...
[활성화 [!DNL Dynamic Media with OpenAPI]](#activate-dynamic-media-with-openapi)를 참조하여 환경에서 OpenAPI 기능을 사용하여 [!DNL Dynamic Media]의 기능을 사용해 보십시오.
