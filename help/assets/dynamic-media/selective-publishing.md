...
## 게시 관리{#selective-publish-manage-publication}를 사용하여 자산을 Dynamic Media 또는 Cloud Service으로 선택적으로 게시합니다.
...
## 빠른 게시 {#quick-publish-aem-dm}를 사용하여 Dynamic Media 또는 Experience Manager에 자산 게시
