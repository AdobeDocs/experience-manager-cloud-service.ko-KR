...
* [컨텐츠 조각](/help/assets/content-fragments/content-fragments-managing.md) 관리 - 컨텐츠 조각을 만듭니다.편집, 게시 및 참조
* [컨텐츠 조각 모델](/help/assets/content-fragments/content-fragments-models.md) - 모델 활성화, 생성 및 정의
* [변형 - 조각 컨텐츠](/help/assets/content-fragments/content-fragments-variations.md) 작성 - 조각 컨텐츠를 작성하고 마스터의 변형을 만듭니다.
* [Markdown](/help/assets/content-fragments/content-fragments-markdown.md) - 조각에 대한 마크다운 구문 사용
* [관련 컨텐츠 사용](/help/assets/content-fragments/content-fragments-assoc-content.md) - 관련 컨텐츠 추가
* [메타데이터 - 조각](/help/assets/content-fragments/content-fragments-metadata.md) 속성 - 조각 속성 보기 및 편집
...
>[!NOTE]
>
>또한 AEM은 조각 컨텐츠 번역을 지원합니다. 자세한 내용은 컨텐츠 조각에 대한 번역 프로젝트 만들기를 참조하십시오.
...
* 컨텐츠 조각 구성 요소 [](/help/sites-cloud/authoring/fundamentals/content-fragments.md) (참조 구성 요소)를 통해 페이지 편집기에서 사용됩니다.
...
* **조각에** 자산 삽입(혼합 미디어 조각)
   ...
   * 자산의 위치를 정의합니다.
   * 자세한 [내용은 조각](/help/assets/content-fragments/content-fragments-variations.md#inserting-assets-into-your-fragment) 편집기에서 조각에 자산 삽입을 참조하십시오.
   >[!NOTE]
   >
...
* 페이지 편집기의 **자산 브라우저에서** 사용할 수 있는 자산
   ...
   * 자세한 [내용은](/help/sites-cloud/authoring/fundamentals/environment-tools.md#assets-browser) 자산 브라우저를 참조하십시오.
...
* **단락 조각**
   ...
   * 서식 [있는 텍스트](/help/assets/content-fragments/content-fragments-variations.md#rich-text) 및 [마크다운](/help/assets/content-fragments/content-fragments-variations.md#markdown) 모드에서 단락 서식을 머리글로 지정할 수 있습니다. 이 경우 단락이 하나로 함께 속합니다.
...
* **조각에 삽입된 자산(혼합 미디어 조각)**
   ...
   * 조각의 단락 시스템에 포함됩니다.
   * 페이지에서 [조각을](/help/sites-cloud/authoring/fundamentals/content-fragments.md)사용/참조할 때 형식을 지정할 수 있습니다.
   * 조각 편집기를 사용하여 조각에만 추가, 삭제 또는 이동할 수 있습니다. 이러한 작업은 페이지 편집기에서 수행할 수 없습니다.
   * 조각 편집기에서 [](/help/assets/content-fragments/content-fragments-variations.md#inserting-assets-into-your-fragment)리치 텍스트 형식을 사용하여 조각에만 추가, 삭제 또는 이동할 수 있습니다.
   ...
   * 이전 텍스트(단락)에 첨부됩니다.
   ...
   >[!NOTE]
   >
   >페이지에서 조각을 사용할 때 자산을 [추가(중간) 컨텐츠로](/help/sites-cloud/authoring/fundamentals/content-fragments.md#using-associated-content) 추가할 수도 있습니다.관련 컨텐츠 또는 자산 브라우저의 자산을 사용합니다.
...
* **변형**
   ...
   * 사전 정의된 [길이로](/help/assets/content-fragments/content-fragments-variations.md#summarizing-text) 신속하게 텍스트를 자를 수 있도록 요약할 수 있습니다.
...
* **콘텐츠 모델**
   ...
   * 이 [활성화되고 도구를 사용하여 만들어집니다](/help/assets/content-fragments/content-fragments-models.md).
...
WKND [사이트](/help/implementing/developing/introduction/develop-wknd-tutorial.md) 샘플은 클라우드 서비스로서 AEM에 대해 학습하는 데 도움이 됩니다. 샘플 조각이 포함되어 있으며 다음과 같이 볼 수 있습니다.
