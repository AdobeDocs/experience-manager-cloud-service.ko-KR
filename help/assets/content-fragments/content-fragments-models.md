...
1. **모델 제목**을 지정합니다.
다양한 속성을 정의할 수도 있습니다(예: 추가) **태그**, a **설명**, 및 선택 **모델 활성화** 끝 [모델 활성화](#enabling-disabling-a-content-fragment-model) 필요한 경우.

   >[!NOTE]
   >
   >에 대한 자세한 내용은 **기본 미리보기 URL 패턴** 참조 [콘텐츠 조각 모델 - 속성](#content-fragment-model-properties).
...
* **최소 항목 수** / **최대 항목 수**
   ...
   * 최대값은에서 검증됩니다. [원본 콘텐츠 조각 편집기](/help/assets/content-fragments/content-fragments-variations.md).
   * 둘 다 [콘텐츠 조각 편집기](/help/sites-cloud/administering/content-fragments/authoring.md).
