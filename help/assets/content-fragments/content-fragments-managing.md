...
description: Headless 콘텐츠의 기반 또는 페이지 작성으로 Assets 콘솔을 사용하여 AEM 콘텐츠 조각을 관리하는 방법에 대해 알아봅니다.
...
Headless 콘텐츠의 기반 또는 페이지 작성으로 Assets 콘솔을 사용하여 AEM 콘텐츠 조각을 관리하는 방법에 대해 알아봅니다.
...
* 버튼을 사용하면 [콘텐츠 조각 콘솔](/help/sites-cloud/administering/content-fragments/managing.md#content-fragments-console)을 통해 액세스할 수 있는 *신규* [콘텐츠 조각 편집기](/help/sites-cloud/administering/content-fragments/authoring.md)를 직접 열어 **새 편집기를 사용해 보기**&#x200B;할 수 있습니다.
