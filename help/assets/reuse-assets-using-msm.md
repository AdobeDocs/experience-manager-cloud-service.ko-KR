...
| 버전 | 문서 링크 |
| -------- | ---------------------------- |
| AEM 6.5 | [여기를 클릭하십시오.](https://experienceleague.adobe.com/docs/experience-manager-65/assets/using/reuse-assets-using-msm.html) |
...
>[!NOTE]
>
>에 대한 MSM [!DNL Assets] 기능에는 다음과 같이 저장되는 컨텐츠 조각이 포함됩니다. [!DNL Assets] (사이트 기능으로 간주되지만).

>[!CAUTION]
>
>콘텐츠 조각용 MSM은 를 통해 콘텐츠 조각을 사용하는 경우에만 사용할 수 있습니다. **[!UICONTROL 에셋]** 콘솔.
>
>MSM 기능은 *아님* 를 사용할 때 사용 가능 **[!UICONTROL 컨텐츠 조각]** 콘솔.
...
**상속:** 시스템이 업데이트를 보낼 위치를 기억하기 위해 사용하는 라이브 카피 에셋/폴더와 소스 간의 링크/참조. 상속은 메타데이터 필드, 콘텐츠 조각 변형 및 필드에 대해 세분화된 수준에서 존재합니다. 소스와 해당 라이브 카피 간의 라이브 관계를 유지하면서 선택한 항목에 대한 상속을 제거할 수 있습니다.
...
1. 다음 항목 선택 **상속 취소** 아이콘, 필수 항목 옆:

   ![동기화 작업은 소스에 적용된 변경 사항을 가져옵니다.](assets/cancel-inheritance-icon.png)
...
1. 항목에 대한 상속을 활성화하려면 **상속 다시 활성화** 아이콘: 필수 항목 옆

   ![동기화 작업은 소스에 적용된 변경 사항을 가져옵니다.](assets/re-enable-inheritance-icon.png)
