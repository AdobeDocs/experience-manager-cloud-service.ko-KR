...
의 최신 버전 1.9.8에 대한 릴리스 날짜 [!DNL Workfront for Experience Manager enhanced connector] 는 2023년 3월 3일입니다.
...
>[!IMPORTANT]
>
>Adobe은 다음을 권장합니다. [최신 1.9.8 버전으로 업그레이드](../assets/update-workfront-enhanced-connector.md) / [!DNL Workfront for Experience Manager enhanced connector].
