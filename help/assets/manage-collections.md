...
컬렉션은 Adobe Experience Manager Assets 내의 에셋 세트입니다. 컬렉션을 사용하여 사용자 간에 에셋을 공유합니다. 집합은 정적 집합이거나 검색 결과를 기반으로 하는 동적 집합일 수 있습니다.
...
을(를) 열려면 **[!UICONTROL 컬렉션]**, Experience Manager 로고를 탭하거나 클릭합니다. 탐색 페이지에서 로 이동합니다. **[!UICONTROL 에셋]** > **[!UICONTROL 컬렉션]**.
...
1. 도구 모음에서 를 탭/클릭합니다 **[!UICONTROL 만들기]**.
...
1. 에셋을 (으)로 드래그 **[!UICONTROL 컬렉션에 놓기]** 영역. 또는 을 탭/클릭합니다 **[!UICONTROL 대상 컬렉션]** 아이콘을 클릭합니다.
...
1. Omni Search 상자에 검색 키워드를 입력하고 다음을 선택합니다. `Enter`. GlobalNav 아이콘을 탭/클릭하여 필터 패널을 표시하고 검색 패널에서 검색 필터를 적용합니다.
...
1. 탭/클릭 **[!UICONTROL 덮어쓰기]** 원본 스마트 컬렉션을 편집된 컬렉션으로 바꿉니다. 또는 을 선택합니다. **[!UICONTROL 다른 이름으로 저장]** 편집한 컬렉션을 별도로 저장합니다.
1. 확인 대화 상자에서 을 탭/클릭합니다 **[!UICONTROL 저장]** 을 클릭하여 프로세스를 완료합니다.

## 컬렉션 메타데이터 보기 및 편집 {#view-and-edit-collection-metadata}

컬렉션 메타데이터는 추가된 태그를 포함하여 컬렉션에 대한 데이터로 구성됩니다.

1. 컬렉션 콘솔에서 컬렉션을 선택하고 다음을 탭/클릭합니다. **[!UICONTROL 속성]** 아이콘을 클릭합니다.
1. In the **[!UICONTROL Collection Metadata]** page, view the collection metadata from the **[!UICONTROL Basic]** and **Advanced** tabs.
1. 필요에 따라 메타데이터를 수정한 다음 탭/클릭합니다 **[!UICONTROL 저장 및 닫기]** 을 클릭하여 변경 내용을 저장합니다.
...
1. 도구 모음에서 를 탭/클릭합니다. **[!UICONTROL 속성]** 아이콘.
...
1. 탭/클릭 **[!UICONTROL 저장 및 닫기]** 을 클릭하고 확인 대화 상자를 닫아 프로세스를 완료합니다.
...
1. 탭/클릭 **[!UICONTROL 저장]** 변경 내용을 저장합니다.

## 컬렉션 삭제 {#delete-a-collection}

1. 컬렉션 콘솔에서 컬렉션을 한 개 이상 선택하고 도구 모음에서 삭제 아이콘을 탭하거나 클릭합니다.
1. 대화 상자에서 을 탭/클릭합니다 **[!UICONTROL 삭제]** 삭제 작업을 확인합니다.
...
1. 다음에서 **[!UICONTROL 다운로드]** 대화 상자, 탭/클릭 **[!UICONTROL 다운로드]**. 컬렉션 내의 에셋 렌디션을 다운로드하려면 다음을 선택합니다 **[!UICONTROL 표현물]**. <!-- Select the **[!UICONTROL Email]** option to send an email notification to the owner of the collection. -->
...
1. 도구 모음에서 를 탭/클릭합니다 **[!UICONTROL 속성]** 을(를) 열려면 [!UICONTROL 속성] 선택한 컬렉션에 대한 페이지입니다.
...
1. 컬렉션 콘솔에서 원하는 컬렉션이나 컬렉션 그룹을 선택한 다음 탭하거나 클릭합니다 **[!UICONTROL 대상 컬렉션]** 을 클릭합니다.
...
1. 탭/클릭 **[!UICONTROL 추가]**. 컬렉션이 의 대상 컬렉션에 추가되었음을 확인하는 메시지가 표시됩니다. **[!UICONTROL 대상 선택]** 페이지를 가리키도록 업데이트하는 중입니다. 메시지를 닫아 프로세스를 완료합니다.
...
1. Assets 사용자 인터페이스에서 도구 모음에서 검색 아이콘 을 탭/클릭합니다.
...
1. 타임라인에서 하단의 캐럿 아이콘을 선택하거나 탭한 다음 탭하거나 클릭합니다 **[!UICONTROL 워크플로우 시작]**.
...
1. 대화 상자에서 을 탭/클릭합니다 **[!UICONTROL 진행]**. 워크플로우는 컬렉션의 모든 에셋에서 실행됩니다.
