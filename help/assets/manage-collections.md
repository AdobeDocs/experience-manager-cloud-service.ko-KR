---
title: 디지털 자산 컬렉션 관리
description: Adobe Experience Manager Assets의 컬렉션 개념을 이해하십시오. 다른 사용자와 컬렉션, 관리, 편집 및 컬렉션 제작 방법을 알아봅니다.
contentOwner: AG
mini-toc-levels: 1
...
1. 컬렉션에 **[!UICONTROL 추가 페이지에서]** 도구 모음에서 컬렉션 **[!UICONTROL 만들기]** 아이콘을 탭/클릭합니다. 기존 컬렉션에 자산을 추가하려면 페이지에서 자산을 선택하고 추가를 탭/ **[!UICONTROL 클릭합니다]**. 기본적으로 가장 최근에 업데이트된 컬렉션이 선택됩니다.
