---
title: 자산 컬렉션 관리
description: AEM Assets의 컬렉션 개념을 이해하십시오. 다른 사용자와 컬렉션, 관리, 편집 및 컬렉션 제작 방법을 알아봅니다.
contentOwner: AG
mini-toc-levels: 1
...
## 컬렉션 콘솔 탐색 {#navigate-the-collections-console}
...
정적 참조를 [사용하거나](#create-a-collection-with-static-references) 검색 조건 기반 필터를 [](#create-a-smart-collection)기반으로 컬렉션을 만들 수 있습니다. Lightbox에서 컬렉션을 만들 수도 있습니다.
...
1. 만들기를 탭/ **[!UICONTROL 클릭한]**&#x200B;다음 확인을 탭/ **[!UICONTROL 클릭하여]** 대화 상자를 닫습니다. 지정된 제목과 속성이 있는 컬렉션이 컬렉션 콘솔에서 열립니다.
   ...
   자산을 컬렉션에 추가하려면 자산 사용자 인터페이스로 이동합니다. 자세한 내용은 [컬렉션에](#add-assets-to-a-collection)자산 추가를 참조하십시오.
...
1. 자산을 컬렉션에 **[!UICONTROL 놓기 영역으로]** 드래그합니다. 또는 도구 모음에서 컬렉션으로 **[!UICONTROL 이동]** 아이콘을 탭/클릭합니다.
1. 컬렉션에 **[!UICONTROL 추가]** 페이지의 도구 모음에서 컬렉션 **[!UICONTROL 만들기]** 아이콘을 탭/클릭합니다. 기존 컬렉션에 자산을 추가하려면 페이지에서 자산을 선택하고 추가를 탭/ **[!UICONTROL 클릭합니다]**. 기본적으로 가장 최근에 업데이트된 컬렉션이 선택됩니다.
...
1. 자산 UI 파섹  ****
1. 전체 검색 상자에 search 키워드를 입력하고 Enter 키를 누릅니다. GlobalNav 아이콘을 탭/클릭하여 필터 패널을 표시하고 검색 패널에서 검색 필터를 적용합니다.
...
1. 저장을 탭/ **[!UICONTROL 클릭하여]** 스마트 컬렉션을 만든 다음 메시지 상자를 닫고 프로세스를 완료합니다. 새로운 스마트 컬렉션은 저장된 검색 **[!UICONTROL 목록에도]** 추가됩니다.
...
1. 자산 UI 파섹
1. 자산을 선택하고 도구 모음에서 **[!UICONTROL 컬렉션으로]** 이동 아이콘을 탭/클릭합니다. 또는 자산을 컬렉션에 놓기 **[!UICONTROL 영역으로 끌 수]** 있습니다. 드롭 영역이 활성화되고 레이블이 [추가에 놓기]로 변경되면 마우스 **[!UICONTROL 단추를 놓습니다]**.
...
1. 파일 및 **[!UICONTROL 폴더]** 목록에서 파일을 **[!UICONTROL 선택합니다]**.
1. 필요에 따라 하나 이상의 필터를 수정합니다. 스마트 컬렉션 편집을 탭/ **[!UICONTROL 클릭합니다]**. 스마트 컬렉션의 이름을 편집할 수도 있습니다.
...
컬렉션 내의 검색 기능은 컬렉션 [검색](#search-collections) 및 컬렉션 내 [자산 검색을 모두 지원합니다](#search-within-collections).
...
1. 컬렉션 설정 페이지에서 컬렉션 설정을 **[!UICONTROL 수정합니다]** . 예를 들어 컬렉션 추가에서 설명한 대로 컬렉션 제목, 설명, 멤버 및 권한을 [수정합니다](#create-a-collection).
...
AEM(Adobe Enterprise Manager) 자산을 사용하면 여러 컬렉션의 메타데이터를 일괄 편집할 수 있습니다. 속성 [!UICONTROL 페이지를 사용하여] 여러 컬렉션에서 메타데이터 변경 작업을 수행할 수 있습니다. 예를 들어 메타데이터 속성을 일반 값으로 변경하거나 태그를 추가하거나 수정할 수 있습니다.

메타데이터 속성 추가, [!UICONTROL 수정] , 삭제 등 메타데이터 속성 페이지를 사용자 정의하려면 스키마 편집기를 사용합니다.

>[!NOTE]
>
>벌크 편집 메서드는 컬렉션에서 사용할 수 있는 자산에 대해 작동합니다. 여러 폴더에서 사용할 수 있거나 일반적인 기준과 일치하는 자산의 경우 검색 [후 메타데이터를](/help/assets/search-assets.md#metadataupdates)일괄 업데이트할 수 있습니다.

1. 컬렉션 콘솔에서 편집할 컬렉션을 선택합니다.
1. 도구 모음에서 속성을 탭/클릭하여 **[!UICONTROL 선택한]** 컬렉션에 [!UICONTROL 대한] 속성 페이지를 엽니다.
...
스마트 컬렉션을 만들 때 저장된 검색이 만들어집니다. 스마트 컬렉션은 저장된 검색 **[!UICONTROL 목록에 자동으로]** 추가됩니다. 컬렉션에 대한 저장된 검색 쿼리는 CRX의 상대 위치에 `dam:query` 있는 속성에 저장됩니다 `/content/dam/collections/`.

>[!NOTE]
>
>정적 컬렉션을 공유하는 것과 같은 방법으로 스마트 컬렉션을 공유할 수 있습니다.

저장된 검색 편집은 스마트 컬렉션 편집과 동일합니다. 자세한 내용은 스마트 [컬렉션](#edit-a-smart-collection)편집을 참조하십시오.

저장된 검색을 삭제하려면 다음 단계를 따르십시오.

1. 자산 사용자 인터페이스로 이동하고 도구 모음에서 **[!UICONTROL 검색을]** 탭/클릭합니다.
1. Omnisearch 상자에 커서를 놓고 Return 키를 누릅니다.
1. GlobalNav 아이콘을 클릭하거나 탭하여 필터 패널을 표시합니다.
1. 저장한 **[!UICONTROL 검색]** 목록에서 삭제할 **[!UICONTROL 스마트]** 컬렉션 옆에 있는 삭제를 탭/클릭합니다.
...
1. GlobalNav 아이콘을 탭/클릭하고 **목록에서 타임라인을** 선택합니다.
1. 타임라인에서 하단의 삽입 기호 아이콘을 클릭하거나 탭한 다음 워크플로우 시작을 탭/ **클릭합니다**.
1. 워크플로우 **시작** 섹션의 목록에서 워크플로우 모델을 선택합니다. 예를 들어 DAM 자산 **업데이트 모델을** 선택합니다.
1. 워크플로우의 제목을 입력하고 시작을 탭/ **클릭합니다**.
1. 대화 상자에서 진행을 탭/ **클릭합니다**. 워크플로우는 컬렉션의 모든 자산에서 실행됩니다.
