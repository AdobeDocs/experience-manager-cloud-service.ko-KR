...
업로드된 에셋에 특정 자르기([스마트 자르기](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/dynamicmedia/image-profiles.html?lang=en) 및 픽셀 자르기) 및 선명하게 하기 구성을 적용할 수 있는 **[!UICONTROL Dynamic Media 스마트 자르기]**&#x200B;에 대해 자세히 알아보십시오.
