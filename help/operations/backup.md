...
두 경우 모두 사용자 지정 코드 및 AEM 버전은 변경되지 않습니다.
...
* 환경의 사용자 지정 코드와 복원이 동일한 저장소 및 동일한 분기에 있습니다.
* 환경의 사용자 지정 코드와 복원이 동일한 저장소에 있지만 공통 커밋이 있는 다른 분기에 있습니다.
* 환경의 사용자 지정 코드와 복원이 다른 저장소에 있습니다.
