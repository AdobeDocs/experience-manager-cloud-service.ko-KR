...
* [AEM as a Cloud Service SDK](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/developing/aem-as-a-cloud-service-sdk.html?lang=ko)을(를) 다운로드하여 로컬 개발 환경을 설정하는 방법에 대해 알아봅니다.
...
* [Repository Modernizer](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/moving/refactoring-tools/repo-modernizer.html?lang=ko), AEM 다중 모드 프로젝트를 입력으로 취하여 AEM as a Cloud Service 프로젝트로 변환하는 도구
