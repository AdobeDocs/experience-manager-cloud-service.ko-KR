...
1. **도구 > 작업 > 웹 콘솔**&#x200B;로 이동하거나 *https://serveraddress:serverport/system/console/configMgr*&#x200B;의 URL로 직접 이동하여 소스 인스턴스의 Adobe Experience Manager 웹 콘솔로 이동합니다.
...
1. **마이그레이션 세트 만들기**&#x200B;를 클릭하여 마이그레이션 세트를 만듭니다.
   ...
   >[!NOTE]
   >
   >이름은 AEM 노드의 동일한 규칙을 따라야 하므로 `. / : [ ] | * < > ^ ? { } % # ` 문자와 특이한 기호 또는 이모지를 포함할 수 없습니다.
