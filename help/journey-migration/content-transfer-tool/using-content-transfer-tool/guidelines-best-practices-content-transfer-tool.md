...
* 잠재적인 문제를 식별하고 저장소의 크기를 줄일 수 있도록 [원본](https://experienceleague.adobe.com/docs/experience-manager-65/deploying/deploying/revision-cleanup.html) 저장소에서 [수정 정리](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-16550.html) 및 **데이터 저장소 일관성 검사**&#x200B;를 실행하십시오.
