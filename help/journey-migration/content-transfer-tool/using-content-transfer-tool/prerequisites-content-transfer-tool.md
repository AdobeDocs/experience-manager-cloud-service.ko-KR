...
| 세그먼트 저장소 크기 | 현재 *Author*&#x200B;에 최대 500GB(온라인 압축 크기)의 JCR 노드가 7억5000만 개 미만이고 *Publish*&#x200B;에 50GB인 기존 리포지토리가 지원됩니다. Adobe 고객 지원 센터에서 지원 티켓을 생성하면 이러한 제한을 초과하는 세그먼트 스토어 크기에 대한 옵션에 대해 논의할 수 있습니다. |
