...
작동 중인 AEM Commerce as a Cloud Service 환경을 만들 수 있도록 [로컬 설정](/help/commerce-cloud/cif-storefront/develop.md#local-setup) 단계를 따르십시오.

### 프로젝트 설정

새 AEM(CIF) 프로젝트를 만들 수 있도록 [AEM Commerce Project Archetype](/help/commerce-cloud/cif-storefront/develop.md#project) 단계를 따르십시오.
