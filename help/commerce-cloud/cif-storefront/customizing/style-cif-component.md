...
1. 다음으로 프로젝트에서 생성된 다른 클라이언트 라이브러리를 검사합니다.
   ...
   **clientlib-base** - [AEM 핵심 구성 요소의 필수 종속성을 임베드하는 빈 클라이언트 라이브러리입니다.](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/introduction.html) 범주는 `venia.base`입니다.
