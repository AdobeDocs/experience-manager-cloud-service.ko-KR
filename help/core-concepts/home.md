...
# 클라우드 서비스로서의 Experience Manager 핵심 개념{#aem-core-concepts-guide}

이 페이지에는 클라우드 서비스로서의 Experience Manager 핵심 개념을 소개하는 자습 리소스들이 나열됩니다.

## 주요 핵심 개념 문서 {#key-articles}

* [클라우드 서비스로서의 AEM 아키텍처](architecture.md)
