---
title: 클라우드 서비스로서의 Adobe Experience Manager의 핵심 개념
description: Adobe Experience Manager as a Cloud Service 핵심 개념 자체 도움말 리소스 및 설명서 링크
...
# 클라우드 서비스로서의 Experience Manager의 핵심 개념 {#aem-core-concepts-guide}

이 페이지에서는 Experience Manager의 핵심 개념을 Cloud Service로 소개하는 자가 도움말 리소스를 제공합니다.
