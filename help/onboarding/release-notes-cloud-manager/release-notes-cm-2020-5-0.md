---
title: Cloud Service 릴리스로 AEM의 Cloud Manager 릴리스 노트 2020.5.0
description: Cloud Service 릴리스로 AEM의 Cloud Manager 릴리스 노트 2020.5.0
...
# Adobe Experience Manager에서 Cloud Service 2020.5.0 {#release-notes}으로 Cloud Manager에 대한 릴리스 노트

이 페이지에서는 AEM의 Cloud Manager 릴리스 노트를 Cloud Service 2020.5.0으로 간략하게 설명합니다.

## 릴리스 날짜 {#release-date}

AEM의 Cloud Service 2020.5.0 Cloud Manager에 대한 릴리스 날짜는 2020년 5월 7일입니다.
