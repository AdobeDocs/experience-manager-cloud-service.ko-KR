---
title: Cloud Service 릴리스 2020.3.0으로서 AEM의 Cloud Manager에 대한 릴리스 노트
description: Cloud Service 릴리스 2020.3.0으로서 AEM의 Cloud Manager에 대한 릴리스 노트
...
# Cloud Service 2020.3.0인 Adobe Experience Manager의 클라우드 관리자에 대한 릴리스 노트 {#release-notes}

이 페이지에서는 AEM의 Cloud Manager 릴리스 노트를 Cloud Service 2020.3.0으로 간략하게 설명합니다.

## 릴리스 날짜 {#release-date}

2020.3.0 Cloud Service으로 AEM에서 Cloud Manager의 릴리스 날짜는 2020년 3월 5일입니다.
