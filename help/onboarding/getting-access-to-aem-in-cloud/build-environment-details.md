...
* maven은 `adobe-public` 프로파일을 사용하여 공개 Adobe **Artifact** 저장소를 자동으로 포함하는 settings.xml 파일을 사용하여 시스템 수준에서 구성됩니다. (자세한 내용은 [Adobe Public Maven 리포지토리](https://repo.adobe.com/)을 참조하십시오.)
