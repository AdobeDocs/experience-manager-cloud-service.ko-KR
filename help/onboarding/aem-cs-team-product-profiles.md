...
>[!NOTE]
>
> 이 문서에서 설명하는 일부 제품 인스턴스와 제품 프로필은 새로 생성된 환경에서만 나타날 수 있습니다. [기존 환경의 제품 프로필 추가 섹션](#adding-product-profiles-for-existing-environments)을 참조하여 환경을 현대화하는 방법을 알아보십시오.
...
2024년 4월 초 이전에 생성된 환경에서 위 섹션에 설명된 조직 수준 제품 인스턴스와 특정 제품 프로필이 누락되어 있을 수 있습니다. 기존 제품 프로필에도 서비스 토글이 없습니다. 일부 향후 API에 액세스하기 위한 필수 구성 요소인 해당 제품 프로필을 업데이트하는 것이 좋습니다.
