...
# 클라우드 서비스로서의 Experience Manager에 온보딩{#aem-onboarding-guide}

이 페이지에는 클라우드 서비스로서의 Experience Manager에 대한 온보딩용 자습 리소스들이 나열됩니다.

## 주요 온보딩 문서 {#key-articles}

이 섹션에서는 다음 사항에 초점을 둔 주요 문서를 다룹니다.

* 클라우드 서비스로서의 Experience Manager 액세스를 위한 요구 사항
* 특정 기능의 가용성을 제어하는 사용자 역할 이해
* Cloud Manager git 저장소 설정
* 클라우드 서비스로서의 Experience Manager 액세스
* 데이터 보호 및 개인 정보 보호 규정의 기초 사항
