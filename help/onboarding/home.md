...
>additional-url="https://www.adobe.com/content/dam/cc/en/legal/terms/enterprise/pdfs/SLAExhibit-AEMCloudService-2019DEC12.pdf" text="서비스 수준 전시회 - Cloud Service으로 AEM"
...
1. Adobe은 조직의 시스템 관리자가 환영 이메일을 받아 사용자를 추가, 역할에 할당 및 Cloud Manager에 대한 적절한 액세스 권한을 제공하는 [시스템 관리자 작업](/help/onboarding/what-is-required/add-users-assign-cm-roles.md)을 수행할 수 있는 시작 이메일을 수신하게 됩니다.
...
**[클라우드 관리자 역할](/help/onboarding/what-is-required/user-roles-permissions.md)**
