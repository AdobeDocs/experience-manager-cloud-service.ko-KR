...
1. Adobe은 조직의 시스템 관리자가 환영 이메일을 받아 사용자를 추가하고, 사용자를 역할에 할당하고, Cloud Manager에 적절한 액세스 권한을 부여하는 등 [시스템 관리자 작업](/help/onboarding/what-is-required/add-users-assign-cm-roles.md)을 수행할 수 있는 환영 이메일을 수신하게 됩니다.
