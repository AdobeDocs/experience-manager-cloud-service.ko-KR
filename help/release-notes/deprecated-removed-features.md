...
가끔 도입된 더 이상 사용되지 않거나 제거된 Java API에 대해서는 [이 페이지](/help/release-notes/deprecated-apis.md)를 참조하십시오.

## OSGI 구성 {#osgi-configuration}

OSGI 속성 구성에 대한 제한 사항에 대해서는 [이 문서](/help/implementing/deploying/osgi-configuration-api.md)를 참조하십시오. 이 속성 중 일부는 시간이 지남에 따라 도입될 수 있습니다.