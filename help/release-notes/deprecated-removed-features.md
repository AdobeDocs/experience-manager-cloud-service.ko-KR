...
| [!DNL Assets] | Marketing Cloud Assets 핵심 서비스 및 Creative Cloud 서비스와 공유 중인 [!DNL Assets]를 사용할 수 없습니다. | [!DNL Adobe Creative Cloud]와의 통합은 [Adobe Asset Link](https://helpx.adobe.com/enterprise/using/adobe-asset-link.html)를 사용하십시오. | 제거됨 |
| [!DNL Foundation] | Apache Sling 데이터 소스(OSGi 번들 org.apache.sling.datasource) 지원 | 해당 없음 | 제거됨 |
| [!DNL Foundation] | JST 스크립팅 템플릿(OSGi 번들 org.apache.sling.scripting.jst) 지원 | 해당 없음 | 제거됨 |
| [!DNL Foundation] | Apache Felix Http 화이트보드 지원 | OSGi Http 화이트보드 | 2022년 3월 |
