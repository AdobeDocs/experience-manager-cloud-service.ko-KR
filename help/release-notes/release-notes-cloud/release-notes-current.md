...
핵심 구성 요소의 릴리스 2.9.0 [은](https://docs.adobe.com/content/help/ko-KR/experience-manager-core-components/using/introduction.html) 이제 다음을 포함한 AEM Sites의 일부로 사용할 수 있습니다.
...
* 이제 SysAdmin 역할의 사용자는 Cloud Manager에 대한 사용자 역할이나 권한을 관리할 수 있는 관리 콘솔의 위치에 대한 클릭 한 번으로 액세스할 수 있습니다. 이제 **액세스** 관리 단추를 [프로그램 **추가] 단추 옆에 있는 랜딩 페이지에서 사용할 수** 있습니다.
