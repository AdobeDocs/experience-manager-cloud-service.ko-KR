...
# [!DNL Adobe Experience Manager] as a Cloud Service 2023.9.0 릴리스 정보 {#release-notes}

다음 섹션에서는 [!DNL Experience Manager] as a Cloud Service의 2023.9.0 버전 기능 릴리스 정보에 대해 간략히 소개합니다.
