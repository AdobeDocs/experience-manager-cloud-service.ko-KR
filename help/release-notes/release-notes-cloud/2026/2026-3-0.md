---
title: ' [!DNL Adobe Experience Manager] as a Cloud Service의 2026.3.0 릴리스 정보입니다.'
description: ' [!DNL Adobe Experience Manager] as a Cloud Service의 2026.3.0 릴리스 정보입니다.'
...
# [!DNL Adobe Experience Manager] as a Cloud Service에 대한 2026.3.0 릴리스 노트 {#release-notes}

다음 섹션에서는 [!DNL Experience Manager] as a Cloud Service의 2026.3.0 버전에 대한 기능 릴리스 노트를 간략하게 설명합니다.
...
[!DNL Cloud Service] 현재 기능 릴리스(2026.3.0)인 [!DNL Adobe Experience Manager]의 릴리스 날짜는 2026년 3월 26일입니다. 다음 기능 릴리스(2026.4.0)는 2026년 4월 30일에 예정되어 있습니다.
