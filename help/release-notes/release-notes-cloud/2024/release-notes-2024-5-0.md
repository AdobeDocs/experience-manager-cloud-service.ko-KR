---
title: ' [!DNL Adobe Experience Manager] as a Cloud Service의 2024.5.0 릴리스 정보입니다.'
description: ' [!DNL Adobe Experience Manager] as a Cloud Service의 2024.5.0 릴리스 정보입니다.'
...
# [!DNL Adobe Experience Manager] as a Cloud Service 2024.5.0 릴리스 정보 {#release-notes}

다음 섹션에서는 [!DNL Experience Manager] as a Cloud Service의 2024.5.0 버전 기능 릴리스 정보에 대해 간략히 소개합니다.
...
이제 콘텐츠 번역 작업 및 워크플로가 이벤트를 트리거하여 외부 애플리케이션에서 관련 프로세스 단계 및 상태를 추적할 수 있습니다. 다음과 같은 이벤트가 생성됩니다. 사용자는 Adobe Developer Console을 사용하여 이벤트를 구독할 수 있습니다.
...
>[!IMPORTANT]
>
> 얼리 액세스 혁신을 위해 얼리 액세스 프로그램에 참여하고 싶다면 공식 주소에서 [aem-forms-ea@adobe.com](mailto:aem-forms-ea@adobe.com)으로 이메일을 보내 액세스 권한을 요청하십시오. 전체 또는 특정 혁신에 대한 액세스를 요청할 수 있습니다.
...
* 프로그래밍 방식으로 호출할 때 유용한 출력을 위한 [json 모드](/help/implementing/developing/introduction/rapid-development-environments.md#global-flags).
