...
* **[!DNL Adobe AI]비디오 스마트 태그 지정 기능 제공**: AI 모델을 적용하여 개체 및 작업별 태그에 대한 비디오 콘텐츠를 분석함으로써 DAM 사용자는 태그를 추가하는 데 드는 시간을 줄이고 노출되고 풍부한 정보를 사용하는 데 더 많은 시간을 할애할 수 있습니다. 결과적으로 고객에게 올바른 경험을 제공합니다. [스마트 태그 비디오 자산](/help/assets/smart-tags-for-videos.md)을 참조하세요.
