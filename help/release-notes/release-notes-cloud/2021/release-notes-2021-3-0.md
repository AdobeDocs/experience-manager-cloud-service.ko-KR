...
[!DNL Adobe Experience Manager] as a 2021.3.0 Cloud Service의 출시일은 2021년 3월 25일입니다.
다음 릴리스(2021.4.0)는 2021년 4월 29일에 있습니다.

## [!DNL Adobe Experience Manager Sites] 로서의 Cloud Service {#sites}

* [이제 간단한 구성을 통해 프로젝트 ](/help/sites-cloud/authoring/features/enable-pwa.md) 수준에서 사이트의 점진적 웹 앱(PWA) 버전을 사용할 수 있습니다.
...
* [!DNL Experience Manager] 지원되는 핵심 구성 요소에서  [!DNL Dynamic Media] 이미지 사용을 지원하도록 연결된 자산 기능을 확장합니다. [연결된 자산 사용](/help/assets/use-assets-across-connected-assets-instances.md)을 참조하십시오.
* Experience Manager 관리자는 특정 날짜 또는 시간에 벌크 자산 입력을 예약할 수 있습니다. 또한 관리자는 날짜 및 시간을 기준으로 반복 지정을 예약할 수 있습니다. [일괄 자산 수집](/help/assets/add-assets.md#asset-bulk-ingestor)을 참조하십시오.
...
* 최신 CIF 코어 구성 요소 버전 v1.9.0이 포함된 CIF Venia 참조 사이트 - 2021.03.25이 출시되었습니다. 자세한 내용은 [CIF Venia 참조 사이트](https://github.com/adobe/aem-cif-guides-venia/releases/tag/venia-2021.03.25)를 참조하십시오.

* CIF 코어 구성 요소 v1.9.0이 출시되었습니다. 자세한 내용은 [CIF 코어 구성 요소](https://github.com/adobe/aem-core-cif-components/releases/tag/core-cif-components-reactor-1.9.0)를 참조하십시오.


## Cloud Manager {#cloud-manager}

이 섹션에서는 AEM as a Cloud Service 2021.3.0에 있는 Cloud Manager 릴리스 노트를 간략하게 설명합니다.
...
* **이제** 파이프라인 실행 및  *Activityscreens 모두에 대해 AEM 푸시* 업데이트 레이블이  ** 표시됩니다.
...
### 컨텐츠 전송 도구 {#what-is-new-ctt-march}의 새로운 기능

* 이제 CTT가 `/libs` 대신 `/apps`에 설치됩니다. 특정 페이지에 대한 브라우저 책갈피가 더 이상 유효하지 않을 수 있습니다.
* CTT가 설치되면 추가 수준을 탐색하여 컨텐츠 전송 페이지로 이동해야 합니다. 자세한 내용은 [컨텐츠 전송 도구 사용](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/moving/cloud-migration/content-transfer-tool/using-content-transfer-tool.html)을 참조하십시오.
...
* Repository Modernizer의 새로운 기능 및 개선 사항입니다. [GitHub 리소스 를 참조하십시오.Repository Modernizer](https://github.com/adobe/aem-cloud-service-source-migration/tree/master/packages/repository-modernizer) 를 참조하십시오.
   * OSGi 구성을 기본 설정 .cfg.json 형식으로 정규화합니다(RepoInit 구성 제외).
   * OSGi 구성 폴더의 이름을 지정된 형식으로 변경합니다.
   * ui.apps.structure 프로젝트를 생성합니다.
   * 분석 모듈을 만듭니다.

* Dispatcher Converter의 새로운 기능 및 개선 사항입니다. [GitHub 리소스 를 참조하십시오.Dispatcher 변환기](https://github.com/adobe/aem-cloud-service-source-migration/tree/master/packages/dispatcher-converter)
