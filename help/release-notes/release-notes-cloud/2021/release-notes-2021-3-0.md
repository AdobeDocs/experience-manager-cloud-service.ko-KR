...
[!DNL Adobe Experience Manager] as a Cloud Service 2021.3.0의 릴리스 날짜는 2021년 3월 25일입니다.
다음 릴리스(2021.4.0) 날짜는 2021년 4월 29일입니다.

## [!DNL Adobe Experience Manager Sites] as a Cloud Service {#sites}

* [사이트의 점진적 웹 앱(PWA) 버전](/help/sites-cloud/authoring/sites-console/enable-pwa.md)을 간단한 구성을 통해 프로젝트 수준에서 사용할 수 있습니다.
...
* [!DNL Experience Manager]은(는) 연결된 Assets 기능을 확장하여 지원되는 핵심 구성 요소에서 [!DNL Dynamic Media] 이미지 사용을 지원합니다. [연결된 Assets 사용](/help/assets/use-assets-across-connected-assets-instances.md)을 참조하세요.
* Experience Manager 관리자는 특정 날짜 또는 시간에 일괄 에셋 수집을 예약할 수 있습니다. 또한 관리자는 날짜와 시간에 따라 반복 수집을 예약할 수 있습니다. [일괄 에셋 수집](/help/assets/add-assets.md#asset-bulk-ingestor)을 참조하십시오.
...
* InDesign 템플릿의 마지막 페이지만 PDF 렌디션에 있습니다. (CQ-4317305)
...
* 공백이나 특수 문자가 포함된 파일 이름이 있는 Assets은 브라우저를 사용하여 업로드됩니다. (CQ-4318381)
...
* 최신 CIF 핵심 구성 요소 버전 v1.9.0이 포함된 CIF Venia 참조 사이트 - 2021.03.25가 릴리스되었습니다. 자세한 내용은 [CIF Venia 참조 사이트](https://github.com/adobe/aem-cif-guides-venia/releases/tag/venia-2021.03.25)를 참조하십시오.

* CIF 코어 구성 요소 v1.9.0이 릴리스되었습니다. 자세한 내용은 [CIF 핵심 구성 요소](https://github.com/adobe/aem-core-cif-components/releases/tag/core-cif-components-reactor-1.9.0)를 참조하십시오.


## Cloud Manager {#cloud-manager}

이 섹션에서는 AEM as a Cloud Service 2021.3.0의 Cloud Manager 릴리스 정보에 대해 간략히 설명합니다.
...
* [IP 허용 목록](/help/implementing/cloud-manager/ip-allow-lists/managing-ip-allow-lists.md#pre-existing-cdn), [SSL 인증서](/help/implementing/cloud-manager/managing-ssl-certifications/managing-certificates.md#pre-existing-cdn) 및 [사용자 지정 도메인 이름](/help/implementing/cloud-manager/custom-domain-names/check-domain-name-status.md#pre-existing-cdn)에 대한 기존 사용자 지정 도메인 이름 구성이 있는 환경의 고객은 이전의 기존 구성에 대한 메시지를 보고 사용자 인터페이스를 통해 셀프 서비스를 수행할 수 있습니다.
...
* 이제 CTT가 `/apps` 대신 `/libs`에 설치되어 특정 페이지에 대한 브라우저 책갈피가 더 이상 유효하지 않을 수 있습니다.
...
* Repository Modernizer의 새로운 기능 및 향상된 기능. 최신 버전은 [GitHub 리소스: Repository Modernizer](https://github.com/adobe/aem-cloud-service-source-migration/tree/master/packages/repository-modernizer)를 참조하십시오.
   * OSGi 구성(RepoInit 구성 제외)을 기본 .cfg.json 형식으로 정규화합니다.
   * OSGi 구성 폴더의 이름을 지정된 형식으로 변경합니다.
   * ui.apps.structure 프로젝트를 생성합니다.
   * 분석 모듈을 만듭니다.

* Dispatcher Converter의 새로운 기능 및 향상된 기능 [GitHub 리소스: Dispatcher 변환기](https://github.com/adobe/aem-cloud-service-source-migration/tree/master/packages/dispatcher-converter)를 참조하십시오.
