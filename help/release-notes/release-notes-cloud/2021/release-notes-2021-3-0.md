...
as a Cloud Service [!DNL Adobe Experience Manager] 2021.3.0의 릴리스 날짜는 2021년 3월 25일입니다.
다음 릴리스(2021.4.0) 날짜는 2021년 4월 29일입니다.

## as a Cloud Service [!DNL Adobe Experience Manager Sites] {#sites}

* [사이트의 점진적 웹 앱(PWA) 버전](/help/sites-cloud/authoring/sites-console/enable-pwa.md)을 이제 간단한 구성을 통해 프로젝트 수준에서 사용할 수 있습니다.
