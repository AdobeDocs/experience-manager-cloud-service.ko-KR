...
* **® Azure 데이터 저장소 커넥터**: 이제 [양식 데이터 모델을 Microsoft® Azure 저장소에 연결](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/integrate/use-form-data-model/configure-azure-storage.html)할 수 있습니다. 적응형 양식 데이터를 검색하여 ® Azure Storage에 BLOB로 저장할 수 있습니다.
