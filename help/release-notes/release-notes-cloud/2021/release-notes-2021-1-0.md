...
description: '[!DNL Adobe Experience Manager] as a 2021.1.0 Cloud Service 릴리스 노트'
...
[!DNL Adobe Experience Manager] Cloud Service이 2021.1.0인 릴리스 날짜는 2021년 2월 3일입니다.
...
* [!DNL Experience Manager] as a  [!DNL Cloud Service] 는 텍스트 기반 자산에서 키워드 및 엔티티 식별을 지원하도록 스마트 태그 기능을 확장합니다. 텍스트는 식별, 색인 지정 및 메타데이터로 사용할 수 있으므로 구성이 필요 없습니다. [스마트 태그](/help/assets/smart-tags.md)를 참조하십시오.
...
* 최신 CIF 코어 구성 요소 버전 v1.7.0이 포함된 CIF Venia 참조 사이트 - 2021.02.02이 출시되었습니다. 자세한 내용은 [CIF Venia 참조 사이트](https://github.com/adobe/aem-cif-guides-venia/releases/tag/venia-2021.02.02)를 참조하십시오.

* CIF 코어 구성 요소 v1.7.0이 출시되었습니다. 자세한 내용은 [CIF 코어 구성 요소](https://github.com/adobe/aem-core-cif-components/releases/tag/core-cif-components-reactor-1.7.0)를 참조하십시오.
...
* 서버 간 인증 API 호출 - 적절한 액세스 토큰을 생성하여 외부 애플리케이션과 AEM 간에 인증된 서버 간 API 호출을 Cloud Service 환경으로 생성합니다. 자세한 내용은 [설명서](/help/implementing/developing/introduction/generating-access-tokens-for-server-side-apis.md)를 읽어보거나 [자습서](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/authentication/overview.html?lang=en#authentication)를 참조하여 알아보십시오.
...
* 컨텐츠 전송 도구 - 사용자 매핑 도구에 추가된 새로운 기능 및 UI입니다. 이 기능은 기존 사용자 및 그룹을 컨텐츠 마이그레이션 활동의 일부로 Adobe Identity Management 시스템 ID에 자동으로 매핑합니다. 자세한 내용은 [사용자 매핑 도구 사용](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/moving/cloud-migration/content-transfer-tool/using-user-mapping-tool.html)을 참조하십시오.
