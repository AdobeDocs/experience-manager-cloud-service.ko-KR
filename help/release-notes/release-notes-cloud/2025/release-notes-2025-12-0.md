---
title: ' [!DNL Adobe Experience Manager] as a Cloud Service의 2025.12.0 릴리스 정보입니다.'
description: ' [!DNL Adobe Experience Manager] as a Cloud Service의 2025.12.0 릴리스 정보입니다.'
...
# [!DNL Adobe Experience Manager] as a Cloud Service 2025.12.0 릴리스 정보 {#release-notes}

다음 섹션에서는 [!DNL Experience Manager] as a Cloud Service의 2025.12.0 버전 기능 릴리스 정보에 대해 간략히 소개합니다.
...
AEM Assets에서 AI가 생성한 메타데이터를 활성화하기 위해 더 이상 GenAI 라이더에 서명이 필요하지 않습니다. 이제 GenAI 라이더에 서명한 고객과 아직 유효성을 검사하지 않은 고객 모두 이 기능을 사용할 수 있습니다. GenAI 사용을 명시적으로 옵트아웃한 고객은 기능이 계속 비활성화됩니다. 환경 수준에서 기능 활성화를 관리하려면 [AI 생성 메타데이터 비활성화](/help/assets/enhance-content-discovery-with-ai-generated-metadata.md#disable-ai-generated-metadata)를 참조하십시오. 이 변경 사항은 릴리스 버전 23482 이상의 고객을 위해 적용됩니다.
