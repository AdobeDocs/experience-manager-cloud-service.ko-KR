---
title: ' [!DNL Adobe Experience Manager] as a Cloud Service의 2025.7.0 릴리스 정보입니다.'
...
# [!DNL Adobe Experience Manager] as a Cloud Service 2025.7.0 릴리스 정보 {#release-notes}

다음 섹션에서는 [!DNL Experience Manager] as a Cloud Service의 2025.7.0 버전 기능 릴리스 정보에 대해 간략히 소개합니다.
...
AEM은 노드 보기 권한 관리 기능을 도입합니다. 주요 기능은 기존 UI와 동일하지만 사용자 친화성과 효율성이 향상되었습니다. 자세한 내용은 [전용 문서](/help/security/touch-ui-principal-view.md)를 참조하십시오.
