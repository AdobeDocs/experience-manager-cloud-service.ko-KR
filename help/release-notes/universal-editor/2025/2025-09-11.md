...
* [복사 및 붙여넣기](/help/sites-cloud/authoring/universal-editor/authoring.md#copy-paste)를 이제 컨테이너 내 구성 요소에도 사용할 수 있습니다.
   * 복사 및 붙여넣기는 동일한 브라우저 탭에서 실행되어야 합니다.
   * 타깃 컨테이너에는 [필터를 설정](/help/implementing/universal-editor/filtering.md)할 수 없습니다.
