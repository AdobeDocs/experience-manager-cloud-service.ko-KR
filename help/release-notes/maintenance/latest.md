...
다음은 2026년 2월 4일에 공개적으로 릴리스된 유지 보수 릴리스 24288에 대한 지속적인 개선 사항을 요약합니다. 이전 유지 관리 릴리스는 릴리스 23963.
...
>[!NOTE]
>
>릴리스 24222이 비공개로 설정되었습니다.

### 개선 사항 {#enhancements-24288}
...
* SITES-40122: 컨텐츠 배포 ImsService와의 Edge Delivery 통합 수정.
...
### 알려진 문제 {#known-issues-24288}

* SITES-40408: 사용자 지정 Dispatcher 다시 작성 규칙으로 인해 GraphQL 종단점이 404를 반환합니다.

### 사용 중단된 기능 및 API {#deprecated-24288}
