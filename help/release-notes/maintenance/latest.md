...
- SITES-13253 - 코어 구성 요소 v2.22.6에서 RecursionTooDeepException이 발생하는 문제가 해결되었습니다.
- SITES-13256 - 특수 URL로 구성된 코어 WCM Teaser가 페이지 렌더링을 차단하는 문제를 해결했습니다
- GRANITE-45462 - 메시징 클라이언트 다중 영역 구성의 문제가 해결되었습니다
- GRANITE-45562 - 404 대신 200을 반환하는 이미지 조합 문제가 해결되었습니다.
