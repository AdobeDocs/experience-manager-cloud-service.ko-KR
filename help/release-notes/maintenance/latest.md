...
2026년 1월 19일에 공개적으로 릴리스된 유지 보수 릴리스 23963에 대한 지속적인 개선 사항을 요약하면 다음과 같습니다. 이전 유지 관리 릴리스는 릴리스 23482.
...
>[!NOTE]
>
>릴리스 23862이 비공개로 설정되었습니다.

### 개선 사항 {#enhancements-23963}
...
* FORMS-23557: Rhino 업데이트로 인해 Use API에서 `*.js`을(를) 올바르게 인스턴스화할 수 없습니다.
