...
* SITES-28051: 현재 사용자의 콘텐츠 조각에 대한 권한을 가져옵니다. GET /cf/fragments/{fragmentId}/permissions.
...
* SITES-29602: CIF: core-cif-components-core의 Guava 사용 제거.
* SITES-25785: CIF: CIF 제품 참조 데이터 유형에 대한 제품 변형 선택 사항을 추가합니다.
* SITES-26392: CIF[Experimental]: JSON+LD(PDP의 CIF 핵심 구성 요소)
* SITES-21278: CIF[실험]: 캐시를 지우는 CIF 기능.
...
* SITES-24631: CIF: 제품 필드의 검색 문제
* SITES-24902: CIF: 제품 URL 형식이 #variant_sku에서 예상대로 작동하지 않습니다.
* SITES-29191: CIF: 제품 목록 구성 요소에 20개 이상의 SKU를 추가할 수 없습니다.
