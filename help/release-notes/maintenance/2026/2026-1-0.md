---
title: 2026.1.0 기능 활성화와 관련된 [!DNL Adobe Experience Manager] as a Cloud Service의 유지 관리 릴리스 정보입니다.
description: 2026.1.0 기능 활성화와 관련된 [!DNL Adobe Experience Manager] as a Cloud Service의 유지 관리 릴리스 정보입니다.
...
다음 섹션에서는 2026.1.0 기능 활성화와 관련된 Experience Manager as a Cloud Service 유지 관리 릴리스의 기술 릴리스 정보에 대해 간략히 소개합니다.

## 릴리스 23963 {#23963}

다음은 2026년 1월 8일에 공개적으로 릴리스된 유지 보수 릴리스 23963에 대한 지속적인 개선 사항을 요약합니다. 이전 유지 관리 릴리스는 릴리스 23482.

2026.1.0 기능 활성화는 이 유지 관리 릴리스에 대한 전체 기능 세트를 제공합니다. 자세한 내용은 [Experience Manager 릴리스 로드맵](https://experienceleague.adobe.com/ko/docs/experience-manager-release-information/aem-release-updates/update-releases-roadmap)을 참조하십시오.
...
* SITES-8113: &#39;Assets&#39; 문자열은 도구 메뉴의 &#39;템플릿&#39;에 대한 &#39;이미지 선택&#39; 대화 상자에서 현지화되지 않습니다.
