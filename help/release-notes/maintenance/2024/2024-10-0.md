...
* ASSETS-41896 : 폴더의 cq:discarded 속성에 언급된 Assets은 Brand Portal에 게시하면 안 됩니다.
...
* CNTBF-298: CC 내보낸 패키지에서 jcr:uuid을(를) 제거합니다.
...
* GUIDES-17793: 게시된 콘텐츠의 일괄 활성화 중에 **일괄 게시 대시보드**&#x200B;에서 참조된 PDF이 활성화되지 않습니다.
...
* SITES - 23585: cq:responsive 노드가 있는 구성 요소의 상속을 복원하는 데 문제가 있습니다.
