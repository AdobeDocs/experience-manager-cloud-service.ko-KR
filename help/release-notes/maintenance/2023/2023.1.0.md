...
다음 섹션에서는 2023.1.0 기능 활성화와 연관된 Experience Manager as a Cloud Service의 유지 관리 릴리스에 대한 기술 릴리스 노트를 간략하게 설명합니다.

## 릴리스 11289 {#release-11289}

2023년 3월 7일에 릴리스된 유지 관리 릴리스 11289에 대한 지속적인 개선 사항이 아래에 요약되어 있습니다. 이 유지 관리 릴리스는 이전 유지 관리 릴리스 10912의 업데이트입니다.
