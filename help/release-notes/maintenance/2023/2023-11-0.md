...
* ASSETS-29631: Assets Cloud: 보안 게재/검색에 dam:roles을(를) 사용합니다.
...
* SITES-16853: 콘텐츠 조각: /adobe/sites/cf/fragments/{fragmentId}/variation/{name}/tags 끝점을 제거합니다.
...
* SITES-15373: 콘텐츠 조각: /adobe/sites/cf/fragments/{fragmentId}/variation/{name}/tags 끝점은 올바른 리소스 이름 지정 규칙을 사용하지 않습니다.
...
* SITES-16079: 콘텐츠 조각: /fragments/{id}/references가 중복을 반환하기 시작했습니다.
...
* ASSETS-28634: Adobe stock의 Omnisearch 필드는 자산 데이터를 자동으로 추가하지 않습니다.
* ASSETS-28727: 처리 프로필 구성 목록에 지정된 사용자 지정 높이 및 너비 값이 표시되지 않습니다.
* ASSETS-29056: AEM 표준 처리 프로필에 코드 변환 변환을 추가합니다.
...
* ASSETS-29515: &quot;jcr:lastModifiedBy&quot;: &quot;workflow-process-service&quot;가 있는 Assets/노드가 목록 보기에서 &quot;외부 사용자&quot;로 표시됩니다.
* ASSETS-29579: 관리자가 아닌 사용자가 이미지 집합을 만들 수 없습니다.
* ASSETS-29631: 보안 게재/검색에 dam:roles을(를) 사용합니다.
* ASSETS-29689: dc:roles(및 새 속성 dam:roles)은 AEM 측에서 필터링되어야 합니다.
...
* ASSETS-30167: adobe_dam:restrictions용 HTML이 자산을 업로드한 후 중단됩니다.
