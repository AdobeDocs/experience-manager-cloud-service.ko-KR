...
다음 섹션에서는 2023.4.0 기능 활성화와 연결된 as a Cloud Service Experience Manager의 유지 관리 릴리스에 대한 기술 릴리스 노트를 간략하게 설명합니다.
...
- SITES-13636 - 일부 고객의 경우 이미지의 clientlib 종속성과 캐러셀 사이트 clientlib이 누락되는 문제가 보고되었습니다. 고객이 이미지나 회전식 clienlib을 포함하는 다른 clientlib을 임베드한 경우 종속성이 해결되지 않습니다.
...
- SKYOPS-51970 - buildImage 단계에서 사용된 FACT 버전의 회귀 문제를 식별하여 사용자 매핑이 일치하지 않습니다.
...
- SKYOPS-56928 - Apache HTTPD 회귀로 인해 404 오류가 발생할 수 있습니다. 이러한 문제가 발생하는 경우 안전상의 이유로 이전 버전으로 롤백하여 해당 기간 동안 파이프라인이 실행되지 않도록 하는 것이 좋습니다.
