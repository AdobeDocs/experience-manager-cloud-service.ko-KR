...
- ASSETS-8715: 속성 &quot;jcr:content/metadata/dam:status&quot;에 대해 null 검사/not null 검사를 추가합니다.
...
- SKYOPS-61484: 사용하지 않은 ${sling.home} 토큰이 병합된 OSGi 구성에서 지속되도록 허용하는 RDEProvider 서비스의 문제가 해결되었습니다
- 다양한 보안, 접근성 및 현지화 수정
