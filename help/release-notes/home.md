...
## AEM 릴리스 일정 {#release-schedule}

[!DNL Adobe Experience Manager] as a Cloud Service의 지속적인 릴리스 모델을 사용하면 응용 프로그램이 지속적으로 자동 업데이트됩니다. 업데이트에는 기능 릴리스와 유지 관리 릴리스의 두 가지 유형이 있습니다.

* **기능 릴리스**&#x200B;는 매월 정해진 일정에 따라 진행되며 새로운 기능 및 제품 혁신에 중점을 둡니다.
   * 최신 기능 릴리스에 대한 자세한 내용은 [최신 릴리스 정보](/help/release-notes/release-notes-cloud/release-notes-current.md)를 확인하십시오.
* **유지 관리 릴리스**&#x200B;은(는) 자주 수행되며 보안 업데이트, 버그 수정 및 성능 개선에 초점을 맞춥니다.
   * 이를 통해 [!DNL Adobe Experience Manager] as a Cloud Service는 항상 중요한 수정 사항을 최신 상태로 유지할 수 있습니다.
   * 최신 유지 관리 릴리스에 대한 자세한 내용은 [최신 유지 관리 릴리스 정보](/help/release-notes/maintenance/latest.md)를 확인하십시오.

이 모델은 서비스 중단 없이 지속적인 릴리스를 보장합니다. 예정된 기능은 일반적으로 하나의 릴리스에서 발표되며 다음 릴리스에서 공개적으로 제공됩니다. 이러한 방식으로 예정된 기능을 평가하고 프로젝트에 대해 가능한 구현을 계획할 수 있습니다. 이 옵션을 통해 기능을 사용할 수 있는 다음 기능 릴리스를 미리 계획할 수 있습니다.

예를 들어 지금이 5월이라면 6월과 같은 예정된 릴리스에서 일반적으로 사용할 수 있게 될 예정된 기능을 평가할 수 있습니다.

![예정된 기능 케이던스 그래픽](assets/prerelease-cadence.png)

이 케이던스는 다가오는 기능이 프로젝트 및 사용자 정의에 미치는 영향을 평가하고 이러한 기능, 테스트 및 사용자 교육의 배포를 계획하는 롤링 기간을 제공합니다.

예정된 릴리스에 대한 자세한 내용은 [Experience Manager 릴리스 로드맵](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/update-releases-roadmap.html#aem-as-cloud-service)을 확인하십시오.
...
1. [예정된 기능 액세스 및 사용](#upcoming-features)
...
각 릴리스에는 해당 릴리스의 새로운 기능뿐만 아니라 평가에 사용할 수 있는 향후 기능을 문서화한 릴리스 정보가 함께 제공됩니다. 미리 알아본 정보로 AEMaaCS의 최신 기능을 활용할 계획을 세워 보십시오.
...
## 예정된 기능 액세스 및 사용 {#upcoming-features}
...
예정된 기능을 사용할 수 있는 방법은 [릴리스 노트](#release-notes)에 자세히 설명되어 있습니다.

* 얼리어답터 프로그램의 일부인 경우 일반적으로 릴리스 노트에 자세히 설명된 대로 Adobe에 문의하여 활성화해야 합니다.
* 프리릴리스 채널의 일부인 경우 [개발 또는 샌드박스 환경에서 프리릴리스 채널을 활성화해야 합니다.](/help/release-notes/prerelease.md)

## 사용자 교육 {#train-users}

예정된 기능을 테스트하고 프로젝트에서 사용하기로 결정했다면 사용자를 교육해야 합니다.
