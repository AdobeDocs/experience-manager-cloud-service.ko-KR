...
{#wysiwyg-authoring}
   + 양식 빌드 {#build-forms}
      ...
      + WYSIWYG 작성 {#universal-editor}
         ...
         + [Edge Delivery Services을 사용하여 적응형 Forms 만들기 및 게시](/help/edge/docs/forms/universal-editor/create-forms.md)
         + [범용 편집기를 사용하여 응답형 Forms 만들기](/help/edge/docs/forms/universal-editor/responsive-layout.md)
         + [AEM Forms용 Edge Delivery Services 양식의 테마 및 스타일 사용자 정의](/help/edge/docs/forms/universal-editor/style-theme-forms.md)
         + [범용 편집기의 Dynamic Forms용 규칙 편집기](/help/edge/docs/forms/universal-editor/rule-editor-universal-editor.md)
         ...
         + [범용 편집기에서 Google reCAPTCHA를 Forms에 추가](/help/edge/docs/forms/universal-editor/recaptcha-forms.md)
         ...
         + [Edge Delivery Services을 사용하여 적응형 Forms 게시](/help/edge/docs/forms/universal-editor/publish-forms.md)
