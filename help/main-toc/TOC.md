...
+ 자산 {#assets}
   ...
   + Dynamic Media {#dynamicmedia}
      ...
      + OpenAPI 기능이 포함된 Dynamic Media {#dynamic-media-open-apis}
         ...
         + [별칭 URL 만들기](/help/assets/vanity-urls.md)
...
{#wysiwyg-authoring}
   + 양식 빌드 {#build-forms}
      ...
      + WYSIWYG 작성 {#universal-editor}
         ...
         + [Edge Delivery Services 양식 제출에서 403 금지된 오류 해결](/help/forms/troubleshooting-403-forbidden-edge-delivery-form-submission.md)
         + [API 통합을 사용하여 Salesforce 리드 개체 만들기](/help/edge/docs/forms/universal-editor/create-lead-object-using-api-integration.md)
...
+ 작업 {#operations}
   ...
   + [배포된 이전 코드 복원(Beta)](/help/operations/restore-previous-code-deployed.md)
...
+ 문제 해결 {#troubleshooting}
   + [AEM Assets 및 Forms 문제 해결](/help/troubleshooting/home.md)
