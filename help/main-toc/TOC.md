...
+ 자산 {#assets}
   ...
   + Assets 보기 작업 {#assets-view}
      ...
      + [관리 보기에서 Assets 보기로 메타데이터 양식 가져오기](/help/assets/import-metadata-form-from-admin-view-to-assets-view.md)
   ...
   + Figma와의 통합 {#integration-figma}
      + [Figma와의 기본 통합](/help/assets/integrate-aem-assets-with-figma.md)
...
+ Forms {#forms}
   ...
   + 설정 및 마이그레이션 {#setup-configure-migrate}
      ...
      + [Adobe Experience Software Development Kit(AEM SDK)의 기능 전환](/help/forms/enable-feature-toggle.md)
