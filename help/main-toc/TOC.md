...
+ Assets {#assets}
   ...
   + 디지털 자산 관리 {#manage}
      + 마이크로 프론트엔드 자산 선택기 {#asset-selector}
         ...
         + [자산 선택기 예시](/help/assets/asset-selector-examples.md)
   ...
   + Dynamic Media {#dynamicmedia}
      ...
      + OpenAPI 기능이 포함된 Dynamic Media {#dynamic-media-open-apis}
         ...
         + [원격 AEM Assets을 AEM Sites와 통합](/help/assets/integrate-remote-approved-assets-with-sites.md)
         + [자주 묻는 질문](/help/assets/dynamic-media-open-apis-faqs.md)
         + [사용자 정의 도메인 구성](/help/assets/configure-custom-domain.md)
   + Assets 보기로 작업 {#assets-view}
...
+ Screens {#screens-as-cloud-service}
   ...
   + Screens as a Cloud Service에 온보딩 {#onboarding-screens-cloud}
      ...
      + Cloud Manager에 추가 기능으로 Screens 프로그램 추가 {#adding-screens-addon}
...
+ Edge Delivery Services {#edge-delivery}
   ...
   + WYSIWYG 작성 {#wysiwyg-authoring}
      ...
      + [사이트 간 코드 재사용](/help/edge/wysiwyg-authoring/repoless.md)
...
+ Headless {#headless}
   ...
   + Headless 여정 {#journeys}
      + Headless 개발자 여정 {#developer}
         ...
         + [모든 것을 통합하는 방법 방법](/help/journey-headless/developer/put-it-all-together.md)
...
+ 구현 {#implementing}
   ...
   + AEM as a Cloud Service용 개발 {#developing}
      ...
      + 하이브리드 및 SPA 개발 {#hybrid}
         ...
         + [Sling 모델 내보내기 도구를 통한 ResourceResolver 직렬화 비활성화](/help/implementing/developing/hybrid/disallow-the-serialization-of-resourceresolvers-via-sling-model-exporter.md)
