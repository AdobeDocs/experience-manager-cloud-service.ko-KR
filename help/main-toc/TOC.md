...
+ 보안 {#security}
   ...
   + [게시 계층에서 AEM as a Cloud Service에 대한 Open ID Connect 지원](/help/security/open-id-connect-support-for-aem-as-a-cloud-service-on-publish-tier.md)
...
+ 생성형 AI {#generative-ai}
   ...
   + [AEM의 AI Assistant - 구성](/help/implementing/cloud-manager/aem-ai-assistant-admin.md)
