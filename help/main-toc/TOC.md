...
+ Edge Delivery Services {#edge-delivery}
   ...
   + 양식 빌드 {#build-forms}
      ...
      + WYSIWYG 작성 {#universal-editor}
         ...
         + [제출 후 사용자 안내: 범용 편집기에서 리디렉션 및 감사 메시지를 구성합니다.](/help/edge/docs/forms/universal-editor/configure-thankyou-message.md)
         ...
         + [미리 채우기 서비스 구성: 미리 채우기 서비스를 구성하는 단계별 안내서 완료](/help/edge/docs/forms/universal-editor/prefill-form.md)
