...
+ 릴리스 정보 {#release-notes}
   ...
   + Cloud Manager 릴리스 정보 {#cloud-manager}
      ...
      + 2025 {#2025}
         + [2025.1.0 릴리스 정보](/help/implementing/cloud-manager/release-notes/2025/2025-1-0.md)
      + 2024 {#2024}
         + [2024.12.0 릴리스 정보](/help/implementing/cloud-manager/release-notes/2024/2024-12-0.md)
...
+ 구현 {#implementing}
   ...
   + Cloud Manager 사용 {#using-cloud-manager}
      ...
      + 코드 관리 {#managing-code}
         ...
         + [외부 저장소 추가 (제한적 Beta)](/help/implementing/cloud-manager/managing-code/external-repositories.md)
