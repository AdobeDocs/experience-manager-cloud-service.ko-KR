...
+ 보안 {#security}
   ...
   + [권한 관리를 위한 주요 보기](/help/security/touch-ui-principal-view.md)
...
+ Sites {#sites}
   ...
   + [AEM as a Cloud Service용 운영 원격 분석](/help/sites-cloud/administering/operational-telemetry-for-aem-as-a-cloud-service.md)
+ 자산 {#assets}
...
+ Edge Delivery Services {#edge-delivery}
   ...
   + 양식 빌드 {#build-forms}
      ...
      + 문서 기반 작성 {#getting-started-edge-delivery-services-forms}
         ...
         + [양식 성능 모니터링: 운영 원격 분석 가이드](/help/edge/docs/forms/operational-telemetry-for-forms.md)
...
+ 생성형 AI {#generative-ai}
   + [AEM as a Cloud Service의 생성 AI](/help/generative-ai/generative-ai-in-aem.md)
...
+ 구현 {#implementing}
   ...
   + Cloud Manager 사용 {#using-cloud-manager}
      ...
      + Edge Delivery 사이트 {#edge-delivery-sites}
         ...
         + [한 번의 클릭으로 첫 번째 Edge Delivery 사이트 만들기](/help/implementing/cloud-manager/edge-delivery/create-edge-delivery-site.md)
         + [Edge Delivery 사이트에 대한 푸시 유효성 검사 설정](/help/implementing/cloud-manager/edge-delivery/cdn-setup-push-invalidation.md)
         + [컨텐츠 Source 구성](/help/implementing/cloud-manager/edge-delivery/configure-content-source.md)
