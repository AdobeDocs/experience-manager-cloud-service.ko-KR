   ...
   + CIF Storefront {#cif-storefront}
      ...
      + Commerce 여정 {#journeys}
         + 콘텐츠 작성자 여정 {#author}
            ...
            + [단계적 제품 카탈로그 경험 구축](/help/commerce-cloud/cif-storefront/commerce-journeys/aem-commerce-content-author/staged-catalog.md)
            + [제품 경험 구축](/help/commerce-cloud/cif-storefront/commerce-journeys/aem-commerce-content-author/product-experience-management.md)
      + 통합 {#integrations}
...
+ Headless {#headless}
   ...
   + 배포 {#deployment}
      ...
      + [리퍼러 필터](/help/headless/deployment/referrer-filter.md)
