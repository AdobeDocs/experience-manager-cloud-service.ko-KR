...
+ Experience Hub {#experience-hub}
   + [Experience Hub 정보](/help/experience-hub.md)
+ 온보딩 {#onboarding}
...
+ Forms {#forms}
      ...
      + 핵심 구성 요소 {#authoring-adaptive-forms-core-components}
         + 적응형 양식 만들기 {#create-an-adaptive-form-on-forms-cs}
            ...
            + 핵심 구성 요소 기반 적응형 양식의 규칙 편집기 소개{#rule-editor-core-components}
               ...
               + [규칙 편집기의 API 통합](/help/forms/api-integration-in-rule-editor.md)
   ...
   + 문제 해결 {#troubleshooting-aem-forms-cloud-service}
      ...
      + [사용자 지정 제출 액션의 502 오류 페이지](/help/forms/custom-submit-action-troubleshooting.md)
...
+ AI 어시스턴트 {#ai-assistant}
   + [AEM에서 AI Assistant 구성](/help/implementing/cloud-manager/ai-assistant-in-aem-admin.md)
   + [AEM의 AI Assistant 정보](/help/implementing/cloud-manager/ai-assistant-in-aem.md)
+ 생성형 AI {#generative-ai}
   ...
   + [AEM Forms용 AI Assistant 시작하기](/help/edge/docs/forms/forms-ai-assistant.md)
   + [AEM Forms용 AI Assistant 시작하기(Forms Experience Builder)](/help/edge/docs/forms/forms-ai-assistant-getting-started.md)
   + [AEM Forms AI 어시스턴트 - 프롬프트 라이브러리](/help/edge/docs/forms/ai-assistant-prompt-library.md)
   + [Forms Experience Builder - 우수 사례](/help/edge/docs/forms/aem-forms-ai-assistant-best-practices.md)
...
+ 구현 {#implementing}
   ...
   + Cloud Manager 사용 {#using-cloud-manager}
      ...
      + 코드 관리 {#managing-code}
         ...
         + [개인 저장소에 대한 가져오기 요청 확인](/help/implementing/cloud-manager/managing-code/github-check-config.md)
      ...
      + Cloud Manager CI-CD 파이프라인 {#cicd-pipelines}
         ...
         + [스테이지 및 프로덕션 전용 파이프라인 분할(Beta)](/help/implementing/cloud-manager/configuring-pipelines/stage-prod-only.md)
