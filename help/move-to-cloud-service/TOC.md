---
sub-product: Cloud Service으로 AEM으로 이동
user-guide-title: Cloud Service으로 AEM으로 이동
...
+ [Cloud Service으로 AEM으로 이동](/help/move-to-cloud-service/home.md)
+ 전환 경로의 단계 {#phases}
