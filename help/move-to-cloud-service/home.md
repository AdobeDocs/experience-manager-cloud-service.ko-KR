...
클라우드 서비스인 AEM은 Adobe Experience Manager Sites 및 Assets에 대한 확장 가능하고 안전하며 민첩한 기술 기반을 제공하므로 마케터와 IT 담당자는 규모에 맞게 효과적인 경험을 전달하는 데 주력할 수 있습니다.

AEM을 클라우드 서비스로 사용하면 팀은 제품 업그레이드를 계획하지 않고 혁신에 집중할 수 있습니다. 새로운 제품 기능은 중단 없이 철저하게 테스트되고 팀에게 전달되므로 항상 최신 애플리케이션에 액세스할 수 있습니다.

## 클라우드 서비스로 전환 프로세스 이해 {#understanding-move}

클라우드 서비스로 전환하는 과정에는 계획, 실행 및 사후 실행의 3단계가 포함됩니다.

성공적이고 원활한 전환을 위해 본 가이드에 나와 있는 모범 사례를 준수하고 적절한 계획을 해야 합니다.

아래 그림은 Cloud Service로의 권장 전환 여정을 시각적으로 보여줍니다.

![이미지](/help/move-to-cloud-service/assets/home-img1.png)

클라우드 서비스로 전환하는 방법과 관련된 여러 단계에 대해 자세히 알아보십시오.
...
| [클라우드 서비스 사용 안내서로 AEM으로 이동](/help/move-to-cloud-service/home.md) | 클라우드 서비스로 전환하는 방법을 파악합니다. |
