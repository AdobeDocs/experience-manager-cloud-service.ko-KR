...
1. **컨텐츠 전송** 마법사에서 마이그레이션 세트를 선택하고 **추출**&#x200B;을 클릭하여 추출을 시작합니다.

   ![이미지](/help/move-to-cloud-service/content-transfer-tool/assets-ctt/extraction-01.png)

1. **마이그레이션 세트 추출** 대화 상자가 표시되고 **추출**&#x200B;을 클릭하여 추출 단계를 시작합니다.
...
1. 이제 **추출** 필드에 **실행** 상태가 표시되어 추출이 진행 중임을 나타냅니다.
   ...
   >[!IMPORTANT]
   >UI에는 30초마다 **컨텐츠 전송** 마법사를 다시 로드하는 자동 재로드 기능이 있습니다.
...
1. **컨텐츠 전송** 마법사로 이동하고 추가 추출을 수행할 마이그레이션 세트를 선택합니다. **추출**&#x200B;을 클릭하여 추가 추출을 시작합니다.
