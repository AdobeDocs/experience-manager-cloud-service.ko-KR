...
범용 편집기를 사용하여 AEM 콘텐츠를 작성하는 경우, 범용 편집기의 **게시** 버튼을 클릭하기만 하면 간단하게 게시할 수 있습니다. [범용 편집기를 사용하여 콘텐츠 게시](/help/sites-cloud/authoring/universal-editor/publishing.md) 문서를 참조하십시오.
