...
2\. 프로젝트 루트에 있는 [`component-definition.json` 파일](/help/implementing/universal-editor/component-definition.md)을 편집하고 새 인용 블록에 대해 다음 정의를 추가한 후 파일을 저장합니다.
...
4\. 프로젝트 루트에 있는 [`component-filters.json` 파일](/help/implementing/universal-editor/filtering.md)을 편집하고 [필터 정의](/help/implementing/universal-editor/filtering.md)에 인용 블록을 추가하여 해당 블록이 모든 섹션에 추가되도록 허용하고 파일을 저장합니다.
