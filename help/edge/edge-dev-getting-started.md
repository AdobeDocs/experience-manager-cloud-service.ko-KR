...
1. 저장소 루트로 돌아가서 `paths.yaml`를 클릭한 다음 **이 파일 편집** 아이콘을 클릭합니다.

   ![paths.yaml](assets/edge-dev-getting-started/paths.png)

1. 기본 매핑을 `/content/<site-name>/:/`로 바꾸고 **변경 사항 커밋...**&#x200B;을 클릭합니다.
...
이제 Universal Editor를 사용하여 사이트를 편집할 수 있습니다. 자세한 내용은 [Universal Editor 설명서](/help/implementing/universal-editor/authoring.md)를 참조하십시오.
