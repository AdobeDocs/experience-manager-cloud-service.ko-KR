...
- **기본 스타일 업데이트**: 양식 CSS 파일을 편집하여 양식의 기본 스타일을 수정할 수 있습니다. 기본 스타일은 일반적으로 `https://github.com/<your-github-username>/<your-repository>/tree/main/blocks/form/form.css`에 있는 프로젝트의 GitHub 리포지토리에서 사용할 수 있습니다. 이 파일은 양식에 대한 포괄적인 스타일을 제공하고, 여러 단계의 마법사 양식을 지원하며, 간편한 맞춤화를 위해 CSS 사용자 지정 속성을 사용하는 것을 강조합니다.

- **CSS 스타일 패턴**: Edge Delivery Services은 블록 기반 CSS 아키텍처를 사용합니다. 다음 권장 선택기 패턴 사용:
...
1. **프로젝트 수준 사용자 지정**: `/styles/styles.css`에 스타일 추가
2. **양식별 사용자 지정**: `/blocks/form/form.css` 수정
3. **구성 요소 재정의**: 사용자 지정 CSS에 적절한 특정 선택기를 사용하십시오.
