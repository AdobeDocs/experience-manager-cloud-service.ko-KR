...
* [적응형 양식 기초 구성 요소](creating-adaptive-form.md): 클래식(이전) 데이터 캡처 구성 요소입니다. 이를 계속 사용하여 기존의 기초 구성 요소 기반 적응형 양식을 편집할 수 있습니다. 새 양식을 만드는 경우 [적응형 Forms 핵심 구성 요소](creating-adaptive-form-core-components.md)를 사용하여 적응형 Forms을 만드는 것이 좋습니다.
...
## AEM Forms을 고객 응대 및 내부 보험 프로세스 모두에 사용할 수 있습니까?

예. AEM Forms은 고객 응대 디지털 양식은 물론 검토, 승인 및 지원 데이터 캡처와 같은 내부, 직원 또는 상담원이 주도하는 프로세스를 지원합니다.

## AEM Forms을 보험 청구 제출에 사용할 수 있습니까?

예. AEM Forms은 구조화된 데이터 캡처 및 지원 문서 등 보험 계약자가 디지털 방식으로 보험 청구서를 제출할 수 있는 여러 단계 적응형 양식을 지원합니다.

## AEM Forms에서 모바일 보험 청구를 지원합니까?

예. AEM Forms은 응답형 및 모바일 친화적 양식을 지원하여 고객 및 에이전트가 모바일 디바이스에서 보험 정보를 제출할 수 있도록 합니다.
