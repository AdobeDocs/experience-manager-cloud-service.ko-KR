...
description: AEM Forms을 살펴보고 비즈니스 전용 양식 및 문서를 만드는 데 어떻게 도움이 되는지 알아봅니다. PaaS(Platform-as-a-Service)와 엔터프라이즈급 디지털 양식 및 비즈니스 프로세스를 관리하고 Forms을 Adobe Sign 및 현재 데이터 소스에 연결하는 방법을 알아봅니다.
...
Adobe [!DNL Experience Manager Forms as a Cloud Service] 는 여정의 모든 단계를 지원하는 고객 중심의 솔루션입니다.
...
대기업은 양식을 한 번 만든 후 컨텐츠 관리 시스템에 복사하여 재사용하는 경우가 많습니다. 최신 형식의 대용량 데이터베이스를 유지하고 이를 검색할 수 있게 만드는 것은 상당한 어려움이 될 수 있습니다. AEM은 고객이 웹 및 모바일 채널 모두에서 필요한 양식을 찾고 액세스할 수 있도록 사용자 지정 가능한 Forms 포털을 제공합니다.

조직의 특정 요구 사항을 충족하도록 Forms Portal의 모양, 브랜딩 및 로고를 사용자 지정할 수 있습니다.

## 등록 및 온보딩 환경을 디지털화하고 간소화합니다.

이 서비스를 사용하여 대화형 및 매력적인 디지털 양식을 작성하고 롤아웃할 수 있습니다. 예를 들어, 고객 등록 여정을 디지털화하고자 하는 조직을 생각해 보십시오. 이 조직은 기존 고객 데이터가 포함된 여러 데이터 소스를 보유하고 있습니다. 양식을 미리 채우고, 양식에 전자 서명을 추가하고, 채워진 양식을 PDF 파일로 보관하고자 합니다. 또한 조직에는 여러 인쇄 양식(PDF 양식)이 있으며 모든 인쇄 양식을 디지털 양식으로 변환하고자 합니다.
...
![반응형 양식 디자인](/help/forms/assets/data-collection.jpeg "여러 장치를 위한 적응형 Forms 경험"){width="70%" align="center"}


## 백오피스 워크플로우 자동화

양식 중심의 워크플로우를 사용하여 검토, 승인 또는 추가 처리를 위해 관리자나 부서 등의 다양한 이해 당사자에게 양식 데이터의 처리 및 라우팅을 자동화합니다.

이러한 워크플로우는 양식 데이터의 일관성 있고 감사 가능한 처리를 보장하고, 수동 작업을 자동화하고, 역할 기반 액세스 제어를 제공하고, 규제 요구 사항을 준수하도록 지원함으로써 위험 요소를 최소화하고, 규정 준수를 유지할 수 있도록 도와줍니다.
...
비즈니스 사용자는 AEM Forms을 사용하여 문서 템플릿을 사용자 지정하고 백엔드 프로세스에서 템플릿에 정보를 통합하여 매력적인 개인화된 사용자 경험을 만들 수 있습니다. 직관적인 API 세트를 사용하면 비즈니스 세트에서 문의나 일괄 처리 간격을 기준으로 커뮤니케이션을 생성할 시기를 결정하는 규칙을 설정할 수 있습니다.

영수증, 환영 키트, 명세서 등 개인화된 문서를 손쉽게 생성할 수 있습니다. 조직은 개인화된 웹 포털로 트래픽을 유도하여 추가 서비스를 등록 또는 구매할 수 있습니다.


![개인화된 송장](/help/forms/assets/personalized-communication.jpeg "주문형 생성된 개인화된 PDF 송장"){width="70%" align="center"}


## 양식 성능 최적화

이 서비스는 게시된 양식에 대한 성능 지표를 캡처하고 추적할 수 있도록 Adobe Analytics과 통합됩니다. 이러한 지표를 분석하기 위한 목적은 양식이나 문서를 보다 유용하게 사용할 수 있도록 하는 데 필요한 변경 사항에 대한 데이터를 기반으로 현명한 결정을 내리는 것입니다. Adobe Analytics을 사용하여 적응형 양식을 사용하는 동안 사용자가 직면하는 상호 작용 패턴과 문제를 발견할 수 있습니다.
