...
description: AEM Forms를 살펴보고 업무용 양식 및 문서 콘텐츠를 제작하는 데 어떻게 도움이 되는지 알아봅니다. PaaS(Platform-as-a-Service)와 엔터프라이즈급 디지털 양식 및 비즈니스 프로세스를 관리하는 방법에 대해 알아보고 Forms을 Adobe Sign 및 현재 데이터 소스에 연결합니다.
