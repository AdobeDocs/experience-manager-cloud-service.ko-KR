...
description: 이 PaaS(Platform-as-a-Service)를 사용하여 엔터프라이즈급 디지털 양식 및 비즈니스 프로세스를 생성하고, 관리하고, 게시하고, 양식을 현재 데이터 소스에 연결합니다.
...
* [주요 변경 내용 AEM 6.5 Forms와 비교](notable-changes.md)
* [자주 묻는 질문](faq.md)
