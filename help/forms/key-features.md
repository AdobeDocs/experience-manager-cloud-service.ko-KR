...
* 사용 [automated forms conversion 서비스](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/introduction.html) PDF 양식을 적응형 양식으로 전환하려면 다음을 수행하십시오. 조직의 데이터 캡처 경험을 디지털화하고 현대화할 수 있습니다.
