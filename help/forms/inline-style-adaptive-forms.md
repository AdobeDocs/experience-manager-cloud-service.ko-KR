...
1. 페이지에서 구성 요소를 선택하고 편집 단추 ![편집 단추](assets/edit.svg)를 선택합니다. 스타일 속성이 사이드바에서 열립니다.
   ...
   [!UICONTROL Style] 모드에서 양식 개체 아래에 나열된 구성 요소를 볼 수 있습니다. 그러나 사이드바의 양식 개체 목록에는 필드 및 패널과 같은 구성 요소가 나열됩니다. 필드 및 패널은 텍스트 상자 및 라디오 버튼과 같은 구성 요소를 포함할 수 있는 일반 구성 요소입니다.
...
적응형 양식의 한 구성 요소에서 다른 구성 요소로 스타일을 복사하여 붙여넣을 수도 있습니다. **[!UICONTROL 스타일]** 모드에서 구성 요소를 선택하고 복사 아이콘 ![복사](assets/property-copy-icon.svg)를 선택합니다.

같은 유형의 다른 구성 요소를 선택하고 붙여넣기 아이콘 ![복사](assets/Smock_Paste_18_N.svg)를 선택하여 복사한 스타일을 붙여넣습니다. 스타일 지우기 아이콘 ![복사](assets/clear-style-icon.svg)를 선택하여 적용된 스타일을 지울 수도 있습니다.

## 구성 요소의 여러 상태에 대한 스타일 설정 {#set-styles-for-states}

구성 요소 유형의 여러 상태에 대해 스타일을 설정할 수 있습니다. 다른 상태에는 [!UICONTROL 포커스], [!UICONTROL 사용 안 함], [!UICONTROL 가리킴], [!UICONTROL 오류], [!UICONTROL 성공] 및 [!UICONTROL 필수]이 포함됩니다.

구성 요소 상태에 대한 스타일을 정의하려면 다음을 수행합니다.

1. **[!UICONTROL 스타일]** 모드에서 구성 요소를 선택하고 편집 아이콘 ![편집](assets/Smock_Edit_18_N.svg)을 선택합니다.

1. **[!UICONTROL 상태]** 드롭다운 목록을 사용하여 구성 요소의 상태를 선택하십시오.

   ![상태 선택](assets/select-state.png)

1. 선택한 구성 요소 상태의 스타일을 정의하고 ![저장](assets/save_icon.svg)을(를) 선택하여 속성을 저장합니다.

성공 및 오류 상태를 시뮬레이션할 수도 있습니다. **[!UICONTROL 성공 시뮬레이션]** 및 **[!UICONTROL 오류 시뮬레이션]** 옵션을 보려면 확장 아이콘을 선택하십시오.
