...
description: 적응형 양식에 사용자 지정 스타일을 적용할 수 있지만 적응형 양식의 개별 구성 요소에 인라인 CSS 속성을 적용할 수도 있습니다. 적응형 양식 구성 요소에 인라인 스타일을 적용하는 방법에 대해 알아봅니다. 텍스트 필드 구성 요소에 인라인 스타일을 적용하는 예를 사용하여 자세히 알아보십시오.
...
| 버전 | 문서 링크 |
| -------- | ---------------------------- |
| AEM 6.5 | [여기를 클릭하십시오.](https://experienceleague.adobe.com/docs/experience-manager-65/forms/adaptive-forms-basic-authoring/inline-style-adaptive-forms.html) |
