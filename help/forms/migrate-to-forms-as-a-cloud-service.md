...
* Forms Cloud Service 프로그램에 대해 [Forms - 디지털 등록](https://experienceleague.adobe.com/docs/experience-manager-cloud-manager/using/getting-started/setting-up-program.html?lang=ko&#editing-program) 옵션을 활성화하고 [파이프라인을 실행](https://experienceleague.adobe.com/docs/experience-manager-cloud-manager/using/how-to-use/deploying-code.html)합니다.
...
1. 기존 [&#x200B; 환경의 &#x200B;](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/correct-method-to-clone-the-aem-environment/qaq-p/363487?profile.language=ko)복제[!DNL AEM Forms]을(를) 만듭니다.
...
1. [!DNL AEM Forms] 자산을 [!DNL AEM] as a Cloud Service과 호환되도록 하려면 옵션을 차례로 사용하십시오.
   ...
   AEM Form을 Cloud Service으로 마이그레이션하려면 [패키지 관리자](https://experienceleague.adobe.com/docs/experience-manager-65/administering/contentmanagement/package-manager.html?lang=ko#contentmanagement)를 사용하여 재사용 가능한 함수(클라이언트 라이브러리)를 패키지로 내보냅니다.

1. [재사용 가능한 함수(클라이언트 라이브러리) 패키지, &#x200B;](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/deploying/overview.html?lang=en#deploying-content-packages-via-cloud-manager-and-package-manager)사용자 지정 코드, 구성 요소, 구성[, 사용자 지정 로케일별 라이브러리를 &#x200B;](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/cloud-manager/devops/deploy-code.html?lang=ko#cloud-manager) as a Cloud Service 환경에 배포[!DNL AEM].
...
* [AEM Forms as a Cloud Service에 온보딩](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/setup-configure-migrate/setup-forms-cloud-service.html?lang=ko)
