...
1. 조각에 대 한 제목, 이름, 설명 및 태그를 지정 합니다.
...
1. 적응형 양식 단편을 삽입할 편집 모드에서 적응형 양식을 엽니다.
1. 세로 막대에서 Assets **![ 자산-브라우저 ](assets/assets-browser.png) 를 클릭** 합니다. [자산 브라우저의 드롭다운에서 [적응형 양식 단편 **]을 선택** 합니다.
...
1. 적응형 양식 단편을 적응형 양식으로 드래그 앤 드롭합니다.
   ...
   >[!NOTE]
   >
   >적응형 양식 조각은 적응형 양식 내에서 작성 하는 데 사용할 수 없습니다. 또한 JSON 기반 적응형 양식에서 XSD 기반 조각을 사용할 수 없으며 그 반대의 방법도 사용할 수 없습니다.
