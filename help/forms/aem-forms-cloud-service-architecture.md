...
|  |  |
|---|---|
| **Forms 디지털 등록** | ![Forms-디지털 등록](assets/forms-cloud-service-architecture-forms-digital-enrollment.svg) |
| **Forms Communications** | ![Forms-통신](assets/forms-cloud-service-architecture-forms-communications.svg) |
