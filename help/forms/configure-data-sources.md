...
* 관계형 데이터베이스 - MySQL, [!DNL Microsoft® SQL Server], [!DNL IBM® DB2®], postgreSQL, Azure SQL 및 [!DNL Oracle RDBMS]
* RESTful 웹 서비스
* SOAP 기반 웹 서비스
* OData 서비스(버전 4.0)
* ® Dynamics
...
`importAllowlistPattern`양식 데이터 모델 SOAP 웹 서비스 가져오기&#x200B;**[!UICONTROL 구성의]** 속성을 설정하여 정규 표현식을 지정하십시오. 다음 JSON 파일에는 샘플이 표시됩니다.
