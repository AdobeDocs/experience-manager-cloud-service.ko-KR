...
데이터 통합은 OAuth2.0, 기본 인증 및 API 키 인증 유형을 기본적으로 지원하며, 웹 서비스 액세스에 대한 사용자 지정 인증을 구현할 수 있습니다. RESTful, SOAP 기반 및 OData 서비스는에서 구성됩니다. [!DNL Experience Manager] as a Cloud Service <!--, JDBC for relational databases --> 및 커넥터 [!DNL Experience Manager] 사용자 프로필이에서 구성됨 [!DNL Experience Manager] 웹 콘솔.
...
다음을 사용하여 관계형 데이터베이스를 구성할 수 있습니다. [!DNL Experience Manager] 웹 콘솔 구성 다음을 수행합니다.
...
다음을 의미할 수 있습니다. [OpenAPI 3.0 사양](https://swagger.io/specification/v3/) 을 참조하십시오.
...
1. OData 서비스에 대해 다음 세부 정보를 지정합니다.
   ...
   * 인증 유형( 없음, OAuth2.0, 기본 인증, API 키 또는 사용자 지정 인증 )을 선택하여 OData 서비스에 액세스하고 그에 따라 인증에 대한 세부 정보를 제공합니다.
