...
description: OSGi에서  [!DNL AEM Forms] Forms 중심 워크플로우에 공유 대기열을 사용하는 방법을 알아봅니다.
topic-tags: process
...
로그인한 사용자는 [!DNL `workflow-users`] 그룹의 구성원이어야 합니다. 사용자는 로그인한 사용자가 읽기 권한이 있는 사용자에게만 또는 공개 프로필을 활성화한 사용자에게만 항목을 공유하거나 항목에 대한 액세스를 요청할 수 있습니다.
