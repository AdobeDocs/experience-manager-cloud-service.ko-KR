...
Ultramarine-Accessible 테마는 참조 테마입니다. 적응형 양식의 색상 대비 및 기타 접근성 관련 문제를 해결하는 방법을 보여 주는 데 도움이 됩니다. Adobe에서는 조직에서 승인한 스타일을 기반으로 프로덕션 환경에 대한 사용자 지정 테마를 만들 것을 권장합니다. 테마를 AEM 인스턴스에 업로드하려면 다음 단계를 수행하십시오.
