...
* 5.3 [Node.js 버전을 20](#53-set-the-nodejs-version-to-20-set-node)(으)로 설정
* 5.4 [프론트엔드 파이프라인 실행](#run-a-frontend-pipeline)
...
##### 5.3 Node.js 버전을 20으로 설정 {#set-node}
...
1. **[!UICONTROL 저장]**&#x200B;을 클릭합니다.
   ...
   >[!NOTE]
   >
   > Cloud Manager에서 프론트엔드 파이프라인이 실패하지 않도록 [Node.js 버전을 20](#set-the-nodejs-vesrion-to-20)(으)로 설정합니다.
