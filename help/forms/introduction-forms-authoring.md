...
<table>
 <tbody>
  ...
  <tr>
   <td>패널</td>
   <td><p>패널 또는 하위 패널을 추가합니다.</p> <p><span class="uicontrol">하위 패널 추가</code> 버튼을 사용하여 상위 패널 도구 모음에서 패널 구성 요소를 추가할 수도 있습니다. 마찬가지로 <span class="uicontrol">패널 도구 모음 추가</code> 버튼을 사용하여 패널별 도구 모음을 추가할 수 있습니다. 패널 편집 대화 상자를 사용하여 패널 도구 모음의 위치를 구성할 수 있습니다.</code></code></p> </td>
  </tr>
  <tr>
   <td>암호 상자</td>
