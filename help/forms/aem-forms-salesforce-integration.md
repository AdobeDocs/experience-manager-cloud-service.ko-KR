---
title: OAuth 2.0 클라이언트 자격 증명 흐름을 사용하여 Salesforce을 AEM Forms과 통합하는 방법은 무엇입니까?
description: OAuth 2.0 클라이언트 자격 증명 플로우를 사용하여 Salesforce을 AEM Forms과 통합하는 방법을 알아봅니다. AEM Forms Salesforce 통합에 대한 단계가 표시됩니다.
...
![AEM Forms과 Salesforce 응용 프로그램 간의 통신을 설정하는 동안 워크플로우가 발생했습니다](/help/forms/assets/salesforce-workflow.png)
...
Salesforce 응용 프로그램을 구성한 후 FDM(양식 데이터 모델)을 만드는 동안 구성을 사용할 수 있습니다. 자세한 내용은 [FDM(양식 데이터 모델) 만들기](create-form-data-models.md)를 참조하십시오. 적응형 양식에 대해 [양식 데이터 모델 제출 액션을 구성](/help/forms/using-form-data-model.md)하여 Salesforce 응용 프로그램으로 데이터를 보냅니다.
