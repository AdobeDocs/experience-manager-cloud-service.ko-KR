---
title: AEM 워크플로우를 적응형 양식과 통합하는 방법
...
* AEM Workflow 통합을 통해 양식 제출과 관련된 복잡한 비즈니스 프로세스를 자동화할 수 있습니다.
...
## AEM 워크플로우와 적응형 Forms 통합 {#steps-to-integrate-workflow-with-af}

>[!BEGINTABS]

>[!TAB 기초 구성 요소]

기초 구성 요소를 기반으로 하는 적응형 양식에 대해 [AEM 워크플로](https://experienceleague.adobe.com/docs/experience-manager-65/developing/extending-aem/extending-workflows/workflows-models.html?lang=ko#extending-aem)를 사용하여 자동화된 프로세스를 설정하려면 다음 단계를 수행하십시오.

1. 편집할 적응형 양식을 열고 적응형 양식 컨테이너 속성의 **[!UICONTROL 제출]** 섹션으로 이동합니다.
1. **[!UICONTROL 제출 액션]** 드롭다운 목록에서 **제출 액션**&#x200B;을(를) **[!UICONTROL AEM 워크플로우 호출]**(으)로 선택합니다.
...
핵심 구성 요소를 기반으로 하는 적응형 양식에 대해 [AEM 워크플로](https://experienceleague.adobe.com/docs/experience-manager-65/developing/extending-aem/extending-workflows/workflows-models.html?lang=ko#extending-aem)를 사용하여 자동화된 프로세스를 설정하려면 다음 단계를 수행하십시오.
...
범용 편집기에서 작성된 적응형 양식에 대해 [AEM 워크플로](https://experienceleague.adobe.com/docs/experience-manager-65/developing/extending-aem/extending-workflows/workflows-models.html?lang=ko#extending-aem)를 사용하여 자동화된 프로세스를 설정하려면 다음 단계를 수행하십시오.
...
1. **제출** 탭을 클릭하고 **[!UICONTROL AEM 워크플로 호출]** 제출 액션을 선택합니다.
   ...
   ![전자 메일 보내기의 작업 구성](/help/forms/assets/invoke-service-ue.png)
