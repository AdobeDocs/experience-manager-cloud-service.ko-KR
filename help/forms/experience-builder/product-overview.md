...
Forms Experience Builder는 대화형 AI를 통해 빠른 양식 생성을 지원하는 동시에 기술 전문가가 아닌 사용자가 코딩 지식 없이 정교한 양식을 만들 수 있도록 지원합니다. 간단한 대화 명령을 통해 복잡한 레이아웃을 디자인하고, 유효성 검사 규칙을 구현하고, 제출 액션을 구성할 수 있습니다.
