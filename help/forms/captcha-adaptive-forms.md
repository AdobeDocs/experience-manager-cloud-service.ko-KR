...
1. [!DNL reCAPTCHA Enterprise]에 대한 클라우드 서비스를 구성하십시오.
   ...
   1. [임계값 점수를 0에서 1](https://cloud.google.com/recaptcha-enterprise/docs/interpret-assessment#interpret_scores) 범위로 지정합니다. 임계값 점수보다 크거나 같은 점수는 인간 상호 작용을 식별하고, 그렇지 않으면 봇 상호 작용으로 간주됩니다.
