---
title: AEM Forms as a Cloud Service의 적응형 Forms 핵심 구성 요소
...
# AEM Forms as a Cloud Service의 적응형 Forms 핵심 구성 요소{#enable-headless-adaptive-forms-on-aem-forms-cloud-service}
...
모든 **AEM Forms as a Cloud Service** 환경에는 핵심 구성 요소를 사용하여 적응형 Forms을 만드는 기본 지원이 포함되어 있습니다. 양식 만들기에 대한 단계별 지침은 [적응형 양식 만들기](/help/forms/create-an-adaptive-form.md)를 참조하세요.

### AEM 6.5용 적응형 Forms 핵심 구성 요소 활성화

**AEM 6.5 Forms** 및 **AEM 6.5 LTS Forms** 환경의 경우 적응형 Forms 핵심 구성 요소가 기본적으로 활성화되지 않습니다. 적응형 Forms 기능을 환경에 추가하려면 AEM Archetype을 사용해야 합니다.
