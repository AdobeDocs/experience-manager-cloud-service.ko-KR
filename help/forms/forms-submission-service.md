...
>[!NOTE]
>
>**조기 액세스 프로그램:** 이 기능은 현재 조기 액세스를 통해 사용할 수 있습니다. 액세스 권한을 요청하려면 공식 주소에서 GitHub 조직 및 저장소 이름으로 [aem-forms-ea@adobe.com](mailto:aem-forms-ea@adobe.com)에 전자 메일을 보내십시오.
>
>**예:** 저장소 `https://github.com/adobe/abc`의 경우 보내기: 조직 = `adobe`, 저장소 = `abc`
...
**시작할 준비가 되셨습니까?*** 시각적 설정을 보려면 [수동 구성](#manual-configuration) 안내서를 따르거나 프로그래밍 방식 통합을 위해 [API 구성](#api-configuration)(으)로 이동하십시오.