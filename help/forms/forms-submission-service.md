...
* Forms 제출 서비스를 사용하기 위해 Git 저장소가 허용 목록에 추가하다에 추가되었는지 확인합니다. Forms 제출 서비스를 요청하려면 [양식](https://main--afb--adobe.hlx.page/docs/docbased/submit#feature-enablement-request)을(를) 작성하십시오.
