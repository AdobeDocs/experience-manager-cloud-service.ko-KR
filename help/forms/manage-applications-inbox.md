...
1. 응용 프로그램을 선택하고 **[!UICONTROL 만들기]**. 응용 프로그램과 연결된 적응형 양식이 열립니다. 적응형 양식의 정보를 입력하고 선택 **[!UICONTROL 제출]**. 연결된 워크플로우를 시작하고 피할당자의 받은 편지함에서 작업을 만듭니다.
...
1. 다음 중 하나를 수행하십시오.
   ...
   * 작업을 위임하려면 다음을 선택합니다 **[!UICONTROL 위임]**. 항목 위임 대화 상자가 열립니다. 사용자를 선택하고 선택적으로 댓글을 추가한 다음 을 선택합니다. **[!UICONTROL 확인]**.

   ![위임](assets/delegate.png)

   * 작업을 요청하려면 다음을 선택합니다. **[!UICONTROL 열기]**. [자신에게 할당] 대화 상자가 열립니다. 선택 **[!UICONTROL 진행]** 작업을 요청합니다. 요청된 작업이 받은 편지함에서 피할당자로 표시됩니다.
...
1. 선택 **열기** 작업 세부 정보 및 사용 가능한 작업을 봅니다. 자세한 작업 보기가 열립니다. 이 보기에서 작업 세부 사항을 보고 작업에 대해 작업할 수 있습니다.
...
또한 탭에는 워크플로우에서 완료된 각 단계에 대한 작업 내역이 표시됩니다. 다음을 선택할 수 있습니다. **[!UICONTROL 세부 사항 보기]** 완료된 단계에서 해당 단계에 대한 세부 사항을 알 수 있습니다. 작업에 대한 설명, 양식 및 작업 첨부 파일, 상태, 시작 및 종료 날짜 등이 표시됩니다.
...
1. 선택 **[!UICONTROL 작업 상태]** 아코디언 및 선택 **[!UICONTROL 완료]**. 완료된 작업이 모두 표시됩니다.

   ![필터](assets/filter.png)

1. 작업을 선택하려면 선택하고 다음을 클릭하십시오. **[!UICONTROL 열기]**.
...
다음 **[!UICONTROL 워크플로 세부 사항]** 탭에는 워크플로우의 각 단계가 표시됩니다. 선택 **[!UICONTROL 세부 정보 보기]** 을 참조하십시오.
