...
description: 이러한 예약된 단어를 응용 Forms에서 식별자로 사용할 수 없습니다.
...
# 적응형 Forms 키워드 {#adaptive-forms-keywords}

적응형 Forms 키워드는 적응형 Forms에 대한 특별한 의미가 있는 사전 정의된 예약된 식별자입니다. 응용 Forms에서는 이러한 키워드를 식별자로 사용할 수 없습니다. 다음 표에는 응용 Forms에 대해 예약된 식별자인 모든 키워드가 나와 있습니다.
...
위에 나열된 키워드 외에도 다음과 유사한 이름을 사용하지 마십시오 [적응형 Forms JavaScript API](https://adobe.com/go/learn_aemforms_javascript_api_63).
