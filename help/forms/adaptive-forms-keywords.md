...
description: 이러한 예약어는 적응형 Forms에서 식별자로 사용할 수 없습니다.
...
적응형 Forms 키워드는 적응형 Forms에 대해 특별한 의미가 있는 사전 정의된 예약 식별자입니다. 이러한 키워드는 적응형 Forms에서 식별자로 사용할 수 없습니다. 다음 표에는 적응형 Forms에 대해 예약된 식별자인 모든 키워드가 나열되어 있습니다.
