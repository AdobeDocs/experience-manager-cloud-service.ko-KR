...
* 을 사용하는 응용 Forms의 경우 [XFA 양식 템플릿](prepopulate-adaptive-form-fields.md)에서는 XFA 템플릿의 데이터 스키마와 호환되는 미리 채우기 XML을 사용합니다.
...
>[!NOTE]
>
>미리 채우기 서비스 구성은 적응형 Forms, HTML 5 양식 및 HTML 5 양식 세트에 적용할 수 있습니다.
...
1. 에 대한 데이터 위치 또는 regex(정규 표현식)를 입력합니다 **데이터 파일 위치**. 유효한 데이터 파일 위치의 예는 다음과 같습니다.
