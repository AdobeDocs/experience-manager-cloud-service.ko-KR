...
* **[!UICONTROL 규정 준수]**: 출력 PDF/A 문서가 준수해야 하는 표준을 지정합니다.
* **[!UICONTROL 결과 수준]**: 변환 출력에 대한 결과 레벨을 PassFail, Summary 또는 Detailed로 지정합니다.
* **[!UICONTROL 색상 공간]**: 출력 PDF/A 파일에 사용되는 사전 정의된 색상 공간을 지정합니다.
...
* **[!UICONTROL 다음을 사용하여 DDX 지정]**: 페이로드에 대해 상대 입력 문서를 지정하고, 절대 경로를 사용하거나, 페이로드로 제공하거나, 문서 데이터 유형의 변수에 저장할 수 있습니다.
...
* **[!UICONTROL 오류 시 실패]**: 오류가 발생한 경우 API 호출 서비스가 실패하는지 확인합니다. 기본적으로 이 값은 False로 설정됩니다.
