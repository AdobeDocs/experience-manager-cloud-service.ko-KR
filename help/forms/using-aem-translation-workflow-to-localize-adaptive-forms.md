...
기계 번역 서비스는 적응형 양식 및 기록 문서에서 콘텐츠를 즉시 번역합니다. [!DNL AEM Forms]은(는) 컴퓨터 번역에 [!DNL Microsoft Translator]의 평가판을 사용하도록 사전 구성되어 있습니다. 다음 단계를 수행하여 적응형 Forms 및 기록 문서에 대한 기계 번역을 활성화합니다.

1. [!DNL AEM Forms] UI에서 양식을 선택하고 **사전 추가** 옵션을 선택합니다.
...
1. [사전 추가] 대화 상자에서 **프로젝트 열기**&#x200B;를 클릭합니다. 프로젝트 화면에서 생성된 프로젝트를 엽니다.
...
1. [기록 문서의 브랜딩 정보를 사용자 지정](generate-document-of-record-for-non-xfa-based-adaptive-forms.md)하고 브라우저 로케일이 컴퓨터 언어를 사용하여 적응형 양식을 지역화한 언어와 동일한 언어로 설정되어 있는지 확인하십시오. 브라우저 로케일은 기록 문서의 브랜딩 정보를 현지화하는 데 도움이 됩니다.
