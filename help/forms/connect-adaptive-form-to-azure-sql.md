...
* **확장성:** Azure SQL은 엔터프라이즈 수준 응용 프로그램에 적합한 확장 가능한 데이터베이스 성능을 제공합니다.
...
* [Azure SQL 데이터베이스](https://learn.microsoft.com/en-us/azure/azure-sql/database/single-database-create-quickstart?view=azuresql&tabs=azure-portal)를 만들고 **프록시 연결**&#x200B;을 사용하도록 설정했는지 확인하세요.
...
* 만든 Azure 데이터베이스에 대해 전용 이그레스 IP를 사용하여 구성된 [고급 네트워킹](https://experienceleague.adobe.com/ko/docs/experience-manager-learn/cloud-service/networking/dedicated-egress-ip-address)을 사용하도록 설정합니다.
...
>[!NOTE]
>
> 프로젝트에 SQL 종속성을 포함하려면 [SQL 드라이버 종속성](https://experienceleague.adobe.com/ko/docs/experience-manager-learn/cloud-service/networking/examples/sql-datasourcepool#mysql-driver-dependencies) 섹션을 참조하십시오.
...
* SQL 데이터베이스 및 방화벽 구성 보안을 위한 Azure 모범 사례를 따르십시오.
