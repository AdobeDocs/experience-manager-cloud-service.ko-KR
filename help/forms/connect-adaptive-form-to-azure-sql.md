---
title: AEM Adaptive Forms을 Azure SQL Storage와 연결하는 방법
description: AEM Forms에서 Azure SQL 데이터베이스 연결을 구성하고 이를 적응형 Forms과 통합하여 JDBC를 사용하여 데이터를 효율적으로 저장하거나 검색하는 방법에 대해 알아봅니다.
