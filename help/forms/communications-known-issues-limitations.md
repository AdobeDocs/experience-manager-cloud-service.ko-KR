...
두 가지 유형의 ® 글꼴이 있습니다. 한 가지 유형은 PCL이 지원하는 TrueType ® 글꼴입니다. 다른 하나는 CFF ®입니다. PDF 및 PostScript 출력은 임베드된 Type-1, TrueType 및 OpenType® 글꼴을 지원합니다. PCL 출력은 임베드된 트루타입 글꼴을 지원합니다.

Type-1 및 ® 글꼴은 PCL 출력에 포함되지 않습니다. Type-1 및 ® 글꼴로 서식이 지정된 컨텐츠는 크기가 크고 생성 속도가 느린 비트맵 이미지로 래스터화되고 생성됩니다.
