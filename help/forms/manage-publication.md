...
* Experience Manager Forms의 양식 또는 폴더에 대한 변경 사항은 다시 게시될 때까지 **Publish** 인스턴스에 표시되지 않습니다. 이렇게 하면 **Publish** 인스턴스에서 진행 중인 업데이트를 계속 사용할 수 없습니다. 관리자가 명시적으로 게시한 변경 사항만 **Publish** 인스턴스에 반영됩니다.
...
**Publish** 옵션 및 관련 자산을 사용하여 양식을 게시한 후 도구 모음에서 사용할 수 있는 **[!UICONTROL 게시 취소]** 단추를 사용하여 게시를 취소할 수도 있습니다. 양식 게시를 취소하려면 다음 작업을 수행하십시오.
...
1. **[!UICONTROL 작업]**&#x200B;에서 **Publish** 또는 **게시 취소**&#x200B;를 클릭합니다.
1. 콘텐츠를 게시하거나 게시를 취소할 **[!UICONTROL 대상]**&#x200B;을(를) 선택하십시오.
   ...
   * **Publish**: 프로덕션 환경에서 양식을 사용할 준비가 되면 Experience Manager Forms **Publish** 옵션을 사용하여 Experience Manager Forms 게시 환경에 양식을 보냅니다.
