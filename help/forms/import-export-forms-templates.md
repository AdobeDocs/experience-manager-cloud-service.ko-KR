...
1. 선택 **[!UICONTROL Adobe Experience Manager]** ![adobeexperiencemanger](assets/adobeexperiencemanager.png) 아이콘 > **[!UICONTROL 탐색]** ![나침반](assets/Smock_Compass_18_N.svg) 아이콘 > **[!UICONTROL Forms]** > **[!UICONTROL Forms 및 문서]**.
...
1. 에 로그인 [!DNL AEM Forms] 인스턴스.
1. 선택 **[!UICONTROL Adobe Experience Manager]** ![adobeexperiencemanger](assets/adobeexperiencemanager.png) 아이콘 > **[!UICONTROL 탐색]** ![나침반](assets/Smock_Compass_18_N.svg) 아이콘 > **[!UICONTROL Forms]** > **[!UICONTROL 테마]**.
