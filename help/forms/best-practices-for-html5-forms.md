...
# HTML5 양식 모범 사례{#best-practices-for-html-forms}
...
* 웹 압축을 활성화합니다. 양식에서 시작된 요청 및 응답의 크기를 줄입니다. <!-- For details, see [Performance tuning of AEM Forms Server](https://helpx.adobe.com/kr/aem-forms/6-3/performance-tuning-aem-forms.html)-->
