...
문서 생성 API는 생성된 PDF 문서 또는 AFP 문서를 반환합니다. 생성된 PDF를 Azure Blob Storage에 선택적으로 업로드할 수도 있습니다.

<span class="preview"> 문서 생성 API를 사용하여 생성된 PDF를 Azure Blob 저장소 기능에 업로드하는 작업은 [얼리 어답터 프로그램](/help/forms/early-access-ea-features.md)에 있습니다. 공식 이메일 ID를 사용하여 aem-forms-ea@adobe.com으로 이메일을 보내 얼리 어답터 프로그램에 참여하고 기능에 대한 액세스 권한을 요청할 수 있습니다. </span>

>
>
> 문서 생성 API에는 배치 및 동기 출력 생성 끝점이 포함됩니다. 이러한 API는 끝점에 따라 JWT 또는 OAuth를 사용하여 서버 간 인증을 지원합니다. 문서 생성 API에 대해 자세히 알아보려면 [여기를 클릭하세요](/help/forms/aem-forms-communication-api-overview.md#document-generation-apis).
...
>
>
> Document Manipulation API는 JWT를 사용하여 서버 간 인증을 지원합니다. 문서 조작 API에 대해 자세히 알아보려면 [여기를 클릭하세요](/help/forms/aem-forms-communication-api-overview.md#document-manipulation-apis).
...
>
>
> 문서 추출 API는 OAuth를 사용하여 서버 간 인증을 지원합니다. 문서 추출 API에 대해 자세히 알아보려면 [여기를 클릭하세요](/help/forms/aem-forms-communication-api-overview.md#document-extraction-apis).
>
...
>
>
> 문서 변환 API는 OAuth를 사용하여 서버 간 인증을 지원합니다. 문서 변환 API에 대해 자세히 알아보려면 [여기를 클릭하세요](/help/forms/aem-forms-communication-api-overview.md#document-conversion-apiss).
...
>
>
> 문서 Assurance API는 OAuth를 사용하여 서버 간 인증을 지원합니다. Document Assurance API에 대해 자세히 알아보려면 [여기를 클릭](/help/forms/aem-forms-communication-api-overview.md#document-assurance-apis)하세요.
