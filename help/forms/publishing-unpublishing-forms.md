...
[!DNL AEM Forms]을(를) 사용하면 양식을 쉽게 만들고 게시하고 게시 취소할 수 있습니다. [!DNL AEM Forms] 서버는 Author와 Publish라는 두 개의 인스턴스를 제공합니다. 작성자 인스턴스는 양식 에셋 및 리소스를 만들고 관리하기 위한 것입니다. 게시 인스턴스는 최종 사용자가 사용할 수 있는 에셋 및 관련 리소스를 유지하기 위한 것입니다.
