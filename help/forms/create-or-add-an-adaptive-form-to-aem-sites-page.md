...
AEM 페이지 편집기를 사용하여 여러 양식을 신속하게 만들고 AEM Sites 페이지에 추가할 수 있습니다. AEM Sites 편집기를 통해 콘텐츠 작성자는 동적 비헤이비어, 유효성 검사, 데이터 통합, 기록 문서 생성 및 비즈니스 프로세스 자동화 등 적응형 양식 구성 요소의 기능을 사용하여 Sites 페이지에서 원활한 데이터 캡처 경험을 만들 수 있습니다. 또한 버전 관리, 타겟팅, 번역 및 다중 사이트 관리자 등 AEM Sites 페이지의 다양한 기능을 사용할 수 있습니다.
...
AEM Sites 편집기를 사용하여 여러 양식을 빠르게 만들고 AEM Sites 페이지에 추가할 수 있습니다. AEM Sites 편집기를 통해 콘텐츠 작성자는 동적 비헤이비어, 유효성 검사, 데이터 통합, 기록 문서 생성 및 비즈니스 프로세스 자동화 등 적응형 양식 구성 요소의 기능을 사용하여 Sites 페이지에서 원활한 데이터 캡처 경험을 만들 수 있습니다. 또한 버전 관리, 타겟팅, 번역 및 다중 사이트 관리자 등 AEM Sites 페이지의 다양한 기능을 사용할 수 있습니다.


## 고려 사항 {#consideration}

AEM Forms는 적응형 양식 컨테이너와 적응형 양식 – 임베드 구성 요소를 제공합니다. 적응형 양식 컨테이너를 사용하여 경험 조각 또는 AEM Sites 페이지에서 새 양식을 만들고 추가하는 동시에 적응형 양식 – 임베드 구성 요소를 사용하여 기존 적응형 양식을 추가하거나 적응형 양식 편집기를 통해 새 양식을 만들 수 있습니다.
