...
따라서 새 채널을 추가해야 하거나 새 유형의 경험에 대한 지원이 필요한 경우 하나(또는 여러 개)의 새 구성 요소를 스택에 삽입할 수 있으며 변경할 위치가 한 개만 있습니다.
...
콘텐츠 모델링(데이터 모델링이라고도 함)은 귀사의 전공입니다. 따라서 Headless를 위한 모델링 시 고려해야 할 사항은 무엇입니까?
