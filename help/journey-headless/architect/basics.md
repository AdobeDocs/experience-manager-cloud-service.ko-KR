...
이 문서는 이들 원칙을 기반으로 작성되었으며, 이를 통해 자체 AEM Headless 프로젝트의 콘텐츠를 모델링하는 방법을 이해할 수 있습니다.
...
>[!NOTE]
>
>편집기에서 UUID 참조는 참조된 리소스의 경로를 지정합니다. 내부적으로 이러한 참조는 리소스를 참조하는 UUID(Universally Unique ID)로 보관됩니다.
