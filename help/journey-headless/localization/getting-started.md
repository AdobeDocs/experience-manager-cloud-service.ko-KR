...
변환해야 하는 모든 필드에 대해 **속성 이름** 필드를 주목하십시오. 여정의 다음 단계에 대해 이 정보가 필요합니다.
...
이제 컨텐츠 조각의 정의와 컨텐츠 구조의 중요성을 이해하므로 이 컨텐츠를 현지화하는 방법을 살펴볼 수 있습니다. AEM의 로컬라이제이션 도구는 매우 강력하지만 높은 수준에서 이해하기 쉽습니다.
