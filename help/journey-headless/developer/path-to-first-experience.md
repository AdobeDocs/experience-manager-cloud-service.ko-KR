...
각 개별 채널을 확인하고 게재할 자체 콘텐츠 구조로 표시할 수 있도록 일관된 경험을 제공하고 다양한 채널에서 개인화된 캠페인을 관리하려고 합니다. 그러나 각 채널에 자체 콘텐츠 모델을 확보하는 것은 유지하기가 어렵습니다.
...
콘텐츠를 게재할 AEM을 사용하여 첫 번째 Headless 앱을 구현하는 데 필요한 사항에 대한 개요입니다. 이러한 단계를 수행하는 방법은 Headless 개발자 여정의 뒷부분에 자세히 설명되어 있습니다.
...
* 루트 폴더가 모델에 설정된 경우 새 콘텐츠 조각의 인라인 콘텐츠 조각 편집기 생성을 간소화할 수 있습니다. 그런 다음 실무자는 위치를 선택하지 않아도 됩니다. 이름만 입력하면 새 참조 편집을 시작할 수 있습니다.

### 콘텐츠 작성 {#authoring}

* 채널별 콘텐츠의 버전에는 콘텐츠 조각 변형을 사용하는 것이 좋습니다. 변형은 콘텐츠 마스터와 동기화되어 콘텐츠 변경 관리를 간소화합니다.
* 다른 콘텐츠 제작자를 초대하여 콘텐츠 검토를 실시하고 콘텐츠 조각 편집기와 콘텐츠 조각 Admin Console의 조각에서 전역적으로 사용할 수 있는 주석 및 댓글로 피드백을 제공할 수 있도록 합니다.
...
* [콘텐츠 조각 모델 만들기](/help/sites-cloud/administering/content-fragments/content-fragments-models.md) - 콘텐츠 조각 모델에 대한 기술 설명서
* [콘텐츠 조각 만들기](/help/sites-cloud/administering/content-fragments/content-fragments.md) - 콘텐츠 조각에 대한 기술 설명서
