...
* 문서를 검토하십시오. [AEM 헤드풀 및 헤드리스](/help/implementing/developing/headful-headless.md) 따라서 가능한 다양한 수준의 SPA 통합을 이해할 수 있습니다.
...
AEM을 통해 단일 페이지 애플리케이션을 개발하면 프론트엔드 개발자가 SPA를 제작하는 도중 표준 모범 사례를 준수하는 것으로 간주됩니다. 프론트엔드 개발자가 이러한 일반적인 모범 사례와 몇 가지 AEM 관련 원칙을 따르는 경우 SPA은 AEM 및 해당 콘텐츠 작성 기능을 통해 작동합니다.
...
기존 SPA가 있는 경우 AEM 편집기의 콘텐츠 작성자에게 표시되도록 AEM은 SPA를 AEM에 임베드하는 것을 지원합니다. 이 기능은 콘텐츠가 소비되는 최종 애플리케이션의 컨텍스트에서 콘텐츠 조각을 통해 콘텐츠 조각이 작성 중인 콘텐츠를 보는 데 매우 유용할 수 있습니다.
