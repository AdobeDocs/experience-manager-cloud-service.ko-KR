...
어떤 API를 선택했든지 공통 API 기반의 Headless 시스템을 정의하여 최신 브라우저와 점진적 웹 앱(PWA) 등 기타 웹 기술을 활용할 수 있습니다. API는 손쉽게 확장하고 조종할 수 표준 인터페이스를 생성합니다.
...
이 여정은 콘텐츠 게재의 Headless 전용 모델에 중점을 둡니다. 단, 해당 기본 지식이 있으면 두 모델의 기능을 활용하는 방법을 더 탐색할 수 있습니다.
