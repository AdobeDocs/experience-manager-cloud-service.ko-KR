...
AEM에서는 유연한 콘텐츠 구조를 사용하고 계층은 임의적으로 커질 수 있습니다. 단, 폴더 구조의 모든 변경 사항이 [콘텐츠 경로를 사용](#developer)하는 기존 쿼리에 의도하지 않은 결과를 초래할 수 있음을 인식해야 합니다. 따라서 사전에 명확하게 설정 및 정의된 계층은 콘텐츠 작성자에게 도움이 될 수 있습니다.
