...
콘텐츠에 대한 요청은 표준 GraphQL API 구현을 사용자 정의하는 AEM GraphQL API를 사용하여 처리합니다. AEM GraphQL API를 사용하면 콘텐츠 조각에서 (복잡한) 쿼리를 수행할 수 있으며, 각 쿼리는 특정 모델 유형에 따라 달라집니다.
...
1. 다음 **조각 참조** 데이터 유형을 사용하면 모델 유형에 따라 콘텐츠 조각을 중첩하여 여러 수준의 구조를 구현할 수 있습니다. 이는 콘텐츠 모델링에 필수적입니다.
