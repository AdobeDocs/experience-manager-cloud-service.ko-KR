...
1. 콘텐츠 조각 모델은 일반적으로 폴더 구조에 저장됩니다. 프로젝트용 폴더를 탭하거나 클릭합니다.
1. 모델이 제공됩니다. 모델을 탭하거나 클릭하여 세부 정보를 확인합니다.
...
1. 모델의 필드 중 하나를 탭하거나 클릭합니다. AEM을 통해 필드가 표시되고, 해당 필드의 세부 정보가 오른쪽 열에 표시됩니다.
