...
AEM 헤드리스 번역 여정의 이전 문서 [컨텐츠 번역,](configure-connector.md)에서는 AEM 번역 프로젝트를 사용하여 헤드리스 컨텐츠를 번역하는 방법을 알아보았습니다. 이제 다음을 수행해야 합니다.
...
이제 AEM에서 헤드리스 콘텐츠를 번역할 준비가 되었습니다. 그러나 AEM은 강력한 도구이며 다양한 추가 옵션을 사용할 수 있습니다. 이 여정에서 본 기능에 대해 자세히 알아보려면 [추가 리소스 섹션](#additional-resources)에서 사용할 수 있는 추가 리소스 중 일부를 확인하십시오.
