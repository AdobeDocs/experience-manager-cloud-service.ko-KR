...
1. 다음으로 이동 **탐색** > **에셋** > **파일**. AEM의 Headless 콘텐츠는 콘텐츠 조각이라는 자산으로 저장됩니다.
...
1. 다음에서 **고급** 탭에서 **타겟 언어** 드롭다운에서 콘텐츠를 번역할 언어를 선택합니다. **만들기**&#x200B;를 선택합니다.
...
번역 프로젝트는 번역 작업과 관련된 콘텐츠 및 작업을 한 곳에 모아 쉽고 간편하게 번역을 관리할 수 있도록 설계되었습니다.

번역 프로젝트를 보려면 다음 작업을 수행하십시오.

1. 다음으로 이동 **탐색** > **프로젝트**.
1. 이전 섹션에서 만든 프로젝트를 선택합니다.
...
1. 라인 항목에 대한 선택 확인란을 선택하여 작업에서 항목을 삭제하거나 컨텐츠 조각 또는 자산 콘솔에서 볼 수 있는 옵션과 같은 추가 옵션을 확인합니다.

![번역 작업 옵션](assets/translation-job-options.png)

일반적으로 번역 작업의 콘텐츠는 **번역 작업** 창의 **상태** 열에 표시된 **초안** 상태에서 시작합니다.

번역 작업을 시작하려면 번역 프로젝트 개요로 돌아가 의 맨 위에서 V자 버튼을 선택합니다 **번역 작업** 카드 및 선택 **시작**.
...
해당 아이콘을 선택하여 편집기 콘솔에서 번역된 콘텐츠 조각을 열어 번역된 콘텐츠의 세부 정보를 볼 수 있습니다.
...
다음을 통해 이 폴더로 이동하는 경우 **탐색** > **파일** > **에셋**&#x200B;를 클릭하면 번역된 콘텐츠가 표시됩니다.
...
이 콘텐츠는 게시되지 않았으므로 Headless 서비스에 사용할 수 없습니다. 이 작성자-게시 구조에 대해 알아보고 번역 여정의 다음 단계에서 번역된 콘텐츠를 게시하는 방법을 살펴볼 수 있습니다.
...
이 지식을 기반으로 다음 문서를 검토하여 AEM Headless 번역 여정을 계속하십시오 [번역된 콘텐츠 게시](publish-content.md) 여기서 번역된 콘텐츠를 게시하는 방법과 언어 루트 콘텐츠가 변경될 때 이러한 번역을 업데이트하는 방법을 배웁니다.
