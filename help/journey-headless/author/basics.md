...
빠른 작업은 단일 리소스에 사용할 수 있습니다. 아래 예에서 **Basel**&#x200B;을 참조하십시오.
...
이렇게 하려면 Assets 콘솔의 **파일** 섹션 내에 일련의 폴더를 만듭니다. **만들기** 옵션(오른쪽 상단)을 선택하고 **폴더**&#x200B;를 선택합니다.
...
**다음**&#x200B;을 계속 수행한 후 조각에 대한 세부 정보(**기본** 및 **고급**)를 제공할 수 있습니다.
