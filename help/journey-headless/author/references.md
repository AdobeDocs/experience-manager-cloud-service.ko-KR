...
콘텐츠 참조는 이 작업을 수행하고 이를 통해 다른 콘텐츠를 참조할 수 있습니다. 이렇게 하면 콘텐츠 항목을 선택할 수 있는 브라우저가 열립니다.
...
조각 참조 작성은 매우 간단합니다(필드는 일반적으로 **조각 참조**&#x200B;로 레이블이 지정되지 않음). 참조를 직접 입력하거나 폴더 아이콘을 선택하여 필요한 조각을 찾아 선택할 수 있는 브라우저를 열 수 있습니다.
