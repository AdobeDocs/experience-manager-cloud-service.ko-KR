...
이전 단계에서는 헤드리스 CMS 작성에 대한 참조를 사용하는 방법을 도입했습니다. 여러분은 어떤 종류의 참조들을 이용할 수 있는지, 그리고 그들의 목적은 무엇인지 배웠습니다. 컨텐츠 참조, 자산/미디어 참조 및 조각 참조.
...
* 컨텐츠 조각 편집기의 **메타데이터** 탭에서는 다양한 메타데이터 필드와 사전 정의된 **태그**&#x200B;를 프로젝트에서 추가할 수 있습니다.

   ![컨텐츠 조각 편집기 - 메타데이터](/help/journey-headless/author/assets/headless-journey-author-metadata-01.png)

   * 자산 콘솔의 도구 모음에서 **속성** 옵션을 사용하여 직접 액세스할 수도 있습니다.
