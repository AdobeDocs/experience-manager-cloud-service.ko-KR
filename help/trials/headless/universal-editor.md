...
1. 편집기는 기본적으로 다음 위치에 로드되어야 합니다. **구성 요소** 모드. 그렇지 않은 경우 다음을 탭하거나 클릭하십시오. **구성 요소** 편집기 왼쪽에 있는 모드 레일의 아이콘

1. 최신 문서의 제목을 더블 탭하거나 클릭하여 편집합니다.
...
1. 다음에 남음 **구성 요소** 서퍼 이미지를 선택하려면 모드, 탭하거나 클릭합니다.

1. 구성 요소 레일에서 자산의 세부 정보를 볼 수 있습니다. 을(를) 탭하거나 클릭합니다 **추천 이미지** 축소판.
...
1. 다음과 같은 모험 중 하나를 탭하거나 클릭합니다. **발리 서프 캠프** 을 눌러 선택합니다.

   * 선택한 구성 요소의 파란색 윤곽선을 확인합니다. 콘텐츠 조각을 선택한 경우 탭에 콘텐츠 조각의 이름이 표시됩니다. 이 경우 **발리 서프 캠프**.
...
1. 다음 **편집** 아이콘이 구성 요소 레일에 표시됩니다. **편집** 아이콘을 탭하거나 클릭하여 새 탭에서 콘텐츠 조각 편집기를 엽니다.
