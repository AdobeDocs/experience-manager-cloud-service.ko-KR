...
* Trust Store는 `/etc/truststore` 아래에 있으며 Java™ 키 저장소 파일, 키 저장소 암호 및 저장소 메타데이터로 구성됩니다. 포함된 인증서는 기본적으로 API를 통해 모든 사람이 액세스할 수 있지만, 암호와 키 저장소는 기술적인 이유로 암호화됩니다.
...
For more information on the Anonymous Hardening Package, see [Security Checklist](https://experienceleague.adobe.com/docs/experience-manager-65/administering/security/security-checklist.html?lang=ko#anonymous-permission-hardening-package).
-->
