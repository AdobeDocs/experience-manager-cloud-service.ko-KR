...
AEM Sites 번역 여정의 이전 문서에서, [컨텐츠 번역,](configure-connector.md) AEM 번역 프로젝트를 사용하여 콘텐츠를 번역하는 방법을 알아보았습니다. 이제 다음을 수행해야 합니다.
...
1. 다음으로 이동 **탐색** -> **자산** -> **파일**. AEM의 컨텐츠는 `/content`.
1. 프로젝트의 언어 루트를 선택합니다. 이 경우 `/content/wknd/en`.
...
이제 AEM에서 자체 콘텐츠를 번역할 준비가 되었습니다. 그러나 AEM은 강력한 도구이며 다양한 추가 옵션을 사용할 수 있습니다. 에서 사용할 수 있는 추가 리소스 중 일부를 확인하십시오 [추가 리소스 섹션](#additional-resources) 추가 정보를 확인하십시오.
