...
이미 AEM Sites 및 번역 요구 사항을 잘 알고 있는 경우, 이 여정에 대한 기본 지식이 이미 있을 수 있습니다. 그럴 경우 아래의 [추가 리소스 섹션 아래에 연결된 기술 문서를 참조하여 고려하십시오.](#additional-resources)
...
이제 Adobe 사이트 번역 여정을 시작할 준비가 되었습니다. 여정의 다음 부분으로 계속 이동하여 [사이트 콘텐츠에 대해 알아보고 AEM](learn-about.md)에서 변환하는 방법을 알아보십시오.
