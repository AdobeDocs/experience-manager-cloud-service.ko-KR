...
1. 번역할 페이지 속성은 목록의 **일반** 섹션 아래에 위치합니다. 번역에 명시적으로 포함하고자 하는 기존 속성 이름을 추가하거나 업데이트할 수 있습니다.
   1. 다음에서 **새 속성** 필드에 속성 이름을 입력합니다. **번역** 및 **상속** 옵션은 자동으로 선택되어 있습니다.
   1. 선택 **추가**.
...
이 지식을 기반으로 다음 문서를 검토하여 AEM Sites 번역 여정을 계속하십시오 [콘텐츠 번역](translate-content.md) 커넥터와 규칙을 함께 사용하여 콘텐츠를 번역하는 방법에 대해 알아봅니다.
