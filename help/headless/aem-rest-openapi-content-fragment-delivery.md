---
title: 콘텐츠 조각 전달을 위한 AEM REST OpenAPI
description: 콘텐츠 조각 전송을 위한 AEM REST OpenAPI에 대해 알아보기
...
# 콘텐츠 조각 전달을 위한 AEM REST OpenAPI {#aem-rest-openapi-for-content-fragment-delivery}
...
Adobe Experience Manager(AEM as a Cloud Service)에서 컨텐츠 조각 전달을 위한 AEM REST OpenAPI는 다음과 같습니다.

* 은(는) [AEM Edge Delivery Services](/help/edge/overview.md)의 HTTP REST API로, JSON 형식의 콘텐츠 조각에서 구조화된 콘텐츠를 제공하도록 설계되었습니다.
