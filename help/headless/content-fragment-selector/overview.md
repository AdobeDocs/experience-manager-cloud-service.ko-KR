...
![콘텐츠 조각 선택기](/help/headless/assets/content-fragment-selector-unwrapped.png)

* 상단 도구 모음에서 다음 작업을 수행할 수 있습니다.
   * 오른쪽 상단의 **저장소** 선택기를 사용하여 사용할 저장소를 선택합니다
   * 목록 또는 그리드 형식을 선택합니다.
...
상단 도구 모음의 아이콘에서 필요한 보기를 선택할 수 있습니다.

![콘텐츠 조각 선택기 - 보기 유형](/help/headless/assets/content-fragment-selector-view-type.png)

## 애플리케이션과 콘텐츠 조각 선택기 통합 {#integrate-the-content-fragment-selector-with-applications}

콘텐츠 조각 선택기를 다음과 같은 다양한 애플리케이션과 통합할 수 있습니다.

* [콘텐츠 조각 선택기를 Adobe 애플리케이션과 통합](/help/headless/content-fragment-selector/integrate-adobe-application.md)
* [컨텐츠 조각 선택기를 Adobe 이외의 애플리케이션 또는 타사 애플리케이션과 통합](/help/headless/content-fragment-selector/integrate-non-adobe-application.md)
* [Vanilla JS를 사용하여 콘텐츠 조각 선택기 통합](/help/headless/content-fragment-selector/integrate-using-vanilla-js.md)
