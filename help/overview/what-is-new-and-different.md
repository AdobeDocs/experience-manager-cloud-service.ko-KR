...
AEM as a Cloud Service 환경의 사용자는 OSGi 번들 및 관련 구성이 관리되는 웹 콘솔 및 AEM 빠른 시작의 이전 부분에 더 이상 액세스할 수 없습니다. 이 인터페이스는 새 개발자 콘솔을 사용하여 읽기 전용 모드로 계속 액세스할 수 있습니다. 개발자는 이 콘솔을 통해 작성자 또는 게시 서비스의 특정 노드를 선택하고 바로 로그인할 수 있으며 기본적으로 차단된 영역에 액세스할 수 있습니다.
...
>[!NOTE]
>
>자세한 내용은 [백업](/help/operations/backup.md), [색인화](/help/operations/indexing.md) 및 [기타 유지 관리 작업](/help/operations/maintenance.md)을 시작하십시오.
