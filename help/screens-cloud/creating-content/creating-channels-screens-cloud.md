...
기본 할당 세부 정보가 있는 채널에는 일반 채널이 있는 것과 동일한 방식으로 표시하도록 할당할 수 있으며, 매번 사용자 지정 세부 정보를 수동으로 정의하는 대신 기본 할당 세부 정보를 활용하는 옵션이 추가되었습니다.
...
1. 확인 대화 상자가 표시되며, 세부 정보는 다음 조건 중 하나와 일치합니다.
