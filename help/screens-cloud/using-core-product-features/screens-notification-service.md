...
description: 이 페이지에서는 Screens as a Cloud Service에서 알림 서비스를 구성하는 방법을 설명합니다.
index: true
...
보고서 시간을 오전 5시로 설정하고 핑 시간 제한을 1시간으로 설정한 경우 Screens 장치가 오전 4:00시에서 오전 5:00시 사이에 ping하지 않으면 장치 비활성을 확인하는 이메일 알림을 받게 됩니다.
