...
* **신속한 개발** - 개발자는 신속한 개발 환경(RDE)을 통해 변경 사항을 신속하게 배포하고 검토할 수 있으므로 로컬 개발 환경에서 작동하는 것으로 입증된 기능을 테스트하는 데 필요한 시간을 최소화할 수 있습니다.

이 온보딩 여정의 목적을 위해 최소한의 기능을 시작하기 위해 AEM as a Cloud Service의 기능을 탐색하는 데 사용할 수 있는 개발 환경을 만듭니다.
...
* [AEM Champion 팁과 트릭 - Cloud Manager 환경 유형](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/expert-resources/aem-champions/environment-types.md) - AEM 챔피언의 Cloud Manager 환경 유형에 대한 개요를 살펴보려면 이 비디오를 시청하십시오.
