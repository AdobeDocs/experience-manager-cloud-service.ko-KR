...
여행 관련 미디어 전문 테넌트인 이론적 WKND Travel and Adventure Enterprises의 예를 생각해 보십시오. 두 개의 프로그램이 있을 수 있습니다. WKND Magazine 부서를 위한 AEM Sites 프로그램과 WKND Media 부서를 위한 AEM Assets 프로그램. 서로 다른 팀원이 각자의 분업 요구 사항에 따라 서로 다른 프로그램에 액세스할 수 있습니다.

프로그램에는 두 가지 유형이 있습니다.

* **프로덕션 프로그램**&#x200B;은 사이트에 대한 라이브 트래픽을 활성화하기 위해 만들어집니다. 이 프로그램은 &quot;실제&quot; 환경입니다.
...
1. 프로그램 만들기 마법사에서 **샌드박스 설정**&#x200B;을 선택한 다음 프로그램 이름을 입력하고 **계속**&#x200B;을 선택합니다.

   ![프로그램 유형 만들기](/help/implementing/cloud-manager/getting-access-to-aem-in-cloud/assets/create-sandbox.png)

1. **샌드박스 설정** 대화 상자에서 샌드박스 프로그램에서 활성화할 솔루션을 선택할 수 있습니다. **Sites** 및 **Assets** 솔루션은 샌드박스 프로그램에 항상 포함되고 자동으로 선택됩니다. 이러한 솔루션은 온보딩 예제에 충분합니다. **만들기**&#x200B;를 클릭합니다.
...
프로그램이 완료되면 **개발자** 제품 프로필에 할당된 조직의 멤버가 Cloud Manager에 로그인하여 Cloud Manager Git 저장소를 관리할 수 있습니다.

## 다음 단계 {#whats-next}

이제 첫 번째 프로그램을 만들어 환경을 만들 수 있습니다. 다음은 [환경 만들기](create-environments.md) 문서를 검토하여 온보딩 여정을 계속할 수 있습니다.

[Edge Delivery Services 사이트 온보딩](/help/implementing/cloud-manager/edge-delivery/create-edge-delivery-site.md)도 참조하세요.
...
* [Adobe Cloud Manager 사용 - 프로그램](https://experienceleague.adobe.com/en/docs/experience-manager-learn/cloud-service/cloud-manager/programs) - Cloud Manager 프로그램은 논리적 비즈니스 이니셔티브를 지원하는 일련의 AEM 환경을 나타내며, 일반적으로 구매한 SLA(Service Level Agreement)에 해당합니다.
