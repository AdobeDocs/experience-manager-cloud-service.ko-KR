---
title: AEM 설명서 여정
description: 설명서 여정은 모범 사례 방식으로 비즈니스 목표를 해결할 수 있도록 복잡하고 서로 다른 기능을 결합하여 AEM 설명서 내에 서술적 구조를 제공합니다. AEM 초보자용으로 설계된 여정은 A에서 Z까지 목표를 달성하기 위한 개념과 기능을 소개합니다.
...
설명서 여정은 모범 사례 방식으로 비즈니스 목표를 해결할 수 있도록 복잡하고 서로 다른 기능을 결합하여 AEM 설명서 내에 서술적 구조를 제공합니다. AEM 초보자용으로 설계된 여정은 A에서 Z까지 목표를 달성하기 위한 개념과 기능을 소개합니다.
...
이미 사용 가능한 설명서 여정에는 여러 가지가 있습니다. 각 여정은 서술형으로 설계되었으므로, AEM의 맥락에서 주제를 완전히 이해할 수 있도록 소개부터 시작하여 끝까지 읽어 보십시오.
